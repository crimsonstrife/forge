        ...
        <x-form-section>
            ...
            <x-slot name="form">
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-text-input id="name" wire:model.defer="name" type="text" class="block w-full mt-1" required />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-text-input id="repository_url" wire:model.defer="repository_url" type="url" class="block w-full mt-1" />

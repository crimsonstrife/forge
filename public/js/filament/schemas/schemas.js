(() => {
    ...
    const c = function (n, e, i) {
        let t = n;
        if ((e.startsWith("/") && ((i = !0), (e = e.slice(1))), i)) return e;
        for (; e.startsWith("../"); ) {
            ((t = t.includes(".") ? t.slice(0, t.lastIndexOf(".")) : null),
                (e = e.slice(3)));
        }
        return ["", null, void 0].includes(t) ? e : `${t}.${e}`;
    };
    const w = (n) => {
    ...
    document.addEventListener("alpine:init", () => {
        (window.Alpine.data("filamentSchema", ({ livewireId: n }) => ({
            ...
            window.Alpine.data("filamentActionsSchemaComponent", m),
            Livewire.hook(
                "commit",
                ({
                    component: n,

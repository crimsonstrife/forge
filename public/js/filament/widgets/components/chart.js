...
const _e = class s extends dt {
  ...
  getPixelForDecimal (t) {
    ...
    return ar(this._alignToPixels ? Jt(this.chart, e, 0) : e)
  }
  ...
  drawBorder () {
    ...
    let d;
    (this.isHorizontal()
      ? ((c = Jt(t, this.left, r) - r / 2),
        (h = Jt(t, this.right, a) + a / 2),
        (u = d = l))
      : ((u = Jt(t, this.top, r) - r / 2),
        (d = Jt(t, this.bottom, a) + a / 2),
        (c = h = l)),
    e.save(),
    (e.lineWidth = o.width),
...
function Nn (s, t, e, i) {
  ...
  return a && (n || At(t, a.left, a.right)) && (o || At(e, a.top, a.bottom))
}
function Nd (s) {
...
function Kf (s, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    ...
    Kt(e, s._pointLabels[n], l, c + a.lineHeight / 2, a, {
      color: r.color,
      textAlign: h,
      textBaseline: 'middle'
    })
...
const Il = { hour: O, minute: O, second: O, timeZoneName: Dt }
...
function Mg (s) {
  const t = Hi(s.year)
  const e = wt(s.ordinal, 1, Ke(s.year))
...
var R = class s {
  ...
  get monthShort () {
    return this.isValid
      ? Je.months('short', { locObj: this.loc })[this.month - 1]
      : null
  }

  get monthLong () {
    return this.isValid
      ? Je.months('long', { locObj: this.loc })[this.month - 1]
      : null
  }

  get weekdayShort () {
    return this.isValid
      ? Je.weekdays('short', { locObj: this.loc })[this.weekday - 1]
      : null
  }

  get weekdayLong () {
    return this.isValid
      ? Je.weekdays('long', { locObj: this.loc })[this.weekday - 1]
      : null
  }

...
const Oc = (s, t, e) =>
  t in s
    ...
    : (s[t] = e)
const v = (s, t, e) => Oc(s, typeof t !== 'symbol' ? t + '' : t, e)
function us (s) {
  return (s + 0.5) | 0
}
...
const Us = (s) => (s & 240) >> 4 === (s & 15)
const Cc = (s) => Us(s.r) && Us(s.g) && Us(s.b) && Us(s.a)
function Pc (s) {
  const t = s.length
  let e
  return (
...
const hs = class s {
  ...
  greyscale () {
    const t = this._rgb
    const e = us(t.r * 0.3 + t.g * 0.59 + t.b * 0.11)
...
function dn (s, t, e) {
  ...
  if (s._sorted) {
    ...
    if (g) {
      ...
      if (c) {
        const p = l.slice(m - 1).findIndex((b) => !I(b[a.axis]))
        m += Math.max(0, p)
      }
      o = K(m, n, i) - n
    } else o = i - n
...
const Ae = (s, t) => t < s.length && !s[t].skip && s[t]
const kr = (s) => (s === 'x' ? 'y' : 'x')
function Dh (s, t, e, i) {
  const n = s.skip ? t : s
  const o = t
...
function ee (s, t) {
  ...
  const r = ue(n, 'padding')
  const a = ue(n, 'border', 'width')
...
function Nh (s, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o) ((t = s.clientWidth), (e = s.clientHeight))
      ...
      const a = ui(o)
      const l = ue(a, 'border', 'width')
      const c = ue(a, 'padding');
...
const Xt = (s) => Math.round(s * 10) / 10
function Sr (s, t, e, i) {
  const n = ui(s)
  const o = ue(n, 'margin')
  const r = ti(n.maxWidth, s, 'clientWidth') || Ks
  const a = ti(n.maxHeight, s, 'clientHeight') || Ks
  const l = Nh(s, t, e)
  let { width: c, height: h } = l
  if (n.boxSizing === 'content-box') {
    const d = ue(n, 'border', 'width')
    const f = ue(n, 'padding');
...
function vn (s, t, e) {
  const i = t || 1
  const n = Xt(s.height * i)
  const o = Xt(s.width * i);
...
const ut = class {
  ...
  linkScales () {
    ...
    const o = (e.xAxisID = P(i.xAxisID, An(t, 'x')))
    const r = (e.yAxisID = P(i.yAxisID, An(t, 'y')))
    const a = (e.rAxisID = P(i.rAxisID, An(t, 'r')))
    const l = e.indexAxis
  ...
  _resolveElementOptions (t, e = 'default', i) {
    ...
    const r = t + '-' + e
    const a = o[r]
    const l = this.enableOptionSharing && Ee(i)
    if (a) return Fr(a, l)
...
const jt = class extends ut {
  ...
  getLabelAndValue (t) {
    ...
    const o = Re(e._parsed[t], i.options.locale)
...
const He = class extends ut {
  ...
  updateElements (t, e, i, n) {
    ...
    const p = fe(g) ? g : Number.POSITIVE_INFINITY
...
const xe = class extends ut {
  ...
  getLabelAndValue (t) {
    ...
    const i = this.chart
    const n = i.data.labels || []
    const o = Re(e._parsed[t].r, i.options.locale)
    return { label: n[t] || '', value: o }
  }
...
const je = class extends ut {
  ...
  updateElements (t, e, i, n) {
    ...
    const b = fe(m) ? m : Number.POSITIVE_INFINITY
    ...
    for (let w = e; w < e + i; ++w) {
      ...
      const S = y ? x : {}
      const M = I(k[g])
      const T = (S[f] = r.getPixelForValue(k[f], w))
      const C = (S[g] =
                o || M
                  ? a.getBasePixel()
                  : a.getPixelForValue(
...
function pu (s, t, e, i) {
  ...
  if (a && t === a.axis && t !== 'r' && r && o.length) {
    const c = a._reversePixels ? lr : Ct
    if (i) {
      if (n._sharedOptions) {
        const h = o[0]
      ...
      if (l) {
        ...
        h.lo -= Math.max(0, f)
        const g = d.slice(h.hi).findIndex((m) => !I(m[u.axis]))
        h.hi += Math.max(0, g)
      }
      return h
    }
...
function Su (s) {
  ...
  const i = _s(xs(t, 'left'), !0)
  const n = _s(xs(t, 'right'))
  const o = _s(xs(t, 'top'), !0)
  const r = _s(xs(t, 'bottom'))
  const a = Wr(t, 'x')
  const l = Wr(t, 'y')
  return {
    fullSize: e,
...
const we = class s extends dt {
  ...
  calculateLabelRotation () {
    ...
    const f = K(this.chart.width - u, 0, this.maxWidth);
  ...
  _computeGridLineItems (t) {
    ...
    for (_ = 0; _ < u; _ += V) {
      ...
      const Oe = G.color
      const js = vt.dash || []
      const Te = vt.dashOffset
      const as = G.tickWidth
      const le = G.tickColor
      const ls = G.tickBorderDash || []
      const ce = G.tickBorderDashOffset;
      ((w = Zu(this, _, l)),
      w !== void 0 &&
                    ((x = Kt(i, w, ot)),
  ...
  _computeLabelItems (t) {
    ...
    for (b = 0, y = a.length; b < y; ++b) {
      ...
      if (V.showLabelBackdrop) {
        const Te = nt(V.backdropPadding)
        const as = ht.heights[b]
        const le = ht.widths[b]
        let ls = L - Te.top
        let ce = 0 - Te.left
        switch (et) {
          case 'middle':
...
const Ze = class {
  ...
  unregister (t) {
    ...
    const n = this.scope;
    (i in e && delete e[i],
    n && i in j[n] && (delete j[n][i], this.override && delete Jt[i]))
  }
}
function Qu (s, t, e) {
  const i = Pe(Object.create(null), [
    e ? j.get(e) : {},
    j.get(t),
    s.defaults
  ]);
...
function sd (s) {
  const t = {}
  const e = []
  const i = Object.keys(Lt.plugins.items)
...
const Xn = class {
  ...
  resolveNamedOptions (t, e, i, n = ['']) {
    const o = { $shared: !0 }
    const { resolver: r, subPrefixes: a } = Kr(this._resolverCache, t, n)
    let l = r
    if (fd(r, e)) {
...
const oa = Kn.map((s) => s.replace('rgb(', 'rgba(').replace(')', ', 0.5)'))
function Ha (s) {
...
const Mi = class extends dt {
  ...
  adjustHitBoxes () {
    ...
    const r = ge(o, this.left, this.width)
    if (this.isHorizontal()) {
      let a = 0
  ...
  _draw () {
    ...
    const a = j.color
    const l = ge(t.rtl, this.left, this.width)
    const c = X(r.font)
    const { padding: h } = r
    const u = c.size
    const d = u / 2
    ...
    const b = function (k, S, M) {
      ...
      if (
        ...
        const A = l.xPlus(k, g / 2)
        const L = S + d
        bn(n, C, A, L, r.pointStyleWidth && g)
      } else {
        const C = S + Math.max((u - m) / 2, 0)
        const A = l.leftForLtr(k, g)
        const L = te(M.borderRadius);
        (n.beginPath(),
    ...
    (this.legendItems.forEach((k, S) => {
      ...
      const M = n.measureText(k.text).width
      const T = l.textAlign(k.textAlign || (k.textAlign = r.textAlign))
      const C = g + d + M
      let A = f.x
      let L = f.y;
      ...
      _
        ? S > 0 &&
                      ...
                      ((L = f.y += x),
                      f.line++,
                      (A = f.x = it(o, this.left + h, this.right - i[f.line])))
        : S > 0 &&
                      L + x > this.bottom &&
  ...
  drawTitle () {
    ...
    if (!e.display) return
    const o = ge(t.rtl, this.left, this.width)
    const r = this.ctx
    const a = e.position
    const l = i.size / 2
    const c = n.top + l
...
function pa (s, t, e, i) {
  ...
  const c = n + o
  const { topLeft: h, topRight: u, bottomLeft: d, bottomRight: f } = te(r)
  let g = Af(t, a)
  const m = If(t, l, c)
  return (
    l === 'center'
...
const Ps = class extends dt {
  ...
  update (t, e) {
    ...
    if (!n.length) this.opacity !== 0 && (o = { opacity: 0 })
      ...
      const a = Ms[i.position].call(this, n, this._eventPosition);
  ...
  drawTitle (t, e, i) {
    ...
    let l
    if (o) {
      const c = ge(i.rtl, this.x, this.width)
      for (
  ...
  drawBody (t, e, i) {
    ...
    let d = u.lineHeight
    let f = 0
    const g = ge(i.rtl, this.x, this.width)
    const m = function (M) {
  ...
  drawFooter (t, e, i) {
    ...
    let a
    if (o) {
      const l = ge(i.rtl, this.x, this.width)
      for (
  ...
  _positionChanged (t, e) {
    ...
    const r = Ms[o.position].call(this, t, e)
...
const zf = (s, t) => (s === null ? null : K(Math.round(s), 0, t))
function xa (s) {
  const t = this.getLabels()
  return s >= 0 && s < t.length ? t[s] : s
}
const Os = class extends we {
  constructor (t) {
    (super(t),
...
const Es = (s) => Math.floor(Vt(s))
const pe = (s, t) => Math.pow(10, Es(s) + t)
function wa (s) {
...
const Ol = { year: O, month: Dt, day: O }
const og = { year: O, month: Dt, day: O, weekday: Dt }
...
const Al = { hour: O, minute: O, second: O, timeZoneName: Dt }
const Il = { hour: O, minute: O, second: O, timeZoneName: mt }
...
const Vl = { year: O, month: Dt, day: O, hour: O, minute: O }
const Wl = { year: O, month: Dt, day: O, hour: O, minute: O, second: O }
const rg = { year: O, month: Dt, day: O, weekday: Dt, hour: O, minute: O }
const Bl = { year: O, month: mt, day: O, hour: O, minute: O, timeZoneName: Dt }
const Hl = {
  year: O,
  month: mt,
  day: O,
...
function Sg (s, t = 4, e = 1) {
  ...
  const n = wt(s.weekNumber, 1, Ws(s.weekYear, t, e))
...
function Mg (s) {
  const t = Hi(s.year)
  const e = wt(s.ordinal, 1, Qe(s.year))
...
const Ig = ['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D']
function nc (s) {
  switch (s) {
    case 'narrow':
      return [...Ig]
...
function $s (s, t) {
  const e = s[t] ? ae.create(s[t]) : null
  return [{}, e, t + 1]
}
const Kg = RegExp(`^T?${Fo.source}$`)
const Qg =
...
const um = is(Yg, Ro)
const dm = is(fc)
const mc = ns(Jg, rs, Hs, $s)
const fm = ns(Zg, rs, Hs, $s)
const gm = ns(qg, rs, Hs, $s)
const mm = ns(rs, Hs, $s)
function pm (s) {
...
var tt = class s {
  ...
  equals (t) {
    ...
    for (const i of Se) if (!e(this.values[i], t.values[i])) return !1
    return !0
  }
}
...
const Im = 'missing Intl.DateTimeFormat.formatToParts support'
function N (s, t = (e) => e) {
...
function vl (s, t) {
  const e = ne(t.zone, Y.defaultZone)
...
var R = class s {
  constructor (t) {
    ...
    if (!i) {
      if (t.old && t.old.ts === this.ts && t.old.zone.equals(e)) {
        ...
        const a = re(t.o) && !t.old ? t.o : e.offset(this.ts);
        ((n = Pi(this.ts, a)),
  ...
  static fromJSDate (t, e = {}) {
    ...
    const n = ne(e.zone, Y.defaultZone)
    return n.isValid
  ...
  static fromObject (t, e = {}) {
    t = t || {}
    const i = ne(e.zone, Y.defaultZone)
    ...
    const w = m ? Sg(o, r, a) : h ? Mg(o) : Jl(o)
    const x = w || Kl(o)
    if (x) return s.invalid(x)
    const k = m ? rl(o, r, a) : h ? al(o) : o
    const [S, M] = Ii(k, c, i)
  ...
  set (t) {
    ...
    o
      ...
      : D(e.ordinal)
        ...
        : (u = al({ ...oo(this.c), ...e }))
    const [d, f] = Ii(u, this.o, this.zone)
...
function Yi ({ cachedData: s, options: t, type: e }) {
  return {
    ...
    initChart (i = null) {
      let r, a, l, c, h, u, d, f, g, m, p, b, y, _, w, x
      if (
        !this.$refs.canvas ||
      ...
      if (
        ...
        const k = getComputedStyle(this.$refs.textColorElement).color;
        ((y = t.scales).r ?? (y.r = {}),

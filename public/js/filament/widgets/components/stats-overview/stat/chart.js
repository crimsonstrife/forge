...
const Zo = (i, t, e) =>
  t in i
    ...
    : (i[t] = e)
const M = (i, t, e) => Zo(i, typeof t !== 'symbol' ? t + '' : t, e)
function ve (i) {
  return (i + 0.5) | 0
}
...
const Ue = (i) => (i & 240) >> 4 === (i & 15)
const ea = (i) => Ue(i.r) && Ue(i.g) && Ue(i.b) && Ue(i.a)
function ia (i) {
  const t = i.length
  let e
  return (
...
const ye = class i {
  ...
  greyscale () {
    const t = this._rgb
    const e = ve(t.r * 0.3 + t.g * 0.59 + t.b * 0.11)
...
const Qt = (i, t) => t < i.length && !i[t].skip && i[t]
const Mn = (i) => (i === 'x' ? 'y' : 'x')
function tr (i, t, e, s) {
  const n = i.skip ? t : i
  const o = t
...
function cr (i, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o) ((t = i.clientWidth), (e = i.clientHeight))
      ...
      const r = ui(o)
      const l = zt(r, 'border', 'width')
      const c = zt(r, 'padding');
...
function wn (i, t, e, s) {
  ...
  if (n.boxSizing === 'content-box') {
    const u = zt(n, 'border', 'width')
    const f = zt(n, 'padding');
...
function ns (i, t, e) {
  const s = t || 1
  const n = Dt(i.height * s)
  const o = Dt(i.width * s);
...
const it = class {
  ...
  _resolveElementOptions (t, e = 'default', s) {
    ...
    const a = t + '-' + e
    const r = o[a]
    const l = this.enableOptionSharing && ee(s)
    if (r) return In(r, l)
...
const kt = class extends it {
  ...
  getLabelAndValue (t) {
    ...
    const o = ne(e._parsed[t], s.options.locale)
...
const he = class extends it {
  ...
  updateElements (t, e, s, n) {
    ...
    const m = Vt(g) ? g : Number.POSITIVE_INFINITY
...
const Yt = class extends it {
  ...
  getLabelAndValue (t) {
    ...
    const s = this.chart
    const n = s.data.labels || []
    const o = ne(e._parsed[t].r, s.options.locale)
    return { label: n[t] || '', value: o }
  }
...
const ue = class extends it {
  ...
  updateElements (t, e, s, n) {
    ...
    const b = Vt(p) ? p : Number.POSITIVE_INFINITY
...
function Jr (i) {
  ...
  const s = Ae(Ce(t, 'left'), !0)
  const n = Ae(Ce(t, 'right'))
  const o = Ae(Ce(t, 'top'), !0)
  const a = Ae(Ce(t, 'bottom'))
  const r = Wn(t, 'x')
  const l = Wn(t, 'y')
  return {
    fullSize: e,
...
const Xt = class i extends st {
  ...
  _computeGridLineItems (t) {
    ...
    for (v = 0; v < d; v += I) {
      ...
      const Kt = j.color
      const Ye = rt.dash || []
      const qt = rt.dashOffset
      const be = j.tickWidth
      const Et = j.tickColor
      const xe = j.tickBorderDash || []
      const It = j.tickBorderDashOffset;
      ((y = yl(this, v, l)),
      y !== void 0 &&
                    ((_ = Ct(s, y, G)),
  ...
  _computeLabelItems (t) {
    ...
    for (b = 0, x = r.length; b < x; ++b) {
      ...
      if (I.showLabelBackdrop) {
        const qt = q(I.backdropPadding)
        const be = et.heights[b]
        const Et = et.widths[b]
        let xe = L - qt.top
        let It = 0 - qt.left
        switch (U) {
          case 'middle':
...
const pe = class {
  ...
  unregister (t) {
    ...
    const n = this.scope;
    (s in e && delete e[s],
    n && s in V[n] && (delete V[n][s], this.override && delete Ot[s]))
  }
}
function Pl (i, t, e) {
...
const Ts = class {
  ...
  resolveNamedOptions (t, e, s, n = ['']) {
    const o = { $shared: !0 }
    const { resolver: a, subPrefixes: r } = Zn(this._resolverCache, t, n)
    let l = a
    if (Wl(a, e)) {
  ...
  createResolver (t, e, s = [''], n) {
    const { resolver: o } = Zn(this._resolverCache, t, s)
...
const Pi = class extends st {
  ...
  adjustHitBoxes () {
    ...
    const a = Wt(o, this.left, this.width)
    if (this.isHorizontal()) {
      let r = 0
  ...
  _draw () {
    ...
    const r = V.color
    const l = Wt(t.rtl, this.left, this.width)
    const c = $(a.font)
    const { padding: h } = a
    const d = c.size
    const u = d / 2
...
function Gc (i, t) {
  const e = new He({ ctx: i.ctx, options: t, chart: i });
...
const Zc = {
  id: 'subtitle',
  start (i, t, e) {
    const s = new He({ ctx: i.ctx, options: e, chart: i });
...
function bo (i, t, e, s) {
  ...
  const c = n + o
  const { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Tt(a)
  let g = sh(t, r)
  const p = nh(t, l, c)
  return (
    l === 'center'
...
const We = class extends st {
  ...
  update (t, e) {
    ...
    if (!n.length) this.opacity !== 0 && (o = { opacity: 0 })
      ...
      const r = Ie[s.position].call(this, n, this._eventPosition);
  ...
  _positionChanged (t, e) {
    ...
    const a = Ie[o.position].call(this, t, e)
...
const je = (i) => Math.floor(xt(i))
const Ht = (i, t) => Math.pow(10, je(i) + t)
function Mo (i) {
...
function fh (i, { min: t, max: e }) {
  ...
  let u = Z(i.min, Math.round((l + h + d * Math.pow(10, o)) * a) / a)
  for (; u < e;) {
...
const Be = class extends Xt {
  ...
  parse (t, e) {
    const s = me.prototype.parse.apply(this, [t, e])
    if (s === 0) {
      this._zero = !0
      return
    }

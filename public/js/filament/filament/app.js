(() => {
  ...
  const ae = Object.getOwnPropertyDescriptor
  const se = (t) => K(t, '__esModule', { value: !0 })
  const le = (t, n) => () => (
  ...
  const ce = le((t, n) => {
    (function (i, a, w) {
      ...
      function g (e) {
        ...
        function I (o, u, p, l, d, b) {
          ...
          for (
            ...
            if (
              ...
              const ee = !l && _.combo == d
              const te = l && _.seq == l && _.level == b;
        ...
        function L (o, u, p, l) {
          r.stopCallback(u, u.target || u.srcElement, p, l) ||
                        (o(u, p) === !1 && (H(u), B(u)))
        }
        r._handleKey = function (o, u, p) {
          ...
          for (d = 0; d < l.length; ++d) {
            if (l[d].seq) {
              ...
              ((_ = !0),
              (b[l[d].seq] = 1),
              L(l[d].callback, p, l[d].combo, l[d].seq))
              continue
            }
        ...
        function $ (o, u, p, l) {
          ...
          for (let c = 0; c < u.length; ++c) {
            const _ = c + 1 === u.length
            const A = _ ? b : d(l || G(u[c + 1]).action)
            z(u[c], A, l, o, c)
          }
        }
        ...
        ((r._bindMultiple = function (o, u, p) {
          for (let l = 0; l < o.length; ++l) z(o[l], u, p)
        }),
        C(e, 'keypress', q),
        C(e, 'keydown', q),
        C(e, 'keyup', q))
      ...
      (g.addKeycodes = function (e) {
        for (const r in e) e.hasOwnProperty(r) && (f[r] = e[r])
        M = null
      }),
      (g.init = function () {
        const e = g(a)
    ...
    if (t) {
      ...
      (t.prototype.bindGlobal = function (a, w, f) {
        ...
        if ((v.bind(a, w, f), a instanceof Array)) {
          for (let y = 0; y < a.length; y++) n[a[y]] = !0
          return
        }
        n[a] = !0
      }),
  ...
  document.addEventListener('livewire:init', () => {
    Livewire.hook('request', ({ payload: t, fail: n }) => {
      n(({ status: i, preventDefault: a }) => {
        const w = window.filamentErrorNotifications
        if (!w) return
        if (JSON.parse(t).components.length === 1) {
          for (const v of JSON.parse(t).components) {
            if (
              JSON.parse(v.snapshot).data
  ...
  window.history.replaceState = function (t, n, i) {
    ...
    const a = i || t?.url || window.location.href
    ...
    try {
      ...
      JSON.stringify(t) !== JSON.stringify(f) &&
                N.call(window.history, t, n, i)
    } catch {
      N.call(window.history, t, n, i)
    }

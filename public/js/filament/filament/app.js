(() => {
    ...
    const se = (r) => q(r, "__esModule", { value: !0 });
    const ae = (r, n) => () => (
    ...
    const le = ae((r, n) => {
        (function (s, l, g) {
            ...
            function T(e, t) {
                ...
                return ((t = B(h, A, t)), { key: h, modifiers: A, action: t });
            }
            function U(e, t) {
                return e === null || e === l
                    ? !1
            ...
            function v(e) {
                ...
                function Q(i, f, p, o) {
                    ...
                    for (let u = 0; u < f.length; ++u) {
                        const _ = u + 1 === f.length;
                        const M = _ ? m : c(o || T(f[u + 1]).action);
                        z(f[u], M, o, i, u);
                    }
                }
                ...
                ((t._bindMultiple = function (i, f, p) {
                    for (let o = 0; o < i.length; ++o) z(i[o], f, p);
                }),
                    S(e, "keypress", K),
                    S(e, "keydown", K),
                    S(e, "keyup", K));
            ...
            ((v.prototype.bind = function (e, t, a) {
                ...
                (v.addKeycodes = function (e) {
                    for (const t in e) e.hasOwnProperty(t) && (d[t] = e[t]);
                    P = null;
                }),
                (v.init = function () {
                    const e = v(l);
    ...
    (function (r) {
        if (r) {
            const n = {};
            const s = r.prototype.stopCallback;
            ((r.prototype.stopCallback = function (l, g, d, w) {
                ...
                (r.prototype.bindGlobal = function (l, g, d) {
                    ...
                    if ((w.bind(l, g, d), l instanceof Array)) {
                        for (let b = 0; b < l.length; b++) n[l[b]] = !0;
                        return;
                    }
                    n[l] = !0;
                }),

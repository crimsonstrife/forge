(() => {
  ...
  const ho = Kr((Hs, yr) => {
    (function () {
      ...
      const u = typeof define === 'function' && define.amd
  ...
  async function _n (e, t) {
    ...
    const S = ei(E)
    const I = u[O ? (m === 'floating' ? 'reference' : 'floating') : m]
    const $ = Cn(
    ...
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn (t) {
          ...
          const { padding: u = 2, x: f, y: d } = jt(e, t)
          const y = Array.from(
  ...
  const Vi = function (e) {
    return (
      e === void 0 && (e = 0),
      {
        ...
        async fn (t) {
          let r, n
          const { x: i, y: o, placement: a, middlewareData: u } = t
    ...
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn (t) {
          ...
          const { apply: a = () => {}, ...u } = jt(e, t)
          const f = await _n(t, u)
          const d = pt(r)
          const y = xt(r)
          const m = Pn(r) === 'y'
  ...
  function Dn (e) {
    ...
    let u = (o ? hr(r.height) : r.height) / i
    return (
  ...
  function vn (e, t, r, n) {
    ...
    const u = xa(o, r, n) ? qi(o) : nn(0)
    let f = (i.left + u.x) / a.x
    let d = (i.top + u.y) / a.y
    let y = i.width / a.x
    let m = i.height / a.y
    if (o) {
  ...
  function Ma (e, t, r) {
    ...
    const d = a.left + u.scrollLeft - f.x
    const y = a.top + u.scrollTop - f.y
  ...
  function $a (e) {
    ...
    const n = (a, u, f = {}, d = null, y = null) => {
      const m = a === 'link' ? `link[href="${u}"]` : `script[src="${u}"]`
      if (
      ...
      const O = a === 'link' ? { ...f, href: u } : { ...f, src: u }
      const E = r(a, O, d, y)
    ...
    const i = async (a, u, f = null, d = null) => {
    ...
    const o = async (a, u, f = null, d = null, y = null) => {
      let m = document.head
      let O = null
      if (f && d) {
  ...
  function Ga (e) {
    ...
    for (; (n = t.exec(e)) !== null;) {
      ...
      if (o !== void 0) r.push({ type: 'parenthesis', value: o })
        ...
        const f = { type: 'method', method: u.trim() };
        (u.includes('(') &&
  ...
  const tr = {
    ...
    initializePlugins: function (t, r, n, i) {
      Mn.forEach(function (u) {
        const f = u.pluginName
        if (!(!t.options[f] && !u.initializeByDefault)) {
          const d = new u(t, r, t.options);
          ((d.sortable = t),
          (d.options = t.options),
          (t[f] = d),
          $t(n, d.defaults))
  ...
  const Io = function (t, r) {
    ...
    const f = a && ae(a)
    const d =
            u && parseInt(u.marginLeft) + parseInt(u.marginRight) + qe(o).width
    const y =
    ...
    if (o && u.float && u.float !== 'none') {
      const m = u.float === 'left' ? 'left' : 'right'
  ...
  const cs = function (t, r) {
    ...
    return (
      Mr.some(function (i) {
        ...
        if (!(!o || wi(i))) {
          const a = qe(i)
          const u = t >= a.left - o && t <= a.right + o
  ...
  const Lo = function (t) {
    function r (o, a) {
      return function (u, f, d, y) {
        ...
        const O = (a ? u : f).options.group.name
        return (
          o === !0 ||
                    (typeof o === 'string' && o === O) ||
    ...
    return (
      (e.prototype = {
        ...
        _handleAutoScroll: function (r, n) {
          ...
          const u = document.elementFromPoint(o, a)
          if (
            ((Ir = r),
            n ||
  ...
  const jo = (e) => {
    e.directive('sortable', (t) => {
      ...
      (t.sortable = Oi.create(t, {
        ...
        onEnd (n) {
          const { item: i, to: o, newIndex: a } = n
          const u = this.options.draggable
          const f = o.querySelectorAll(u)[a - 1]
  ...
  const _s = Bo((e) => {
    ...
    function ne (c) {
      ...
      for (let P = I(c); o(P) && ['html', 'body'].indexOf(d(P)) < 0;) {
        const F = O(P)
        if (
          F.transform !== 'none' ||
                    F.perspective !== 'none' ||
...
`,
    ...
    function or (g) {
      ...
      return (
        g === !0
          ? (w.className = a)
          : ((w.className = u), V(g) ? w.appendChild(g) : Yt(w, g)),
        w
      )
    }
    function kn (g, w) {
    ...
    function Xt (g) {
      ...
      return {
        ...
        arrow: D.find(function (L) {
          return L.classList.contains(a) || L.classList.contains(u)
        }),

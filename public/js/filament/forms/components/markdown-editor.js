  ...
  (function (o, p) {
    ...
    const Ft = (function () {
      ...
      return function (m, A) {
        ...
        for (let ue = 0, me = B; ue < ee; ++ue) {
          const ve = Y[ue]
          ve == 'm' ? (Y[ue] = me) : (me = ve)
        }
        for (let _e = 0, be = B; _e < ee; ++_e) {
          const Ce = Y[_e]
          Ce == '1' && be == 'r'
            ? (Y[_e] = 'n')
    ...
    function ei (e) {
      if (Hr == null) {
        const t = y('span', '\u200B');
        (V(e, y('span', [t, document.createTextNode('x')])),
...
`,
      ...
      for (var i = [{ from: t, to: n }], a = 0; a < r.length; ++a) {
        for (let l = r[a], u = l.find(0), f = 0; f < i.length; ++f) {
          ...
          if (!(ye(m.to, u.from) < 0 || ye(m.from, u.to) > 0)) {
            const A = [f, 1]
            const B = ye(m.from, u.from)
            const ee = ye(m.to, u.to);
            ((B < 0 || (!l.inclusiveLeft && !B)) &&
      ...
      if (l) {
        for (let u = 0; u < l.length; ++u) {
          ...
          if (f.marker.collapsed) {
            ...
            const B = ye(m.to, r) || oi(f.marker) - oi(i)
            if (
              !((A >= 0 && B <= 0) || (A <= 0 && B >= 0)) &&
                            ((A <= 0 &&
    ...
    function Ca (e, t) {
      ...
      for (let i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
        ...
        (r.map = []))
        const u = t != e.display.externalMeasured && x(a);
        ($c(a, r, da(e, a, u)),
        a.styleClasses &&
      ...
      if (t) {
        ...
        if (!f.test(t)) {
          ...
          for (let B = 0; ;) {
            f.lastIndex = B
            const ee = f.exec(t)
            const Y = ee ? ee.index - B : t.length - B
            if (Y) {
              const ie = document.createTextNode(
                u.slice(B, B + Y)
              );
              (s && h < 9
                ? A.appendChild(y('span', [ie]))
                : A.appendChild(ie),
...
`
    ...
    function Cn (e) {
      ...
      if (!N(document.body, e.node)) {
        ...
        V(t.display.measure, y('div', [e.node], null, n)))
      }
    ...
    function Ia (e) {
      ...
      const t = V(e.measure, y('pre', 'x', 'CodeMirror-line-like'))
    ...
    function ci (e, t, n, r, i) {
      ...
      if (
        ...
        const f = u.left + (r == 'window' ? 0 : Ha(L(e)));
        ((n.left += f), (n.right += f))
      }
    ...
    function lf (e, t, n, r, i) {
      ...
      if (A) {
        const B = (e.options.lineWrapping ? uf : sf)(
          e,
          t,
          n,
          a,
    ...
    function Jr (e) {
      ...
      const t = y('span', 'xxxxxxxxxx')
      const n = y('pre', [t], 'CodeMirror-line-like')
      V(e.measure, n)
    ...
    function _o (e, t, n) {
      ...
      const i = n.appendChild(y('div', '\xA0', 'CodeMirror-cursor'))
      if (
    ...
    function ff (e, t, n) {
      ...
      if (ee.line == Y.line) B(ee.line, ee.ch, Y.ch)
        ...
        const _e = B(Y.line, me ? 0 : null, Y.ch).start;
        (me &&
                    (ve.top < _e.top - 2
      ...
      for (
        ...
        if (!u.hidden) {
          if (((i += u.line.height), s && h < 8)) {
            const B = u.node.offsetTop + u.node.offsetHeight;
            ((m = B - n), (n = B))
          } else {
          ...
          if (
            (Y > 0.005 || Y < -0.005) &&
                        (i < r && (a -= Y), Bt(u.line, m), Va(u.line), u.rest)
          ) {
    ...
    function pf (e, t, n, r) {
      ...
      for (let a = 0; a < 5; a++) {
        ...
        if (
          ...
          m.scrollLeft != null &&
                        (Dr(e, m.scrollLeft),
                        Math.abs(e.doc.scrollLeft - B) > 1 && (l = !0)),
          !l)
        ) {
          break
        }
    ...
    function To (e, t) {
      ...
      const B = e.options.fixedGutter ? 0 : n.gutters.offsetWidth
      const ee =
                e.curOp && e.curOp.scrollLeft != null
                  ? e.curOp.scrollLeft
                  : n.scroller.scrollLeft - B
    ...
    function _f (e) {
      ...
      const n = e.focus && e.focus == R(de(t));
      (e.preparedSelection &&
    ...
    function kf (e) {
      ...
      if (
        ...
        const i = pf(
          t,
          je(r, e.scrollToPos.from),
          je(r, e.scrollToPos.to),
      ...
      for (let f = r.view, m = r.viewFrom, A = 0; A < f.length; A++) {
        ...
        if (!B.hidden) {
          if (!B.node || B.node.parentNode != a) {
            ...
            for (; l != B.node;) l = u(l)
            let Y = i && t != null && t <= m && B.lineNumber;
            (B.changes &&
                            (Se(B.changes, 'gutter') > -1 && (Y = !1),
                            Ma(e, B, m, n)),
            Y &&
                                (j(B.lineNumber),
                                B.lineNumber.appendChild(
    ...
    function ll (e) {
      ...
      for (let r = 0; r < n.length; ++r) {
        ...
        const u = t.appendChild(
          y('div', null, 'CodeMirror-gutter ' + a)
        );
        (l && (u.style.cssText = l),
        a == 'CodeMirror-linenumbers' &&
                        ((e.lineGutter = u),
    ...
    function Ef (e, t, n, r) {
      ...
      w && c === 105 && (i.wrapper.style.clipPath = 'inset(0px)'),
    ...
    let bi = 0
    let sr = null
    s ? (sr = -0.53) : v ? (sr = 15) : w ? (sr = -0.7) : k && (sr = -1 / 3)
    function sl (e) {
      let t = e.wheelDeltaX
      let n = e.wheelDeltaY
      return (
      ...
      for (let a = 1; a < t.length; a++) {
        ...
        if (r && !l.empty() ? f > 0 : f >= 0) {
          ...
          const B = u.empty()
            ...
            : u.from() == u.head;
          (a <= n && --n,
          t.splice(--a, 2, new Ye(B ? A : m, B ? m : A)))
        }
      }
      return new jt(t, n)
    }
    ...
    function Fo (e, t, n, r) {
      ...
      if (t.full) {
        ...
        (a(A, A.text.slice(0, u.ch) + m[0] + B.text.slice(f.ch), i(0)),
        e.remove(u.line + 1, ie))
      } else {
        (a(A, A.text.slice(0, u.ch) + m[0], i(0)),
        a(B, ee + B.text.slice(f.ch), Y))
        ...
        if (
          this.size - t < 25 &&
                    (this.children.length > 1 ||
                        !(this.children[0] instanceof Bn))
        ) {
          const u = [];
          (this.collapse(u),
          (this.children = [new Bn(u)]),
          ...
          if (e <= a) {
            if (
              ...
              for (
                ...
                const f = new Bn(i.lines.slice(u, (u += 25)));
                ((i.height -= f.height),
    ...
    ((Mt.prototype = oe(jn.prototype, {
      ...
      getRange: function (e, t, n) {
        const r = ir(this, je(this, e), je(this, t))
        return n === !1
          ? r
          : n === ''
            ? r.join('')
      ...
      setCursor: mt(function (e, t, n) {
        xl(
          this,
          je(this, typeof e === 'number' ? ne(e, t || 0) : e),
          null,
          n
        )
      }),
      ...
      addSelection: mt(function (e, t, n) {
        ...
        (r.push(new Ye(je(this, e), je(this, t || e))),
...
`,
    ...
    function sd (e, t, n, r) {
      s ? setTimeout(Ee(Qa, e), 0) : (e.curOp.focus = R(de(e)))
      const i = ld(e, n, r)
      const a = e.doc.sel
      let l
      e.options.dragDrop &&
    ...
    function Ql (e, t, n) {
      ...
      if (n == 'line') {
        return new Ye(ne(t.line, 0), je(e.doc, ne(t.line + 1, 0)))
      }
      const r = n(e, t)
    ...
    function fd (e, t) {
      ...
      if (r.line != n.line) {
        ...
        const B = A - l || (r.ch - n.ch) * (u.level == 1 ? -1 : 1)
    ...
    function Vl (e, t, n, r) {
      ...
      for (let f = 0; f < e.display.gutterSpecs.length; ++f) {
        ...
        if (m && m.getBoundingClientRect().right >= i) {
          const A = P(e.doc, a)
          const B = e.display.gutterSpecs[f]
    ...
    function Xn (e, t, n, r) {
      ...
      if (e.options.indentWithTabs) {
        for (let Y = Math.floor(A / l); Y; --Y) ((ee += l), (B += '	'))
      }
      if ((ee < A && (B += Z(A - ee)), B != m)) {
        return (
          ln(i, B, ne(t, 0), ne(t, m.length), '+input'),
          (u.stateAfter = null),
          !0
        )
      }
...
`) == t
      ...
      for (
        var B = e.curOp.updateInput, ee = r.ranges.length - 1;
        ee >= 0;
        ee--
      ) {
        const Y = r.ranges[ee]
...
`) &&
    ...
    function os () {
      ...
      return (
        ...
        _ && (e.style.border = '1px solid black'),
        t
      )
    }
    function vd (e) {
      ...
      ((e.prototype = {
        ...
        addWidget: function (r, i, a, l, u) {
          ...
          if (
            ...
            ((l == 'above' || r.bottom + i.offsetHeight > B) &&
        ...
        findPosV: function (r, i, a, l) {
          ...
          for (var m = je(this.doc, r), A = 0; A < i; ++A) {
            const B = Xt(this, m, 'div')
            if (
              (f == null ? (f = B.left) : (B.left = f),
              (m = as(this, B, u, a)),
              m.hitSide)
            ) {
              break
        ...
        moveV: Tt(function (r, i) {
          ...
          if (
            (l.extendSelectionsBy(function (A) {
              ...
              const B = Xt(a, A.head, 'div');
              (A.goalColumn != null && (B.left = A.goalColumn),
              u.push(B.left))
              const ee = as(a, B, r, i)
              return (
                i == 'page' &&
                                    A == l.sel.primary() &&
                                    Lo(a, fi(a, ee, 'div').top - B.top),
                ee
              )
            }, Re),
            u.length)
        ...
        hasFocus: function () {
          return this.display.input.getField() == R(de(this))
        },
        isReadOnly: function () {
...
`)))
    ...
    (Qe.prototype.showPrimarySelection = function () {
      ...
      if (
        ...
        if (!m) {
          ...
          const B = A.maps ? A.maps[A.maps.length - 1] : A.map
          m = {
            node: B[B.length - 1],
            offset: B[B.length - 2] - B[B.length - 3]
          }
        }
        if (!f || !m) {
          e.removeAllRanges()
    ...
    (Qe.prototype.pollContent = function () {
      ...
      if (B.length > 1 || B[0] || ye(Ne, Fe)) {
        return (ln(e.doc, B, Ne, Fe, '+input'), !0)
      }
    }),
      ...
      function ee (Y) {
        if (Y.nodeType == 1) {
          ...
          if (ue) {
            ...
            ve.length &&
                            (me = ve[0].find(0)) &&
                            B(ir(e.doc, me.from, me.to).join(u))
            return
          }
    ...
    function xd (e, t, n) {
      ...
      let i = !1
      if (!t || !N(r, t)) return dn(ne(x(e.line), 0), !0)
      ...
      function A (me, ve, _e) {
        for (let be = -1; be < (m ? m.length : 0); be++) {
          for (
            ...
            const Fe = Ce[Ne + 2]
            if (Fe == me || Fe == ve) {
              const $e = x(be < 0 ? e.line : e.rest[be])
              let Ve = Ce[Ne] + _e
              return (
                (_e < 0 || Fe != me) &&
                                    (Ve = Ce[Ne + (_e ? 1 : 0)]),
      ...
      for (
        ...
        if (((B = A(ee, ee.firstChild, 0)), B)) {
          return dn(ne(B.line, B.ch - Y), i)
        }
      ...
      for (
        ...
        if (((B = A(ie, ie.firstChild, -1)), B)) {
          return dn(ne(B.line, B.ch + ue), i)
        }
  ...
  (function (o) {
    ...
    o.commands.newlineAndIndentContinueMarkdownList = function (S) {
      ...
      for (var s = S.listSelections(), h = [], g = 0; g < s.length; g++) {
        const T = s[g].head
        let w = S.getStateAfter(T.line)
        const c = o.innerMode(S.getMode(), w)
        if (
        ...
        const M = p.exec(z)
        const _ = /^\s*$/.test(z.slice(0, T.ch))
        if (!s[g].empty() || (!d && !k) || !M || _) {
          S.execCommand('newlineAndIndent')
          return
        }
        if (v.test(z)) {
...
const ys = Ke((vs, bs) => {
  (function (o) {
    ...
    'use strict'
    o.defineOption('styleSelectedText', !1, function (w, c, d) {
      const k = d && d != o.Init
      c && !k
        ? ((w.state.markedSelection = []),
          (w.state.markedSelectionStyle =
                      typeof c === 'string' ? c : 'CodeMirror-selectedtext'),
          g(w),
          w.on('cursorActivity', p),
          w.on('change', v))
        : !c &&
                  k &&
                  (w.off('cursorActivity', p),
                  w.off('change', v),
                  h(w),
                  (w.state.markedSelection = w.state.markedSelectionStyle =
                      null))
    })
    function p (w) {
      w.state.markedSelection &&
    ...
    function v (w) {
      w.state.markedSelection &&
                w.state.markedSelection.length &&
                w.operation(function () {
                  h(w)
                })
    }
    ...
    function s (w, c, d, k) {
      if (S(c, d) != 0) {
        for (
          let z = w.state.markedSelection,
            M = w.state.markedSelectionStyle,
            _ = c.line;
          ;

        ) {
          const W = _ == c.line ? c : b(_, 0)
          const E = _ + C
          const O = E >= d.line
          const G = O ? d : b(E, 0)
          const J = w.markText(W, G, { className: M })
    ...
    function h (w) {
      for (var c = w.state.markedSelection, d = 0; d < c.length; ++d) {
        c[d].clear()
      }
      c.length = 0
    }
    function g (w) {
      h(w)
      for (let c = w.listSelections(), d = 0; d < c.length; d++) {
        s(w, c[d].from(), c[d].to())
      }
    }
    function T (w) {
      if (!w.somethingSelected()) return h(w)
      if (w.listSelections().length > 1) return g(w)
      const c = w.getCursor('start')
      const d = w.getCursor('end')
      const k = w.state.markedSelection
      if (!k.length) return s(w, c, d)
      let z = k[0].find()
...
const ks = Ke((xs, _s) => {
  (function (o) {
    ...
    function C (_, W) {
      for (var E = v(_), O = E, G = 0; G < W.length; G++) {
        O.indexOf(W.charAt(G)) == -1 && (O += W.charAt(G))
      }
      return E == O ? _ : new RegExp(_.source, O)
    }
    function b (_) {
      return /\\s|\\n|\n|\\W|\\D|\[\^/.test(_.source)
    }
    function S (_, W, E) {
      W = C(W, 'g')
      for (
        let O = E.line, G = E.ch, J = _.lastLine();
        O <= J;
        O++, G = 0
      ) {
        W.lastIndex = G
        const re = _.getLine(O)
        const q = W.exec(re)
        if (q) {
          return {
            from: p(O, q.index),
    ...
    function s (_, W, E) {
      if (!b(W)) return S(_, W, E)
      W = C(W, 'gm')
      for (var O, G = 1, J = E.line, re = _.lastLine(); J <= re;) {
...
`)
    ...
    function h (_, W, E) {
      for (var O, G = 0; G <= _.length;) {
        W.lastIndex = G
        const J = W.exec(_)
        if (!J) break
        const re = J.index + J[0].length
        if (re > _.length - E) break;
    ...
    function g (_, W, E) {
      W = C(W, 'g')
      for (
        let O = E.line, G = E.ch, J = _.firstLine();
        O >= J;
        O--, G = -1
      ) {
        const re = _.getLine(O)
    ...
    function T (_, W, E) {
      if (!b(W)) return g(_, W, E)
      W = C(W, 'gm')
      for (
        var O,
          G = 1,
          J = _.getLine(E.line).length - E.ch,
          re = E.line,
          q = _.firstLine();
        re >= q;
...
` +
        ...
        const Q = h(O, W, J)
        if (Q) {
          const j = O.slice(0, Q.index).split(`
`)
          const V = Q[0].split(`
`)
          const y = re + j.length
    ...
    function d (_, W, E, O) {
      if (_.length == W.length) return E
      for (let G = 0, J = E + Math.max(0, _.length - W.length); ;) {
        if (G == J) return G
        const re = (G + J) >> 1
        const q = O(_.slice(0, re)).length
        if (q == E) return re
        q > E ? (J = re) : (G = re + 1)
      }
    }
    function k (_, W, E, O) {
      ...
      const J = G(W).split(/\r|\n\r?/)
      e: for (
        let re = E.line, q = E.ch, I = _.lastLine() + 1 - J.length;
        re <= I;
        re++, q = 0
      ) {
        const D = _.getLine(re).slice(q)
        const Q = G(D)
        if (J.length == 1) {
          const j = Q.indexOf(J[0])
          if (j == -1) continue e
          var E = d(D, Q, j, G) + q
          return {
            from: p(re, d(D, Q, j, G) + q),
            to: p(re, d(D, Q, j + J[0].length, G) + q)
          }
        } else {
          const V = Q.length - J[0].length
          if (Q.slice(V) != J[0]) continue e
          for (let y = 1; y < J.length - 1; y++) {
            if (G(_.getLine(re + y)) != J[y]) continue e
          }
          const K = _.getLine(re + J.length - 1)
          const X = G(K)
    ...
    function z (_, W, E, O) {
      ...
      const J = G(W).split(/\r|\n\r?/)
      e: for (
        let re = E.line, q = E.ch, I = _.firstLine() - 1 + J.length;
        re >= I;
        re--, q = -1
      ) {
        let D = _.getLine(re)
        ...
        const Q = G(D)
        if (J.length == 1) {
          const j = Q.lastIndexOf(J[0])
          if (j == -1) continue e
          return {
            from: p(re, d(D, Q, j, G)),
            to: p(re, d(D, Q, j + J[0].length, G))
          }
        } else {
          ...
          for (
            ...
            if (G(_.getLine(E + y)) != J[y]) continue e
          }
          const K = _.getLine(re + 1 - J.length)
          const X = G(K)
    ...
    ((M.prototype = {
      ...
      find: function (_) {
        let W = this.doc.clipPos(_ ? this.pos.from : this.pos.to)
        if (
        ...
        const O = p(
          _ ? this.doc.firstLine() : this.doc.lastLine() + 1,
          0
        )
        return (
      ...
      replace: function (_, W) {
        if (this.atOccurrence) {
          const E = o.splitLines(_);
    ...
    o.defineExtension('getSearchCursor', function (_, W, E) {
      return new M(this.doc, _, W, E)
    }),
    o.defineDocExtension('getSearchCursor', function (_, W, E) {
      return new M(this, _, W, E)
    }),
    o.defineExtension('selectMatches', function (_, W) {
      for (
        var E = [],
  ...
  (function (o) {
    ...
    function v (N, R, le, xe) {
      ...
      return (
        ...
        (N.context = new p(F, R, le, xe, null, N.context))
      )
    }
    function C (N) {
      const R = N.context.type
      return (
        (R == ')' || R == ']' || R == '}') &&
    ...
    function b (N, R, le) {
      if (
        R.prevToken == 'variable' ||
                ...
                (R.typeAtEndOfLine && N.column() == N.indentation())
      ) {
        return !0
      }
    }
    ...
    o.defineMode('clike', function (N, R) {
      const le = N.indentUnit
      const xe = R.statementIndentUnit || le
      const F = R.dontAlignCalls
      const L = R.keywords || {}
      const de = R.types || {}
      const ze = R.builtin || {}
      const pe = R.blockKeywords || {}
      const Ee = R.defKeywords || {}
      const ge = R.atoms || {}
      const Oe = R.hooks || {}
      const qe = R.multiLineStrings
      const Se = R.indentStatements !== !1
      const Be = R.indentSwitch !== !1
      const Ze = R.namespaceSeparator
      const ke = R.isPunctuationChar || /[\[\]{}\(\),;\:\.]/
      const Je = R.numberStart || /[\d\.]/
      const Re =
                R.number ||
                /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i
      const Ge = R.isOperatorChar || /[+\-*&%=<>!?|\/]/
      const U = R.isIdentifierChar || /[\w\$_\xa1-\uffff]/
      const Z = R.isReservedIdentifier || !1
      let ce
      let He
      function te (we, Me) {
        const Le = we.next()
        ...
        const H = we.current()
        return h(L, H)
          ? (h(pe, H) && (ce = 'newstatement'),
            h(Ee, H) && (He = !0),
            'keyword')
          : h(de, H)
            ? 'type'
            : h(ze, H) || (Z && Z(H))
              ? (h(pe, H) && (ce = 'newstatement'), 'builtin')
              : h(ge, H)
                ? 'atom'
                : 'variable'
      }
      function fe (we) {
        return function (Me, Le) {
          for (var $ = !1, H, se = !1; (H = Me.next()) != null;) {
            if (H == we && !$) {
              se = !0
              break
            }
    ...
    function s (N) {
      for (var R = {}, le = N.split(' '), xe = 0; xe < le.length; ++xe) {
        R[le[xe]] = !0
      }
      return R
    }
    function h (N, R) {
      return typeof N === 'function' ? N(R) : N.propertyIsEnumerable(R)
    }
    const g =
    ...
    const _ = 'case do else for if switch while struct enum union'
    ...
    function D (N, R) {
      const le = R.cpp11RawStringDelim.replace(/[^\w\s]/g, '\\$&')
      const xe = N.match(new RegExp('.*?\\)' + le + '"'))
      return (xe ? (R.tokenize = null) : N.skipToEnd(), 'string')
    }
    function Q (N, R) {
      typeof N === 'string' && (N = [N])
      const le = []
      ...
      for (let F = 0; F < N.length; ++F) o.defineMIME(N[F], R)
    }
    ...
    Q(['text/x-c++src', 'text/x-c++hdr'], {
      ...
      keywords: s(g + ' ' + T),
      types: z,
      blockKeywords: s(_ + ' class try catch'),
      ...
      return function (R, le) {
        for (var xe; (xe = R.next());) {
          if (xe == '*' && R.eat('/')) {
            ...
            return ((le.tokenize = V(N + 1)), le.tokenize(R, le))
          }
        }
        return 'comment'
      }
    ...
    (Q('text/x-kotlin', {
      ...
      hooks: {
        ...
        '"': function (N, R) {
          return ((R.tokenize = y(N.match('""'))), R.tokenize(N, R))
        },
        '/': function (N, R) {
          return N.eat('*')
            ? ((R.tokenize = V(1)), R.tokenize(N, R))
    ...
    Q('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function (N, R) {
          return (
            (R.tokenize = X(N.match('""') ? 'triple' : 'single')),
            R.tokenize(N, R)
          )
        },
        '`': function (N, R) {
          return !K || !N.match('`')
            ? !1
            : ((R.tokenize = K), (K = null), R.tokenize(N, R))
        },
        "'": function (N) {
      ...
      return (
        (He.top = function (te, fe, oe) {
          ...
          if (Ee && /@component/i.test(te)) {
            return Re(oe, fe, 'atComponentBlock')
          }
          if (/^@(-moz-)?document$/i.test(te)) {
            return Re(oe, fe, 'documentTypes')
          }
          if (
            /^@(media|supports|(-moz-)?document|import)$/i.test(te)
          ) {
            return Re(oe, fe, 'atBlock')
          }
        ...
        (He.atBlock = function (te, fe, oe) {
          ...
          if (te == '}' || te == ';') return Z(te, fe, oe)
          if (te == '{') {
            return Ge(oe) && Re(oe, fe, ze ? 'block' : 'top')
          }
          if (te == 'interpolation') {
            return Re(oe, fe, 'interpolation')
          }
    ...
    (o.defineMode('xml', function (C, b) {
      ...
      function d (y, K) {
        ...
        if (X == '<') {
          ...
          const N = K.tokenize(y, K)
          return N ? N + ' tag error' : 'tag error'
        } else {
          return /[\'\"]/.test(X)
            ? ((K.tokenize = k(X)),
              (K.stringStartCol = y.column()),
              K.tokenize(y, K))
            : (y.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/),
              'word')
        }
      ...
      function M (y) {
        return function (K, X) {
          for (var N; (N = K.next()) != null;) {
            if (N == '<') {
              return ((X.tokenize = M(y + 1)), X.tokenize(K, X))
            }
            if (N == '>') {
              if (y == 1) {
                X.tokenize = c
      ...
      function O (y, K) {
        for (var X; ;) {
          if (
            !y.context ||
                        ((X = y.context.tagName),
                        !s.contextGrabbers.hasOwnProperty(_(X)) ||
                            !s.contextGrabbers[_(X)].hasOwnProperty(_(K)))
          ) {
            return
          }
          E(y)
      ...
      function J (y, K, X) {
        return y == 'word'
          ? ((X.tagName = K.current()), (w = 'tag'), D)
          : s.allowMissingTagName && y == 'endTag'
            ? ((w = 'tag bracket'), D(y, K, X))
            : ((w = 'error'), J)
      }
      function re (y, K, X) {
        if (y == 'word') {
          ...
          return s.allowMissingTagName && y == 'endTag'
            ? ((w = 'tag bracket'), q(y, K, X))
            : ((w = 'error'), I)
        }
      }
      function q (y, K, X) {
        return y != 'endTag' ? ((w = 'error'), q) : (E(X), G)
      }
      function I (y, K, X) {
        return ((w = 'error'), q(y, K, X))
      }
      function D (y, K, X) {
        if (y == 'word') return ((w = 'attribute'), Q)
        if (y == 'endTag' || y == 'selfcloseTag') {
          ...
          return (
            ...
            y == 'selfcloseTag' ||
                        s.autoSelfClosers.hasOwnProperty(_(N))
              ? O(X, N)
              : (O(X, N),
                (X.context = new W(X, N, R == X.indented))),
            G
          )
        }
        return ((w = 'error'), D)
      ...
      function Q (y, K, X) {
        return y == 'equals'
          ? j
          : (s.allowMissing || (w = 'error'), D(y, K, X))
      }
      function j (y, K, X) {
        return y == 'string'
          ? V
      ...
      return {
        startState: function (y) {
          ...
          return (y != null && (K.baseIndent = y), K)
        },
        token: function (y, K) {
          if (
            (!K.tagName &&
                            y.sol() &&
                            (K.indented = y.indentation()),
            y.eatSpace())
          ) {
            return null
          }
          T = null
          let X = K.tokenize(y, K)
          return (
            (X || T) &&
                            X != 'comment' &&
                            ((w = null),
                            (K.state = K.state(T || X, y, K)),
                            w && (X = w == 'error' ? X + ' error' : w)),
            X
          )
        },
        indent: function (y, K, X) {
          let N = y.context
          if (y.tokenize.isInAttribute) {
            return y.tagStart == y.indented
              ? y.stringStartCol + 1
              : y.indented + S
          }
          if (N && N.noIndent) return o.Pass
          if (y.tokenize != d && y.tokenize != c) {
          ...
          if (R && R[1]) {
            for (; N;) {
              if (N.tagName == R[2]) {
                ...
                s.implicitlyClosed.hasOwnProperty(_(N.tagName))
              ) {
                N = N.prev
              } else break
            }
            ...
            for (; N;) {
              const le = s.contextGrabbers[_(N.tagName)]
              if (le && le.hasOwnProperty(_(R[2]))) N = N.prev
              else break
            }
          }
          for (; N && N.prev && !N.startOfLine;) N = N.prev
          return N ? N.indent + S : y.baseIndent || 0
        },
        electricInput: /<\/[\s\w:]+>$/,
        blockCommentStart: '<!--',
        blockCommentEnd: '-->',
        ...
        xmlCurrentTag: function (y) {
          return y.tagName
            ? { name: y.tagName, close: y.type == 'closeTag' }
            : null
        },
        xmlCurrentContext: function (y) {
          for (var K = [], X = y.context; X; X = X.prev) {
            K.push(X.tagName)
          }
          return K.reverse()
        }
  ...
  (function (o) {
    ...
    (o.defineMode('javascript', function (p, v) {
      ...
      const w = (function () {
        ...
        const P = x('keyword a')
        const ae = x('keyword b')
        const he = x('keyword c')
        const ne = x('keyword d')
        const ye = x('operator')
      ...
      function k (x) {
        for (var P = !1, ae, he = !1; (ae = x.next()) != null;) {
          if (!P) {
            if (ae == '/' && !he) return
            ae == '[' ? (he = !0) : he && ae == ']' && (he = !1)
          }
      ...
      function W (x, P) {
        const ae = x.next()
        if (ae == '"' || ae == "'") {
          return ((P.tokenize = E(ae)), P.tokenize(x, P))
        }
        if (ae == '.' && x.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) {
          return _('number', 'number')
        }
        if (ae == '.' && x.match('..')) return _('spread', 'meta')
        if (/[\[\]{}\(\),;\:\.]/.test(ae)) return _(ae)
        if (ae == '=' && x.eat('>')) return _('=>', 'operator')
        if (
          ae == '0' &&
        ...
        if (ae == '/') {
          return x.eat('*')
            ? ((P.tokenize = O), O(x, P))
            : x.eat('/')
              ? (x.skipToEnd(), _('comment', 'comment'))
              : Bt(x, P, 1)
                ? (k(x),
                  x.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/),
                  _('regexp', 'string-2'))
                : (x.eat('='),
                  _('operator', 'operator', x.current()))
        }
        if (ae == '`') return ((P.tokenize = G), G(x, P))
        if (ae == '#' && x.peek() == '!') {
          return (x.skipToEnd(), _('meta', 'meta'))
        }
        if (ae == '#' && x.eatWhile(T)) {
          return _('variable', 'property')
        }
        if (
          (ae == '<' && x.match('!--')) ||
                    (ae == '-' &&
          ...
          return (x.skipToEnd(), _('comment', 'comment'))
        }
        if (c.test(ae)) {
          return (
        ...
        if (T.test(ae)) {
          ...
          const he = x.current()
          if (P.lastType != '.') {
            if (w.propertyIsEnumerable(he)) {
              const ne = w[he]
              return _(ne.type, ne.style, he)
            }
            if (
              he == 'async' &&
                            x.match(
              ...
              return _('async', 'keyword', he)
            }
          }
          return _('variable', 'variable', he)
        }
      }
      function E (x) {
        return function (P, ae) {
          ...
          if (S && P.peek() == '@' && P.match(d)) {
            return ((ae.tokenize = W), _('jsonld-keyword', 'meta'))
          }
          for (; (ne = P.next()) != null && !(ne == x && !he);) {
            he = !he && ne == '\\'
          }
          return (he || (ae.tokenize = W), _('string', 'string'))
        }
      }
      function O (x, P) {
        for (var ae = !1, he; (he = x.next());) {
          if (he == '/' && ae) {
            P.tokenize = W
            break
          }
      ...
      function G (x, P) {
        for (var ae = !1, he; (he = x.next()) != null;) {
          if (!ae && (he == '`' || (he == '$' && x.eat('{')))) {
            P.tokenize = W
            break
          }
        ...
        return _('quasi', 'string-2', x.current())
      }
      const J = '([{}])'
      function re (x, P) {
        P.fatArrowAt && (P.fatArrowAt = null)
        let ae = x.string.indexOf('=>', x.start)
        if (!(ae < 0)) {
          if (g) {
            const he =
                            /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(
      ...
      function D (x, P) {
        ...
        for (let he = x.context; he; he = he.prev) {
          for (var ae = he.vars; ae; ae = ae.next) {
            if (ae.name == P) return !0
          }
        }
      }
      function Q (x, P, ae, he, ne) {
        const ye = x.cc
        for (
          j.state = x,
          j.stream = ne,
      ...
      function V () {
        for (let x = arguments.length - 1; x >= 0; x--) {
      ...
      function K (x, P) {
        for (let ae = P; ae; ae = ae.next) if (ae.name == x) return !0
        return !1
      }
      function X (x) {
        const P = j.state
        if (((j.marked = 'def'), !!h)) {
          if (P.context) {
            if (
              ...
              const ae = N(x, P.context)
              if (ae != null) {
                P.context = ae
                return
              }
            } else if (!K(x, P.localVars)) {
              P.localVars = new xe(x, P.localVars)
              return
            }
          }
          v.globalVars &&
                        !K(x, P.globalVars) &&
                        (P.globalVars = new xe(x, P.globalVars))
        }
      }
      function N (x, P) {
        if (P) {
          if (P.block) {
            ...
            return K(x, P.vars)
              ? P
              : new le(P.prev, new xe(x, P.vars), !1)
          }
        } else return null
      }
      function R (x) {
                      ...
                      : x == 'if'
                        ? (j.state.lexical.info == 'else' &&
                                        j.state.cc[j.state.cc.length - 1] ==
                                            Ee &&
                                        j.state.cc.pop()(),
                          y(pe('form'), Ze, Oe, Ee, Hr))
                        : x == 'function'
                          ? y(Ht)
                          : x == 'for'
                            ? y(pe('form'), de, ei, Oe, ze, Ee)
      ...
      function Ze (x) {
        return x != '(' ? V() : y(pe(')'), Je, ge(')'), Ee)
      }
      function ke (x, P, ae) {
        if (j.state.fatArrowAt == j.stream.start) {
          const he = ae ? He : ce
          if (x == '(') {
            return y(L, pe(')'), H($t, ')'), Ee, ge('=>'), he, ze)
          }
          if (x == 'variable') return V(L, Ct, ge('=>'), he, ze)
        }
        const ne = ae ? Ge : Re
        return q.hasOwnProperty(x)
          ? y(ne)
          : x == 'function'
            ? y(Ht, ne)
            : x == 'class' || (g && P == 'interface')
              ? ((j.marked = 'keyword'), y(pe('form'), to, Ee))
              : x == 'keyword c' || x == 'async'
                ? y(ae ? Be : Se)
                : x == '('
                  ? y(pe(')'), Je, ge(')'), Ee, ne)
      ...
      function Ge (x, P, ae) {
        ...
        if (x == 'quasi') return V(U, he)
        if (x != ';') {
          if (x == '(') return se(Be, ')', 'call', he)
          if (x == '.') return y(we, he)
          if (x == '[') return y(pe(']'), Je, ge(']'), Ee, he)
          if (g && P == 'as') {
            return ((j.marked = 'keyword'), y(Pe, he))
          }
          if (x == 'regexp') {
            return (
      ...
      function Me (x, P) {
        ...
        if (x == 'variable' || j.style == 'keyword') {
          ...
          if (x == 'jsonld-keyword') return y($)
          if (g && R(P)) return ((j.marked = 'keyword'), y(Me))
          if (x == '[') return y(Se, nt, ge(']'), $)
          if (x == 'spread') return y(Be, $)
      ...
      function Pe (x, P) {
        ...
        if (x == '[') return y(pe(']'), H(Pe, ']', ','), Ee, Rt)
        if (x == '{') return y(pe('}'), Ie, Ee, Rt)
        if (x == '(') return y(H(ot, ')'), xt, Rt)
        if (x == '<') return y(H(Pe, '>'), Pe)
      ...
      function Hr (x, P) {
        if (x == 'keyword b' && P == 'else') {
          return y(pe('form', 'else'), Oe, Ee)
        }
      }
      function ei (x, P) {
        if (P == 'await') return y(ei)
        if (x == '(') return y(pe(')'), xn, Ee)
      }
      function xn (x) {
      ...
      function Ht (x, P) {
        ...
        if (x == '(') return y(L, pe(')'), H($t, ')'), Ee, Pt, Oe, ze)
        if (g && P == '<') return y(pe('>'), H(Wt, '>'), Ee, Ht)
      }
      function hr (x, P) {
        if (P == '*') return ((j.marked = 'keyword'), y(hr))
        if (x == 'variable') return (X(P), y(hr))
        if (x == '(') return y(L, pe(')'), H($t, ')'), Ee, Pt, ze)
        if (g && P == '<') return y(pe('>'), H(Wt, '>'), Ee, hr)
      }
      function ti (x, P) {
        if (x == 'keyword' || x == 'variable') {
          return ((j.marked = 'type'), y(ti))
        }
        if (P == '<') return y(pe('>'), H(Wt, '>'), Ee)
      }
      function $t (x, P) {
        return (
          P == '@' && y(Se, $t),
      ...
      function Ae () {
        return V(pe('form'), Ct, ge('{'), pe('}'), H(ir, '}'), Ee, Ee)
      }
      function ir () {
        return V(Ct, Ut)
      }
      ...
      return {
        ...
        token: function (x, P) {
          if (
            (x.sol() &&
                            ...
                            re(x, P)),
            P.tokenize != O && x.eatSpace())
          ) {
            return null
          }
          const ae = P.tokenize(x, P)
          return z == 'comment'
            ? ae
            : ((P.lastType =
                              z == 'operator' && (M == '++' || M == '--')
        ...
        indent: function (x, P) {
          if (x.tokenize == O || x.tokenize == G) return o.Pass
          if (x.tokenize != W) return 0
          const ae = P && P.charAt(0)
          let he = x.lexical
          let ne
          if (!/^\s*else\b/.test(P)) {
            for (let ye = x.cc.length - 1; ye >= 0; --ye) {
              const Xe = x.cc[ye]
              if (Xe == Ee) he = he.prev
...
const Qn = Ke((Os, Ps) => {
  (function (o) {
    ...
    function v (T, w, c) {
      ...
      return (
        k > -1
          ? T.backUp(d.length - k)
          : d.match(/<\/?$/) &&
                      (T.backUp(d.length), T.match(w, !1) || T.match(d)),
        c
      )
    }
    const C = {}
    ...
    function s (T, w) {
      return new RegExp((w ? '^' : '') + '</\\s*' + T + '\\s*>', 'i')
    }
    function h (T, w) {
      for (const c in T) {
        for (
          let d = w[c] || (w[c] = []), k = T[c], z = k.length - 1;
          z >= 0;
          z--
        ) {
          d.unshift(k[z])
    ...
    function g (T, w) {
      for (let c = 0; c < T.length; c++) {
        const d = T[c]
        if (!d[0] || d[1].test(S(w, d[0]))) return d[2]
      }
    }
    (o.defineMode(
      'htmlmixed',
          ...
          : c.match(/\b(\w+)\b/)
            ...
            : c.match('%}')
              ? ((d.waitProperty = null),
                ...
                (d.waitPipe = null),
                d.blockCommentTag
                  ? ((d.blockCommentTag = !1), (d.tokenize = w))
                  : (d.tokenize = S),
                'tag')
              : (c.next(), 'null')
      }
...
const Di = Ke((Hs, Ws) => {
  (function (o) {
    ...
    'use strict';
    ((o.defineSimpleMode = function (w, c) {
      o.defineMode(w, function (d) {
        return o.simpleMode(d, c)
      })
    }),
    (o.simpleMode = function (w, c) {
      p(c, 'start')
      const d = {}
      const k = c.meta || {}
      let z = !1
    ...
    function C (w) {
      ...
      for (var c = [], d = 0; d < w.length; d++) {
        c.push(w[d] && w[d].replace(/\./g, ' '))
      }
      return c
    }
    function b (w, c) {
      ((w.next || w.push) && p(c, w.next || w.push),
      (this.regex = v(w.regex)),
      (this.token = C(w.token)),
      (this.data = w))
    }
    function S (w, c) {
      return function (d, k) {
        ...
        if (k.local) {
          if (k.local.end && d.match(k.local.end)) {
            ...
            return (
              k.local.endScan &&
                                (_ = k.local.endScan.exec(d.current())) &&
                                (d.pos = d.start + _.index),
              M
            )
          }
        }
        for (let W = w[k.state], E = 0; E < W.length; E++) {
          const O = W[E]
    ...
    function s (w, c) {
      if (w === c) return !0
      if (!w || typeof w !== 'object' || !c || typeof c !== 'object') {
        return !1
      }
      let d = 0
      for (var k in w) {
        if (w.hasOwnProperty(k)) {
          if (!c.hasOwnProperty(k) || !s(w[k], c[k])) return !1
          d++
        }
      }
    ...
    function h (w, c, d, k) {
      ...
      const _ = z ? z.mode : d.mode || o.getMode(w, d.spec)
      const W = z ? z.state : o.startState(_);
      (d.persistent &&
                !z &&
                (c.persistentStates = {
                  mode: _,
    ...
    function g (w, c) {
      for (let d = 0; d < c.length; d++) if (c[d] === w) return !0
    }
    function T (w, c) {
  ...
  (function (o) {
    ...
    (o.defineSimpleMode('dockerfile', {
      start: [
        ...
        { regex: w, token: [null, 'keyword', null, 'error'], sol: !0 },
        {
          regex: b,
      ...
      function (p, v) {
        ...
        function J (F) {
          if (
            ...
            L && ((F.f = j), (F.block = re), (F.htmlState = null))
          }
          return (
            (F.trailingSpace = 0),
        ...
        function re (F, L) {
          ...
          if (
            ...
            return (
              ...
              (L.code = !1),
              (L.strikethrough = !1),
              v.taskLists && F.match(w, !1) && (L.taskList = !0),
              (L.f = L.inline),
        ...
        function j (F, L) {
          ...
          if (pe === '*' || pe === '_') {
            ...
            const Z =
                            !/\s/.test(U) &&
                            (!_.test(U) || /\s/.test(Ge) || _.test(Ge))
            const ce =
                            !/\s/.test(Ge) &&
                            (!_.test(Ge) || /\s/.test(U) || _.test(U))
            let He = null
            let te = null
            if (
              (Re % 2 &&
                                (!L.em && Z && (pe === '*' || !ce || _.test(Ge))
                                  ? (He = !0)
                                  : L.em == pe &&
                                      ce &&
                                      (pe === '*' || !Z || _.test(U)) &&
        ...
        const s = {
          ...
          token: function (T, w) {
            ...
            if (
              ...
              return (T.skipToEnd(), (w.codeBlock = !0), null)
            }
            if (T.peek() === '`') {
              T.next()
              const c = T.pos
            ...
            } else if (w.code) return (T.next(), null)
            if (T.eatSpace()) return ((w.ateSpace = !0), null)
            if (
              (T.sol() || w.ateSpace) &&
                            ((w.ateSpace = !1), C.gitHubSpice !== !1)
            ) {
              if (
                T.match(
  ...
  (function (o) {
    ...
    (o.defineMode('go', function (p) {
      ...
      function h (k, z) {
        ...
        k.eatWhile(/[\w\$_\xa1-\uffff]/)
        const _ = k.current()
        return C.propertyIsEnumerable(_)
          ? ((_ == 'case' || _ == 'default') && (s = 'case'),
            'keyword')
          : b.propertyIsEnumerable(_)
            ? 'atom'
            : 'variable'
      }
      function g (k) {
        return function (z, M) {
          for (var _ = !1, W, E = !1; (W = z.next()) != null;) {
            if (W == k && !_) {
              E = !0
              break
            }
      ...
      function c (k, z, M) {
        return (k.context = new w(k.indented, z, M, null, k.context))
      }
      function d (k) {
        if (k.context.prev) {
...
const au = Ke((iu, ou) => {
  (function (o) {
    ...
    (o.defineMode('http', function () {
      function p (T, w) {
        return (T.skipToEnd(), (w.cur = h), 'error')
      }
      function v (T, w) {
      ...
      function b (T, w) {
        return (T.skipToEnd(), (w.cur = h), null)
      }
      function S (T, w) {
        return (T.eatWhile(/\S/), (w.cur = s), 'string-2')
      }
      function s (T, w) {
        return T.match(/^HTTP\/\d\.\d$/)
          ? ((w.cur = h), 'keyword')
      ...
      return {
        token: function (T, w) {
          const c = w.cur
          return c != h && c != g && T.eatSpace() ? null : c(T, w)
        },
...
const gu = Ke((pu, hu) => {
  (function (o) {
    ...
    (o.defineMode('nginx', function (p) {
      function v (k) {
        for (var z = {}, M = k.split(' '), _ = 0; _ < M.length; ++_) {
          z[M[_]] = !0
        }
        return z
      }
      ...
      function T (k, z) {
        ...
        if (_ == '/' && k.eat('*')) return ((z.tokenize = w), w(k, z))
        if (_ == '<' && k.eat('!')) return ((z.tokenize = c), c(k, z))
        if (_ == '=') g(null, 'compare')
        else {
          return (_ == '~' || _ == '|') && k.eat('=')
            ? g(null, 'compare')
            : _ == '"' || _ == "'"
              ? ((z.tokenize = d(_)), z.tokenize(k, z))
              : _ == '#'
      ...
      return {
        ...
        token: function (k, z) {
          ...
          const _ = z.stack[z.stack.length - 1]
          return (
            h == 'hash' && _ == 'rule'
              ? (M = 'atom')
              : M == 'variable' &&
...
const bu = Ke((mu, vu) => {
  (function (o) {
    ...
    (o.defineMode('pascal', function () {
      function p (T) {
        for (var w = {}, c = T.split(' '), d = 0; d < c.length; ++d) {
          w[c[d]] = !0
        }
        return w
      }
      ...
      function S (T, w) {
        const c = T.next()
        if (c == '#' && w.startOfLine) return (T.skipToEnd(), 'meta')
        if (c == '"' || c == "'") {
          return ((w.tokenize = s(c)), w.tokenize(T, w))
        }
        if (c == '(' && T.eat('*')) return ((w.tokenize = h), h(T, w))
        if (c == '{') return ((w.tokenize = g), g(T, w))
      ...
      function s (T) {
        return function (w, c) {
          for (var d = !1, k, z = !1; (k = w.next()) != null;) {
            if (k == T && !d) {
              z = !0
              break
            }
    ...
    (o.defineMode('perl', function () {
      ...
      function g (c, d, k, z, M) {
        return (
          ...
          (d.style = null),
          (d.tail = null),
          (d.tokenize = function (_, W) {
            for (var E = !1, O, G = 0; (O = _.next());) {
              if (O === k[G] && !E) {
                return (
                  k[++G] !== void 0
                    ? ((W.chain = k[G]),
      ...
      function w (c, d) {
        ...
        if (k == 'q') {
          ...
          if (!(_ && /\w/.test(_))) {
            if (((_ = p(c, 0)), _ == 'x')) {
              ...
              if (/[\^'"!~\/]/.test(_)) {
                return (b(c, 1), g(c, d, [c.eat(_)], s, h))
              }
            } else if (_ == 'q') {
              if (((_ = p(c, 1)), _ == '(')) {
              ...
              if (/[\^'"!~\/]/.test(_)) {
                return (b(c, 1), g(c, d, [c.eat(_)], 'string'))
              }
            } else if (_ == 'w') {
              if (((_ = p(c, 1)), _ == '(')) {
        ...
        if (k == 'm') {
          ...
          if (
            ...
            if (/[\^'"!~\/]/.test(_)) return g(c, d, [_], s, h)
            if (_ == '(') return g(c, d, [')'], s, h)
            if (_ == '[') return g(c, d, [']'], s, h)
            if (_ == '{') return g(c, d, ['}'], s, h)
            if (_ == '<') return g(c, d, ['>'], s, h)
          }
        ...
        if (
          ...
          var _ = c.current()
          return S[_] ? 'variable-2' : 'variable'
        }
        if (k == '#' && p(c, -2) != '$') {
...
const Su = Ke((ku, wu) => {
  (function (o) {
      ...
      return T.length == 0
        ...
        : function (d, k) {
          for (let z = T[0], M = 0; M < z.length; M++) {
            if (d.match(z[M][0])) {
              return ((k.tokenize = v(T.slice(1), w)), z[M][1])
            }
          }
          return ((k.tokenize = C(w, c)), 'string')
        }
    }
    function C (T, w) {
      return function (c, d) {
      ...
      hooks: {
        ...
        '<': function (T, w) {
          ...
          if ((c = T.match(/^<<\s*/))) {
            ...
            if ((d && T.eat(d), k)) {
              return (
                (w.tokStack || (w.tokStack = [])).push(k, 0),
                (w.tokenize = C(k, d != "'")),
                'string'
              )
            }
        ...
        '{': function (T, w) {
          return (
            w.tokStack &&
                            w.tokStack.length &&
                            w.tokStack[w.tokStack.length - 1]++,
            !1
          )
        },
        '}': function (T, w) {
          return (
            w.tokStack &&
                            w.tokStack.length > 0 &&
                            !--w.tokStack[w.tokStack.length - 1] &&
                            (w.tokenize = C(w.tokStack[w.tokStack.length - 2])),
            !1
          )
        }
      }
    ...
    (o.defineMode(
      'php',
      function (T, w) {
        const c = o.getMode(T, (w && w.htmlMode) || 'text/html')
        ...
        function k (z, M) {
          ...
          if (
            ...
            return _ && M.php.tokenize == null && z.match('?>')
              ? ((M.curMode = c),
                (M.curState = M.html),
        ...
        return {
          startState: function () {
            ...
            const M = w.startOpen ? o.startState(d) : null
            return {
              html: z,
              php: M,
              curMode: w.startOpen ? d : c,
              curState: w.startOpen ? M : z,
              pending: null
            }
          },
          copyState: function (z) {
            const M = z.html
            const _ = o.copyState(c, M)
            const W = z.php
          ...
          token: k,
          indent: function (z, M, _) {
            return (z.curMode != d && /^\s*<\//.test(M)) ||
                            (z.curMode == d && /^\?>/.test(M))
              ? c.indent(z.html, M, _)
              : z.curMode.indent(z.curState, M, _)
          },
          blockCommentStart: '/*',
          blockCommentEnd: '*/',
          lineComment: '//',
...
const Mu = Ke((Eu, zu) => {
  (function (o) {
    ...
    (o.defineMode('python', function (h, g) {
      ...
      const _ = !(g.version && Number(g.version) < 3)
      if (_) {
        var W =
                    g.identifiers ||
                    /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/;
        ...
        function xe (F, L) {
          for (; !F.eol();) {
            if ((F.eatWhile(/[^'"\{\}\\]/), F.eat('\\'))) {
              ...
              if (F.match(K)) return ((L.tokenize = X), R)
              if (F.match('{{')) return R
              if (F.match('{', !1)) {
                return (
                  (L.tokenize = le(0)),
                  F.current() ? R : L.tokenize(F, L)
                )
              }
              if (F.match('}}')) return R
              if (F.match('}')) return T
        ...
        function le (xe, F) {
          for (; !xe.eol();) {
            if ((xe.eatWhile(/[^'"\\]/), xe.eat('\\'))) {
              if ((xe.next(), N && xe.eol())) return R
            } else {
              if (xe.match(K)) return ((F.tokenize = X), R)
              xe.eat(/['"]/)
            }
          }
          if (N) {
      ...
      function Q (K, X, N) {
        const R = K.match(/^[\s\[\{\(]*(?:#|$)/, !1)
          ? null
          : K.column() + 1
        X.scopes.push({ offset: X.indent + k, type: N, align: R })
      }
      function j (K, X) {
        for (
          var N = K.indentation();
      ...
      function V (K, X) {
        ...
        if (X.beginningOfLine && R == '@') {
          return K.match(W, !1) ? 'meta' : _ ? 'operator' : T
        }
        if (
...
const qu = Ke((Au, Du) => {
  (function (o) {
    ...
    'use strict'
    function p (g) {
      for (var T = {}, w = 0, c = g.length; w < c; ++w) T[g[w]] = !0
      return T
    }
    const v = [
      'alias',
    ...
    (o.defineMode('ruby', function (g) {
      ...
      function c (E, O) {
        ...
        let J
        if (G == '`' || G == "'" || G == '"') {
          return w(M(G, 'string', G == '"' || G == '`'), E, O)
        }
        if (G == '/') {
          return d(E) ? w(M(G, 'string-2', !0), E, O) : 'operator'
        }
        if (G == '%') {
          let re = 'string'
          let q = !0
    ...
    (o.defineMode(
      ...
      function (p) {
        ...
        function J (q, I) {
          ...
          if (q.match('/*')) {
            return (
              (I.tokenizer = _(q.indentation(), !0)),
              I.tokenizer(q, I)
            )
          }
          if (q.match('//')) {
            return (
              (I.tokenizer = _(q.indentation(), !1)),
              I.tokenizer(q, I)
            )
          }
          if (q.match('#{')) {
          ...
          if (((Q === '@return' || Q === '}') && G(I), D !== null)) {
            for (
              var j = q.pos - Q.length,
                V = j + p.indentUnit * I.indentCount,
                y = [],
                K = 0;
              K < I.scopes.length;
              K++
    ...
    (o.defineMode('shell', function () {
      ...
      function s (d, k) {
        ...
        if (M == '<') {
          ...
          const _ = d.match(/^<-?\s*['"]?([^'"]*)['"]?/)
          if (_) return (k.tokens.unshift(w(_[1])), 'string-2')
        }
        if (
          /\d/.test(M) &&
        ...
        return function (M, _) {
          for (var W, E = !1; (W = M.next()) != null;) {
            if (W === z && !E) {
              ...
              ((E = !0), M.backUp(1), _.tokens.unshift(T))
              break
            } else {
              if (!E && d !== z && W === d) {
                return (_.tokens.unshift(h(d, k)), c(M, _))
              }
              if (!E && /['"]/.test(W) && !/['"]/.test(d)) {
                (_.tokens.unshift(g(W, 'string')), M.backUp(1))
                break
              }
            }
            E = !E && W === '\\'
...
const Uu = Ke((Hu, Wu) => {
  (function (o) {
    ...
    o.defineMode('sql', function (g, T) {
      ...
      return {
        ...
        indent: function (Q, j) {
          const V = Q.context
          if (!V) return o.Pass
          const y = j.charAt(0) == V.type
          return V.align
            ? V.col + (y ? 0 : 1)
            : V.indent + (y ? 0 : g.indentUnit)
        },
        blockCommentStart: '/*',
        blockCommentEnd: '*/',
    ...
    function s (g) {
      for (var T = {}, w = g.split(' '), c = 0; c < w.length; ++c) {
        T[w[c]] = !0
      }
      return T
    }
  ...
  (function (o) {
    ...
    o.defineMode('stylus', function (E) {
      ...
      function ke ($, H, se, De) {
        return (
          (De = De >= 0 ? De : O),
          ($.context = new Ze(se, H.indentation() + De, $.context)),
          se
        )
      }
      function Je ($, H) {
      ...
      function Re ($, H, se) {
        return de[se.context.type]($, H, se)
      }
      function Ge ($, H, se, De) {
      ...
      function Le ($) {
        const H = /^\s*[-_]*[a-z0-9]+[\w-]*/i
        const se =
                    typeof $ === 'string' ? $.match(H) : $.string.match(H)
        return se ? se[0].replace(/^\s*/, '') : ''
      }
      return (
        (de.block = function ($, H, se) {
          if (
            ($ == 'comment' && we(H)) ||
                        ($ == ',' && Me(H)) ||
                        $ == 'mixin'
          ) {
            return ke(se, H, 'block', 0)
          }
          if (oe($, H)) return ke(se, H, 'interpolation')
          if (
            Me(H) &&
                        $ == ']' &&
                        !/^\s*(\.|#|:|\[|\*|&)/.test(H.string) &&
          ...
          if (fe($, H)) return ke(se, H, 'block')
          if ($ == '}' && Me(H)) return ke(se, H, 'block', 0)
          if ($ == 'variable-name') {
            return H.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/) ||
                            ce(Le(H))
              ? ke(se, H, 'variableName')
              : ke(se, H, 'variableName', 0)
          }
          if ($ == '=') {
            return !Me(H) && !ce(Le(H))
              ? ke(se, H, 'block', 0)
          ...
          if (
            ...
            return ((ge = 'tag'), ke(se, H, 'block'))
          }
          if (Ue($, H)) return ke(se, H, 'pseudo')
          if (
            /@(font-face|media|supports|(-moz-)?document)/.test($)
          ) {
            return ke(se, H, Me(H) ? 'block' : 'atBlock')
          }
          if (/@(-(moz|ms|o|webkit)-)?keyframes$/.test($)) {
            return ke(se, H, 'keyframes')
          }
          if (/@extends?/.test($)) return ke(se, H, 'extend', 0)
          if ($ && $.charAt(0) == '@') {
          ...
          if ($ == 'reference' && Me(H)) return ke(se, H, 'block')
          if ($ == '(') return ke(se, H, 'parens')
          if ($ == 'vendor-prefixes') {
            return ke(se, H, 'vendorPrefixes')
          }
          if ($ == 'word') {
            const De = H.current()
            ...
            if (ge == 'tag') {
              ...
              if (
                ...
                return (
                  (ge = 'variable-2'),
                  ce(Le(H)) ? 'block' : ke(se, H, 'block', 0)
                )
              }
              if (Me(H)) return ke(se, H, 'block')
            }
            if (ge == 'block-keyword') {
              return (
                (ge = 'keyword'),
            ...
            if (De == 'return') return ke(se, H, 'block', 0)
            if (
              ge == 'variable-2' &&
                            H.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/)
            ) {
              return ke(se, H, 'block')
            }
          }
          return se.context.type
        }),
        (de.parens = function ($, H, se) {
          if ($ == '(') return ke(se, H, 'parens')
          if ($ == ')') {
        ...
        (de.vendorPrefixes = function ($, H, se) {
          return $ == 'word'
            ? ((ge = 'property'), ke(se, H, 'block', 0))
            : Je(se)
        }),
        (de.pseudo = function ($, H, se) {
          return Z(Le(H.string))
            ? Ge($, H, se)
            : (H.match(/^[a-z-]+/),
              (ge = 'variable-3'),
              Me(H) ? ke(se, H, 'block') : Je(se))
        }),
        (de.atBlock = function ($, H, se) {
          if ($ == '(') return ke(se, H, 'atBlock_parens')
          if (fe($, H)) return ke(se, H, 'block')
          if (oe($, H)) return ke(se, H, 'interpolation')
          if ($ == 'word') {
            const De = H.current().toLowerCase()
            if (
        ...
        (de.atBlock_parens = function ($, H, se) {
          ...
          return de.atBlock($, H, se)
        }),
        (de.keyframes = function ($, H, se) {
              ...
              : $ == '}'
                ...
                : $ == 'unit' && /^[0-9]+\%$/.test(H.current())
                  ...
                  : $ == 'word' &&
                                  ((ge = te(H.current())),
                                  ge == 'block-keyword')
                    ? ((ge = 'keyword'), ke(se, H, 'keyframes'))
                    : /@(font-face|media|supports|(-moz-)?document)/.test(
                      $
                    )
                      ? ke(se, H, Me(H) ? 'block' : 'atBlock')
                      : $ == 'mixin'
                        ? ke(se, H, 'block', 0)
                        : se.context.type
        }),
        (de.interpolation = function ($, H, se) {
          return (
            $ == '{' && Je(se) && ke(se, H, 'block'),
            $ == '}'
              ? H.string.match(
            ...
            return !H.tokenize && $.eatSpace()
              ...
              : ((pe = (H.tokenize || Oe)($, H)),
                pe &&
                                  ...
                                  ((Ee = pe[1]), (pe = pe[0])),
                (ge = pe),
                (H.state = de[H.state](Ee, $, H)),
                ge)
          },
          indent: function ($, H, se) {
            const De = $.context
            const nt = H && H.charAt(0)
            let dt = De.indent
            const Pt = Le(H)
    ...
    const z = p.concat(v, C, b, S, s, g, T, h, w, c, d, k)
    function M (E) {
      return (
...
const Xu = Ke((Gu, Zu) => {
  (function (o) {
    ...
    function _ (q, I, D) {
      ...
      if (q.match(g) || q.match(T) || q.match(w) || q.match(c)) {
        return 'number'
      }
      ...
      if (q.match(d)) {
        ...
        return S.hasOwnProperty(y)
          ...
          : b.hasOwnProperty(y)
            ? 'atom'
            : v.hasOwnProperty(y)
              ? (C.hasOwnProperty(y) && (I.prev = 'define'),
                'keyword')
              : D == 'define'
                ? 'def'
                : 'variable'
    ...
    function E (q, I, D) {
      for (var Q = q.length == 1, j, V = !1; (j = I.peek());) {
        if (V) {
          if ((I.next(), j == '(')) {
    ...
    (o.defineMode('swift', function (q) {
      return {
        ...
        token: function (I, D) {
          const Q = D.prev
          D.prev = null
          const j = D.tokenize[D.tokenize.length - 1] || _
          const V = j(I, D, Q)
          if (
            (!V || V == 'comment'
              ? (D.prev = Q)
...
const Vu = Ke((Yu, Qu) => {
  (function (o) {
    ...
    (o.defineMode('coffeescript', function (p, v) {
        ...
        return function (j, V) {
          for (; !j.eol();) {
            if ((j.eatWhile(/[^'"\/\\]/), j.eat('\\'))) {
              ...
              if (j.match(I)) return ((V.tokenize = W), Q)
              j.eat(/['"\/]/)
            }
          }
          return (
      ...
      function G (I, D, Q) {
        Q = Q || 'coffee'
        for (var j = 0, V = !1, y = null, K = D.scope; K; K = K.prev) {
        ...
        (Q !== 'coffee'
          ? ((V = null), (y = I.column() + I.current().length))
      ...
      function J (I, D) {
        if (D.scope.prev) {
          if (D.scope.type === 'coffee') {
            for (
              var Q = I.indentation(), j = !1, V = D.scope;
              V;
              V = V.prev
            ) {
              if (Q === V.offset) {
...
function Pi (o) {
  ...
  function b (K, X, N, R, le) {
    ((N = N || K.getLineHandle(X)),
    (R = R || K.getTokenAt({ line: X, ch: 1 })),
    (le =
                le ||
                (!!N.text &&
                    K.getTokenAt({ line: X, ch: N.text.length - 1 }))))
    const xe = R.type ? R.type.split(' ') : []
    return le && C(le).indentedCode
      ? 'indented'
      : xe.indexOf('comment') === -1
        ? !1
        : C(R).fencedChars || C(le).fencedChars || v(N)
          ? 'fenced'
          : 'single'
  }
  function S (K, X, N, R) {
...
`),
  ...
  let w = s.getLineHandle(h.line)
  const c = b(s, h.line, w, T)
  let d
  let k
  let z
  if (c === 'single') {
    const M = w.text.slice(0, h.ch).replace('`', '')
    const _ = w.text.slice(h.ch).replace('`', '');
    (s.replaceRange(
      M + _,
      { line: h.line, ch: 0 },
    ...
    if (h.line !== g.line || h.ch !== g.ch) {
      for (d = h.line; d >= 0 && ((w = s.getLineHandle(d)), !v(w)); d--);
...
`),
      ...
      if (
        ...
        for (d = q; d >= 0 && ((w = s.getLineHandle(d)), !v(w)); d--);
      }
      if (k === void 0) {
        for (
          z = s.lineCount(), k = q;
          k < z && ((w = s.getLineHandle(k)), !v(w));
          k++
        );
      }
      (s.operation(function () {
    ...
    if (h.line !== g.line || h.ch !== g.ch) {
      ...
      for (d = h.line; d >= 0; d--) {
        if (
          ((w = s.getLineHandle(d)),
          !w.text.match(/^\s*$/) && b(s, d, w) !== 'indented')
        ) {
          d += 1
          break
        }
      ...
      for (z = s.lineCount(), k = h.line; k < z; k++) {
        if (
          ((w = s.getLineHandle(k)),
          !w.text.match(/^\s*$/) && b(s, k, w) !== 'indented')
        ) {
          k -= 1
          break
        }
...
`,
    ...
    for (let j = d; j <= k; j++) s.indentLine(j, 'subtract')
    s.focus()
  } else {
    const V = h.line === g.line && h.ch === g.ch && h.ch === 0
    const y = h.line !== g.line
    V || y ? S(s, h, g, p) : jr(s, !1, ['`', '`'])
  }
}
function Bi (o) {
...
function yc (o, p) {
  ...
  if (
    ...
    jr(v, C.image, b.insertTexts.uploadedImage, p)
  } else {
    const h = b.insertTexts.link;
    ((h[0] = '[' + S), jr(v, C.link, h, p))
  }
  (o.updateStatusBar(
    'upload-image',
...
function Xi (o) {
  ...
  const v = Tr(p)
  const C = o.options
  jr(p, v.table, C.insertTexts.table)
}
function Yi (o) {
  const p = o.codemirror
  const v = Tr(p)
  const C = o.options
  jr(p, v.image, C.insertTexts.horizontalRule)
}
function Qi (o) {
  const p = o.codemirror;
  (p.undo(), p.focus())
...
function bn (o) {
  ...
  if (
    (p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = w),
    S)
  ) {
...
function xc (o, p, v, C) {
  if (!(!o.codemirror || o.isPreviewActive())) {
    ...
    let w = T.slice(0, h.ch)
    let c = T.slice(h.ch);
    (p == 'link'
      ? (w = w.replace(/(.*)[^!]\[/, '$1'))
      : p == 'image' && (w = w.replace(/(.*)!\[$/, '$1')),
    (c = c.replace(/]\(.*?\)/, '')),
    b.replaceRange(
      w + c,
      { line: h.line, ch: 0 },
...
function Te (o) {
  ...
  if (
    ...
    o.autosave != null &&
            (o.autosave.timeFormat = fr({}, Rd, o.autosave.timeFormat || {})),
  ...
  Te.prototype.createStatusbar = function (o) {
    ...
    if (!(!o || o.length === 0)) {
      ...
      for (T.className = 'editor-statusbar', b = 0; b < C.length; b++) {
        ...
        ((c.className = w.className),
        typeof w.defaultValue === 'function' && w.defaultValue(c),
        typeof w.onUpdate === 'function' &&
                        this.codemirror.on(
                          'update',
                          (function (k, z) {
                            return function () {
...
function Kd ({
  ...
  return {
    ...
    async init () {
      ...
      this.editor.codemirror.on('changes', (d, k) => {
        try {
          ...
          if (z.origin === '+input') {
            const M = '(https://)'
            const _ = z.text[z.text.length - 1]
            if (_.endsWith(M) && _ !== '[]' + M) {
              const W = z.from
              const E = z.to
    ...
    getToolbar () {
      ...
      return (
        w.forEach((k) => {
          (k.forEach((z) => d.push(this.getToolbarButton(z))),
          k.length > 0 && d.push('|'))
        }),
        d[d.length - 1] === '|' && d.pop(),
        d
    ...
    getToolbarButton (d) {
      if (d === 'bold') return this.getBoldToolbarButton()
      if (d === 'italic') return this.getItalicToolbarButton()
      if (d === 'strike') return this.getStrikeToolbarButton()
      if (d === 'link') return this.getLinkToolbarButton()
      if (d === 'heading') return this.getHeadingToolbarButton()
      if (d === 'blockquote') return this.getBlockquoteToolbarButton()
      if (d === 'codeBlock') return this.getCodeBlockToolbarButton()
      if (d === 'bulletList') return this.getBulletListToolbarButton()
      if (d === 'orderedList') return this.getOrderedListToolbarButton()
      if (d === 'table') return this.getTableToolbarButton()
      if (d === 'attachFiles') return this.getAttachFilesToolbarButton()
      if (d === 'undo') return this.getUndoToolbarButton()
      if (d === 'redo') return this.getRedoToolbarButton()
      console.error(`Markdown editor toolbar button "${d}" not found.`)
    },
    ...
    getAttachFilesToolbarButton () {
      return {
        ...
        title: T.tools?.attach_files
      }
    },
    getUndoToolbarButton () {
      return { name: 'undo', action: EasyMDE.undo, title: T.tools?.undo }
    },
    getRedoToolbarButton () {
      return { name: 'redo', action: EasyMDE.redo, title: T.tools?.redo }
    }
  }
}

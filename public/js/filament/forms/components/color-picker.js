...
const a = (e, t = 0, r = Math.pow(10, t)) => Math.round(r * e) / r;
const at = { grad: 360 / 400, turn: 360, rad: 360 / (Math.PI * 2) };
const F = (e) => G(v(e));
var v = (e) => (
    e[0] === "#" && (e = e.substring(1)),
    e.length < 6
...
const nt = (e, t = "deg") => Number(e) * (at[t] || 1);
const it = (e) => {
    const r =

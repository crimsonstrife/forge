            ...
            async fn(t) {
                ...
                if (
                    ...
                    if (
                        ...
                        (!(h === "alignment" ? b !== P(T) : !1) ||
                            I.every((D) =>
                                P(D.placement) === b ? D.overflows[0] > 0 : !0,
                            ))
                    ) {
                        return {
                    ...
                    let z =
                        (j = I.filter((M) => M.overflows[0] <= 0).sort(
...
function Y(i) {
    const { overflow: t, overflowX: e, overflowY: s, display: n } = C(i);
...
function B(i) {
    ...
    const t = i.assignedSlot || i.parentNode || (kt(i) && i.host) || k(i);
...
function rt(i, t, e, s) {
    ...
    if (o) {
        ...
        for (; m && s && f !== u; ) {
            ...
            const L = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (d *= g.x),
                (h *= g.y),
...
function me(i) {
    ...
    const d = E(0);
    const h = R(s);
    if ((h || (!h && !o)) && ((_(s) !== "body" || Y(r)) && (a = ot(s)), R(s))) {
        const f = rt(s);
        ((c = G(s)), (d.x = f.x + s.clientLeft), (d.y = f.y + s.clientTop));
    }
...
function be(i) {
    ...
    const n = V(t.scrollWidth, t.clientWidth, s.scrollWidth, s.clientWidth);
    const o = V(t.scrollHeight, t.clientHeight, s.scrollHeight, s.clientHeight);
...
function Ht(i, t, e) {
    ...
    else if (t === "document") s = be(k(i));
    else if (S(t)) s = xe(t, e);
    else {
        const n = zt(i);
...
function ve(i, t) {
    const e = t.get(i);
    if (e) return e;
    let s = at(i, [], !1).filter((l) => S(l) && _(l) !== "body");
    let n = null;
    const o = C(i).position === "fixed";
    let r = o ? B(i) : i;
    for (; S(r) && !K(r); ) {
        const l = C(r);
        const a = dt(r);
...
function Ae(i, t, e) {
    ...
    if (s || (!s && !o)) {
        if (((_(t) !== "body" || Y(n)) && (l = ot(t)), s)) {
            const f = rt(t, !0, o, t);
            ((a.x = f.x + t.clientLeft), (a.y = f.y + t.clientTop));
        } else n && c();
    }
    o && !s && n && c();
    const d = n && !s && !o ? Ut(n, l) : E(0);

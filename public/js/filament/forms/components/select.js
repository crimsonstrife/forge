    ...
    n === void 0 && (n = {}),
    {
      ...
      async fn (t) {
        ...
        if (
          ...
          let W, tt
          const k =
                        (((W = s.flip) == null ? void 0 : W.index) || 0) + 1
          const $ = q[k]
          if (
            $ &&
                        (!(d === 'alignment' ? w !== ht($) : !1) ||
...
const Hn = Ee && !Mi && !Ke && 'draggable' in document.createElement('div')
const Wi = (function () {
  if (Ee) {
    if (mt) return !1
...
const zi = function (t, e) {
  ...
  const l = r && b(r)
  const c =
        a && parseInt(a.marginLeft) + parseInt(a.marginRight) + N(s).width
  const f =
        l && parseInt(l.marginLeft) + parseInt(l.marginRight) + N(r).width
  if (i.display === 'flex') {
  ...
  _onDragOver: function (t) {
    ...
    if (
      ...
      if (!A || ($n(t, u, this) && !A.animated)) {
        ...
        const V = u ? 'top' : 'left'
        const W = Ci(i, 'top', 'top') || Ci(h, 'top', 'top')
        const tt = W ? W.scrollTop : void 0;
        (Rt !== i &&
        ...
        ((Rt = i), (Jt = F))
        const $ = i.nextElementSibling
        let B = !1
        B = F === 1
        const X = he(I, e, h, o, i, s, t, B)
        if (X !== !1) {
          return (
            (X === 1 || X === -1) && (B = X === 1),
            (Ve = !0),
...
function Yn (n, t, e) {
  const i = N(kt(e.el, 0, e.options, !0))
...
function $n (n, t, e) {
  const i = N(Ye(e.el, e.options.draggable))
  const o = Vi(e.el, e.options, y)
  const s = 10
  return t
    ? n.clientX > o.right + s ||
    ...
    do {
      ...
      const z =
                ...
                (Math.abs(S - s) <= r && W + A < J) -
                    (Math.abs(m - s) <= r && !!W)
      if (!P[d]) for (let k = 0; k <= d; k++) P[k] || (P[k] = {});
                ...
                (tt != 0 || z != 0) &&
                    ...
                    (P[d].pid = setInterval(
                      function () {
                        ...
                        const $ = P[this.layer].vy
                          ? P[this.layer].vy * a
                          : 0
                        const B = P[this.layer].vx
                          ? P[this.layer].vx * a
                          : 0;
                        (typeof f === 'function' &&
                                f.call(

...
function vr (t, e) {
  ...
  if (n) {
    ...
    for (let r = 0; r < t.length; r++) if (!vr(t[r], e[r])) return !1
  } else {
    for (const r in t) if (!(r in e) || !vr(t[r], e[r])) return !1
...
const O = class t {
  ...
  insertAt (e, n) {
    const r = wa(this.content, e + this.openStart, n)
...
function wa (t, e, n, r) {
  ...
  const l = wa(s.content, e - i - 1, n, s)
...
const le = class t {
  ...
  hasMarkup (e, n, r) {
    return (
      this.type == e &&
            vr(this.attrs, n || e.defaultAttrs || Zh) &&
  ...
  replace (e, n, r) {
    return Xh(this.resolve(e), this.resolve(n), r)
  }
...
function Na (t, e) {
  const n = Object.create(null)
  if (e) for (const r in e) n[r] = new Ni(t, r, e[r])
  return n
}
const Er = class t {
  constructor (e, n, r) {
  ...
  create (e = null, n, r) {
    ...
    return new le(this, this.computeAttrs(e), C.from(n), U.setFrom(r))
  }
  ...
  createChecked (e = null, n, r) {
    return (
      (n = C.from(n)),
      this.checkContent(n),
      new le(this, this.computeAttrs(e), n, U.setFrom(r))
    )
  }
  ...
  createAndFill (e = null, n, r) {
    ...
    return i ? new le(this, e, n.append(i), U.setFrom(r)) : null
  }
...
const an = class {
  constructor (e) {
    ...
    (this.markFromJSON = (o) => U.fromJSON(this, o)),
  ...
  text (e, n) {
    ...
    return new Ei(r, r.defaultAttrs, e, U.setFrom(n))
  }
...
const Ue = class t {
  ...
  parse (e, n = {}) {
    const r = new Or(this, n, !1)
    return (r.addAll(e, U.none, n.from, n.to), r.finish())
  }

  parseSlice (e, n = {}) {
    const r = new Or(this, n, !0)
    return (r.addAll(e, U.none, n.from, n.to), O.maxOpen(r.finish()))
  }
...
var Or = class {
  constructor (e, n, r) {
    ...
    (o
      ...
      : r
        ? (i = new ln(null, null, U.none, !0, null, s))
        : (i = new ln(e.schema.topNodeType, null, U.none, !0, null, s)),
    (this.nodes = [i]),
...
`
  ...
  addElement (e, n, r) {
    ...
    let l
    Da.hasOwnProperty(s) && this.parser.normalizeLists && fp(e)
    const a =
...
const it = class t {
  ...
  serializeFragment (e, n = {}, r) {
    r || (r = vi(n).createDocumentFragment())
    let o = r
    const i = []
    return (
      e.forEach((s) => {
  ...
  serializeMark (e, n, r = {}) {
    ...
    return o && Mr(vi(r), o(e, n), null, e.attrs)
  }
...
function pp (t) {
  let e = ga.get(t)
  return (e === void 0 && ga.set(t, (e = mp(t))), e)
}
function mp (t) {
  let e = null
  function n (r) {
...
function Mr (t, e, n, r) {
  ...
  for (let u = d; u < e.length; u++) {
    ...
    if (f === 0) {
      ...
      const { dom: h, contentDOM: p } = Mr(t, f, n, r)
...
const zn = class {
  ...
  get deletedBefore () {
    return (this.delInfo & (za | Nr)) > 0
  }

  get deletedAfter () {
    return (this.delInfo & (Ha | Nr)) > 0
  }
  ...
  _map (e, n, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        const h = a + o + (f < 0 ? 0 : d)
        if (r) return h
        const p = e == (n < 0 ? a : u) ? null : gp(l / 3, e - a)
        let m = e == a ? Ha : e == u ? za : Nr
        return (
          (n < 0 ? e != a : e != u) && (m |= $a),
          new zn(h, m, p)
        )
...
var lt = class t extends ae {
  ...
  apply (e) {
    const n = e.slice(this.from, this.to)
    const r = new O(
      zi(n.content, (o) => o.mark(this.mark.removeFromSet(o.marks)), e),
      n.openStart,
      n.openEnd
    )
...
const pe = class t extends ae {
  ...
  static fromJSON (e, n) {
    ...
    return new t(n.from, n.to, O.fromJSON(e, n.slice), !!n.structure)
  }
}
...
function Hi (t, e, n, r = n.contentMatch, o = !0) {
  ...
  for (let a = 0; a < i.childCount; a++) {
    ...
    if (!u) s.push(new pe(l, d, O.empty))
    else {
      r = u
...
function at (t) {
  ...
  for (let r = t.depth; ; --r) {
    ...
    if (r == 0 || o.type.spec.isolating || !wp(o, i, s)) break
  }
  return null
}
function kp (t, e, n) {
  ...
  t.step(new re(a, c, s, l, new O(d.append(f), u, h), d.size - u, !0))
}
...
function Mp (t, e, n) {
  ...
  const o = e.start
  const i = e.end
  t.step(new re(o, i, o, i, new O(r, 0, 0), n.length, !0))
}
function vp (t, e, n, r, o) {
  ...
  t.doc.nodesBetween(e, n, (s, l) => {
    ...
    if (
      s.isTextblock &&
            !s.hasMarkup(r, a) &&
            Tp(t.doc, t.mapping.slice(i).map(l), r)
    ) {
      let c = null
      ...
      return (
        t.step(
          new re(
            ...
            u + 1,
            f - 1,
            new O(C.from(r.create(a, null, s.marks)), 0, 0),
            1,
            !0
          )
        ),
...
function Ep (t, e, n = 1, r) {
  ...
  t.step(new pe(e, e, new O(i.append(s), n, n), !0))
}
function Ne (t, e) {
  const n = t.resolve(e)
  const r = n.index()
...
var Bi = class {
  ...
  dropNode () {
    ...
    if (o.childCount <= 1 && n > 0) {
      ...
      this.unplaced = new O(Ln(e, n - 1, 1), n - 1, i ? n - 1 : r)
    } else this.unplaced = new O(Ln(e, n, 1), n, r)
  }
  ...
  placeNodes ({
    ...
    this.unplaced = p
      ...
      : new O(Ln(s.content, e, c), s.openStart, s.openEnd)
  }
...
function Pi (t, e, n, r, o) {
  ...
  return l && !Dp(n, i.content, s) ? l : null
}
function Dp (t, e, n) {
      ...
      for (let m = 0; m < s.length; m++) {
        ...
        if (b.canReplaceWith(k, k, p.type, p.marks)) {
          return t.replace(
            o.before(g),
            y ? i.after(g) : n,
            new O(Ka(r.content, 0, r.openStart, h), h, r.openEnd)
          )
        }
      }
    }
...
const St = class {
  ...
  removeNodeMark (e, n) {
    ...
    if (n instanceof U) n.isInSet(r.marks) && this.step(new cn(e, n))
    else {
      let o = r.marks
      let i
      const s = []
...
const D = class {
  ...
  replace (e, n = O.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      (e.replaceRange(d.map(a.pos), d.map(c.pos), l ? O.empty : n),
      l == 0 &&
      ...
      n &&
                (e = e.mark(
                  this.storedMarks ||
                        (r.empty
                          ? r.$from.marks()
                          : r.$from.marksAcross(r.$to) || U.none)
                )),
...
const ji = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (pn(i, 'end') || P.isSelectable(i))) {
    for (let s = r.depth; ; s--) {
      const l = _n(t.doc, r.before(s), r.after(s), O.empty)
...
const qi = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (pn(i, 'start') || P.isSelectable(i))) {
    const s = _n(t.doc, r.before(), r.after(), O.empty)
...
const _p = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0)
function Vp (t, e, n) {
  const r = e.nodeBefore
  const o = e.nodeAfter
  const i = e.index()
...
function uc (t, e, n, r) {
  ...
  if (
    ...
    if (n) {
      ...
      p = C.from(o.copy(p))
      const m = t.tr.step(
        new re(e.pos - 1, h, e.pos, h, new O(p, 1, 0), s.length, !0)
      )
...
const Wi = is(zr, ji, Ki)
const tc = is(zr, qi, Ji)
const Ct = {
  Enter: is(Xi, Zi, es, Fp),
  'Mod-Enter': Qi,
  Backspace: Wi,
  'Mod-Backspace': Wi,
  'Shift-Backspace': Wi,
...
function pc (t, e = null) {
  return function (n, r) {
    ...
    if (!s) return !1
    const l = r ? n.tr : null
    return jp(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1
  }
}
function jp (t, e, n, r = null) {
  let o = !1
  let i = e
  const s = e.$from.doc
  if (
  ...
  i < s &&
        (o.step(
          new re(
            ...
            i,
            s,
            new O(C.from(n.create(null, r.parent.copy())), 1, 0),
            1,
            !0
          )
        ),
...
const Gp = /^(img|br|input|textarea|hr)$/i
...
const Ot = (qe && qe.userAgent) || ''
const fs = /Edge\/(\d+)/.exec(Ot)
const Xc = /MSIE \d/.exec(Ot)
const hs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Ot)
const Se = !!(Xc || hs || fs)
const At = Xc ? document.documentMode : hs ? +hs[1] : fs ? +fs[1] : 0
const Ie = !Se && /gecko\/(\d+)/i.test(Ot)
Ie && +(/Firefox\/(\d+)/.exec(Ot) || [0, 0])[1]
const ps = !Se && /Chrome\/(\d+)/.exec(Ot)
const ge = !!ps
const Yc = ps ? +ps[1] : 0
const xe = !Se && !!qe && /Apple Computer/.test(qe.vendor)
const wn = xe && (/Mobile\/\w+/.test(Ot) || (!!qe && qe.maxTouchPoints > 2))
const Re = wn || (qe ? /Mac/.test(qe.platform) : !1)
const tm = qe ? /Win/.test(qe.platform) : !1
const ut = /Android \d/.test(Ot)
...
function sm ({ refDOM: t, refTop: e, stack: n }) {
...
function fm (t, e) {
  ...
  if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
    ...
    if (!Os(e, c) || ((s = td(t.dom, e, c)), !s)) return null
  }
  if (xe) for (let c = s; r && c; c = xn(c)) c.draggable && (r = void 0)
  if (((s = cm(s, e)), r)) {
    if (
      Ie &&
            r.nodeType == 1 &&
...
function Mt (t, e) {
  ...
  return Array.prototype.find.call(n, wc) || t.getBoundingClientRect()
}
const hm = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/
function nd (t, e, n) {
  const {
  ...
  if (r.nodeType == 3) {
    if (
      s &&
            (hm.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))
    ) {
      const a = Mt(dt(r, o, o), n)
      if (
        Ie &&
                o &&
        ...
        const c = Mt(dt(r, o - 1, o - 1), -1)
        if (c.top == a.top) {
          const d = Mt(dt(r, o, o + 1), -1)
    ...
    const c = a
      ? a.nodeType == 3
        ...
        : a.nodeType == 1
          ...
          : null
      : null
    if (c) return Wn(Mt(c, -1), !0)
  }
  return Wn(Mt(r.nodeType == 3 ? dt(r) : r, -n), n >= 0)
}
function Wn (t, e) {
...
function gm (t, e, n) {
  ...
  return l
    ? !mm.test(r.parent.textContent) || !l.modify
        ? n == 'left' || n == 'backward'
          ? i
          : s
        : rd(t, e, () => {
...
function ym (t, e, n) {
  return kc == e && Sc == n
    ...
    : ((kc = e),
      (Sc = n),
      (Cc = n == 'up' || n == 'down' ? pm(t, e, n) : gm(t, e, n)))
}
const Pe = 0
const Mc = 1
const Wt = 2
...
const Et = class t extends Gt {
  ...
  localCompositionInfo (e, n) {
    ...
    if (this.node.inlineContent) {
      const s = i.nodeValue
      const l = Cm(this.node.content, s, r - n, o - n)
...
var bs = class {
  constructor (e, n, r) {
    ...
    (this.changed = !1),
    (this.top = e),
    (this.preMatch = xm(e.node.content, e)))
  }
  ...
  if (Jr(n)) {
    ...
    if (
      o &&
            ...
            P.isSelectable(u) &&
            o.parent &&
            !(u.isInline && Qp(n.focusNode, n.focusOffset, o.dom))
    ) {
      const f = o.posBefore
...
function ft (t, e = !1) {
  ...
  if ((ad(t, n), !!ld(t))) {
    ...
    if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) vm(t)
    else {
      ...
      n.visible
        ...
        : (t.dom.classList.add('ProseMirror-hideselection'),
          'onselectionchange' in document && Mm(t)))
    }
...
function ad (t, e) {
  if (e instanceof P) {
    ...
    n != t.lastSelectedViewDesc &&
            (Nc(t), n && n.selectNode(), (t.lastSelectedViewDesc = n))
  } else Nc(t)
}
function Nc (t) {
...
function Dc (t, e, n) {
  ...
  if (r instanceof R) {
    if (n.indexOf('s') > -1) {
      ...
      return vt(t, new R(r.$anchor, s))
    } else if (r.empty) {
      if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
        const o = ws(t.state, e)
    ...
    if (r instanceof P && r.node.isInline) {
      return vt(t, new R(e > 0 ? r.$to : r.$from))
    }
    {
      const o = ws(t.state, e)
      return o ? vt(t, o) : !1
...
function ks (t, e, n) {
  if (e.nodeType != 3) {
    ...
    (s = Om(e, n))
      ? ((e = s), (n = 0))
      : (i = Nm(e, n)) && ((e = i), (n = i.nodeValue.length))
  }
...
function Ic (t, e) {
  ...
  if (!(ge || tm) && n.parent.inlineContent) {
...
`
  ...
  if (
    ...
    l = $m(zc(l, +d[1], +d[2]), d[4])
  } else if (
    ((l = O.maxOpen(Lm(l.content, o), !0)), l.openStart || l.openEnd)
  ) {
    let u = 0
    let f = 0
    for (
...
function zc (t, e, n) {
  return (
    ...
    n < t.openEnd &&
            (t = new O(Ss(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
    t
  )
}
var md = {
...
const we = {}
const ke = {}
const Fm = { touchstart: !0, touchmove: !0 }
const Cs = class {
  constructor () {
    ((this.shiftKey = !1),
    (this.mouseDown = null),
...
function _m (t) {
  ...
  (xe && t.dom.addEventListener('input', () => null), Ms(t))
}
function Tt (t, e) {
...
ke.keydown = (t, e) => {
  ...
  if (
    ...
    if (
      ...
      wn && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
    ) {
      const r = Date.now();
      ...
      t.someProp('handleKeyDown', (r) => r(t, n)) || Im(t, n)
        ? n.preventDefault()
        : Tt(t, 'key')
    }
  }
  ...
  s &&
        (i == 'singleClick'
          ? (t.input.mouseDown && t.input.mouseDown.done(),
            (t.input.mouseDown = new vs(t, s, n, !!r)))
          : (i == 'doubleClick' ? Gm : Xm)(t, s.pos, s.inside, n)
              ? n.preventDefault()
              : Tt(t, 'pointer'))
}
var vs = class {
  ...
  up (e) {
    ...
    this.allowDefault || !n
      ...
      : Jm(this.view, n.pos, n.inside, e, this.selectNode)
        ? e.preventDefault()
        : e.button == 0 &&
                      (this.flushed ||
                          (xe &&
...
function wd (t) {
  for (
    t.composing &&
        ((t.input.composing = !1), (t.input.compositionEndedAt = eg()));
...
function Zm (t) {
  ...
  const n = Xp(e.focusNode, e.focusOffset)
  const r = Yp(e.focusNode, e.focusOffset)
  if (n && r && n != r) {
...
function qn (t, e, n, r, o) {
  ...
  if (t.someProp('handlePaste', (a) => a(t, o, i || O.empty))) return !0
  if (!i) return !1
  const s = ng(i)
  const l = s
...
ke.drop = (t, e) => {
  ...
  const l = !!(r && Sd(t, n))
  if (t.someProp('handleDrop', (p) => p(t, n, s || O.empty, l))) {
    n.preventDefault()
    return
  }
  if (!s) return
...
const Es = class {
  ...
  start () {
    (this.observer &&
            ...
            this.observer.observe(this.view.dom, lg)),
    this.onCharData &&
  ...
  ignoreSelectionChange (e) {
    ...
    const n = new Set()
    let r
    for (let i = e.focusNode; i; i = xn(i)) n.add(i)
    for (let i = e.anchorNode; i; i = xn(i)) {
      if (n.has(i)) {
        r = i
        break
      }
  ...
  flush () {
    ...
    i < 0 &&
      ...
      ? ((e.input.lastFocus = 0),
        ...
        e.scrollToSelection())
      : (i > -1 || o) &&
              (i > -1 && (e.docView.markDirty(i, s), cg(e)),
...
function mg (t, e, n, r, o) {
    ...
    if (A && !t.state.selection.eq(A)) {
      if (
        ge &&
                ...
                t.someProp('handleKeyDown', (E) => E(t, Vt(13, 'Enter')))
      ) {
        return
      }
      const v = t.state.tr.setSelection(A);
      (x == 'pointer'
        ? v.setMeta('pointer', !0)
  ...
  let p = bg(u.content, c.doc.content, c.from, f, h)
  if (
    (p && t.input.domChangeCount++,
    ((wn && t.input.lastIOSEnter > Date.now() - 225) || ut) &&
            o.some((x) => x.nodeType == 1 && !pg.test(x.nodeName)) &&
            (!p || p.endA >= p.endB) &&
            t.someProp('handleKeyDown', (x) => x(t, Vt(13, 'Enter'))))
  ) {
    t.input.lastIOSEnter = 0
    return
  }
  if (!p) {
    if (
      ...
      if (c.sel) {
        const x = Wc(t, t.state.doc, c.sel)
        if (x && !x.eq(t.state.selection)) {
          const A = t.state.tr.setSelection(x);
          (i && A.setMeta('composition', i), t.dispatch(A))
        }
      }
      return
    }
  ...
  if (
    t.state.selection.anchor > p.start &&
        yg(d, p.start, p.endA, m, g) &&
        t.someProp('handleKeyDown', (x) => x(t, Vt(8, 'Backspace')))
  ) {
      ...
      v &&
                !(
                  (ge &&
                        ...
                        (v.head == k || v.head == A.mapping.map(M) - 1)) ||
                    (Se && v.empty && v.head == k)
                ) &&
                A.setSelection(v)
    }
  ...
  if (b) {
    if (m.pos == g.pos) {
      Se &&
                ...
                setTimeout(() => ft(t), 20))
      const x = w(t.state.tr.delete(k, M))
      const A = d.resolve(p.start).marksAcross(d.resolve(p.endA));
      (A && x.ensureMarks(A), t.dispatch(x))
    } else if (
      p.endA == p.endB &&
            (S = gg(
      ...
      const x = w(t.state.tr);
      (S.type == 'add'
        ? x.addMark(k, M, S.mark)
        : x.removeMark(k, M, S.mark),
      t.dispatch(x))
    } else if (
      ...
      const A = () => w(t.state.tr.insertText(x, k, M))
      t.someProp('handleTextInput', (v) => v(t, k, M, x, A)) ||
                t.dispatch(A())
    } else t.dispatch(w())
  } else t.dispatch(w())
}
...
const Gn = class {
  ...
  updateStateInner (e, n) {
    ...
    let i = !1
    let s = !1;
    (e.storedMarks && this.composing && (wd(this), (s = !0)),
    (this.state = e))
    ...
    if (
      ...
      const h = Jc(this)
      wg(h, this.nodeViews) && ((this.nodeViews = h), (i = !0))
    }
  ...
  domSelectionRange () {
    ...
    return e
      ? (xe &&
                  ...
                  Zp(this.dom.ownerDocument) == this.dom &&
                  dg(this, e)) ||
                  e
      : {
          focusNode: null,
...
const kg = typeof navigator < 'u' && /Mac/.test(navigator.platform)
const Sg =
    typeof navigator < 'u' &&
...
function Td (t) {
  const e =
        (kg && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
        (Sg && t.shiftKey && t.key && t.key.length == 1) ||
        t.key == 'Unidentified'
  let n =
        (!e && t.key) ||
...
const Mg = typeof navigator < 'u' && /Win/.test(navigator.platform)
function vg (t) {
  const e = t.split(/-(?!$)/)
  let n = e[e.length - 1]
  n == 'Space' && (n = ' ')
  ...
  for (let l = 0; l < e.length - 1; l++) {
    ...
    else if (/^mod$/i.test(a)) Cg ? (s = !0) : (o = !0)
...
const Ag = Object.defineProperty
const Ws = (t, e) => {
  for (const n in e) Ag(t, n, { get: e[n], enumerable: !0 })
}
function io (t) {
...
var Wg =
    (t = null, e = {}) =>
      ({ editor: n, view: r, tr: o, dispatch: i }) => {
        ...
        const l = zd(o.doc, t) || n.state.selection
...
var jg = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o }))
var Kg =
    (t, e) =>
      ({ tr: n, commands: r }) =>
      ...
      ({ tr: r, dispatch: o, editor: i }) => {
        ...
        if (o) {
          ...
          if (f) {
            ...
            const M = y.content.size > 0;
            (b && k && M && (d = Math.max(0, d - 1)),
            r.replaceWith(d, u, m))
          }
          (n.updateSelection && Ug(r, r.steps.length - 1, -1),
          n.applyInputRules &&
            ...
            o &&
                  n.selection.ranges.forEach((a) => {
                    r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, d) => {
                      (i &&
                              i === c.type &&
                              n.setNodeMarkup(d, void 0, Od(c.attrs, e)),
                      s &&
                                  c.marks.length &&
                                  c.marks.forEach((u) => {
                                    s === u.type &&
...
function Wd (t) {
  ...
  return (
    t.forEach((s) => {
      ...
      const a = B(s, 'addGlobalAttributes', l)
      if (!a) return
      a().forEach((d) => {
        d.types.forEach((u) => {
...
function wy (t, e) {
  ...
  const s = (n = o.find((c) => B(c, 'topNode'))) == null ? void 0 : n.name
  const l = Object.fromEntries(
    o.map((c) => {
      ...
      const f = t.reduce((y, b) => {
        const k = B(b, 'extendNodeSchema', u)
        return { ...y, ...(k ? k(c) : {}) }
      }, {})
      const h = Rd({
        ...f,
        content: q(B(c, 'content', u)),
        marks: q(B(c, 'marks', u)),
        group: q(B(c, 'group', u)),
        inline: q(B(c, 'inline', u)),
        atom: q(B(c, 'atom', u)),
        selectable: q(B(c, 'selectable', u)),
        draggable: q(B(c, 'draggable', u)),
        code: q(B(c, 'code', u)),
        whitespace: q(B(c, 'whitespace', u)),
        linebreakReplacement: q(B(c, 'linebreakReplacement', u)),
        defining: q(B(c, 'defining', u)),
        isolating: q(B(c, 'isolating', u)),
      ...
      const p = q(B(c, 'parseHTML', u))
      p && (h.parseDOM = p.map((y) => Nd(y, d)))
      const m = B(c, 'renderHTML', u)
      m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: oo(y, d) }))
      const g = B(c, 'renderText', u)
  ...
  const a = Object.fromEntries(
    i.map((c) => {
      ...
      const f = t.reduce((g, y) => {
        const b = B(y, 'extendMarkSchema', u)
        return { ...g, ...(b ? b(c) : {}) }
      }, {})
      const h = Rd({
        ...f,
        inclusive: q(B(c, 'inclusive', u)),
        excludes: q(B(c, 'excludes', u)),
        group: q(B(c, 'group', u)),
        spanning: q(B(c, 'spanning', u)),
        code: q(B(c, 'code', u)),
        attrs: Object.fromEntries(
          d.map((g) => {
            let y, b
...
function Ys (t) {
  return t.sort((n, r) => {
    const o = B(n, 'priority') || 100
    const i = B(r, 'priority') || 100
    return o > i ? -1 : o < i ? 1 : 0
  })
}
function jd (t) {
  const e = Ys(Gs(t))
  const n = ky(e.map((r) => r.name))
  return (
    n.length &&
            console.warn(
...
function Qs (t, e) {
  ...
  return n === 'node' ? Cy(t, e) : n === 'mark' ? Fd(t, e) : {}
}
function My (t, e = JSON.stringify) {
  const n = {}
  return t.filter((r) => {
    const o = e(r)
  ...
  if (
    (o.forEach(({ $from: u, $to: f }) => {
      ...
      t.doc.nodesBetween(h, p, (m, g) => {
        ...
        ((s += k),
        l.push(
          ...m.marks.map((M) => ({ mark: M, from: y, to: b }))
        ))
      })
    }),
    s === 0)
    ...
    (t, e = {}) =>
      ({ tr: n, state: r, dispatch: o, editor: i }) => {
          ...
          if (o) {
            ...
            const w =
                    ((s = l.contentMatch.defaultType) == null
                      ? void 0
                      : s.createAndFill(M)) || void 0
            y = y.append(C.from(l.createAndFill(null, w) || void 0))
            const S = a.before(a.depth - (b - 1))
            n.replace(S, a.after(-k), new O(y, 4 - b, 0))
            let x = -1;
            (n.doc.nodesBetween(S, n.doc.content.size, (A, v) => {
              if (x > -1) return !1
              A.isTextblock && A.content.size === 0 && (x = v + 1)
            }),
            x > -1 && n.setSelection(R.near(n.doc.resolve(x))),
            n.scrollIntoView())
          }
          return !0
        }
        ...
        if (o) {
          ...
          const M = b || (y.$to.parentOffset && y.$from.marks())
...
var By =
    (t, e, n, r = {}) =>
      ({
        ...
        const M = g || (m.$to.parentOffset && m.$from.marks())
        if (!k) return !1
        const w = Xe((S) => Id(S.type.name, u))(m)
        if (k.depth >= 1 && w && k.depth - w.depth <= 1) {
          if (w.node.type === h) return c.liftListItem(p)
          if (
            Id(w.node.type.name, u) &&
        ...
        return !n || !M || !l
          ...
          : a()
            .command(() => {
              ...
              const x = M.filter((A) => f.includes(A.type.name))
              return (i.ensureMarks(x), S ? !0 : c.clearNodes())
            })
            .wrapInList(h, r)
            .command(() => $s(i, h))
            .command(() => Fs(i, h))
...
const tl = class {
  ...
  get options () {
    return { ...(q(B(this, 'addOptions', { name: this.name })) || {}) }
  }
...
function Zy (t) {
  ...
  return (
    n.doc.nodesBetween(r, o, (h, p) => {
      ...
      const S = Math.min(o, p + M)
      if (w >= S) return
      const x = h.isText
        ? h.text || ''
        : h.textBetween(w - p, S - p, void 0, '\uFFFC')
      Qy(x, i.find, s).forEach((v) => {
    ...
    (d) =>
      new L({
        ...
        appendTransaction: (u, f, h) => {
          ...
          const M = f.doc.content.findDiffEnd(h.doc.content)
          if (!(!Xy(k) || !M || k === M.b)) {
            return a({
              rule: d,
              state: h,
...
const ho = class {
  constructor (t, e) {
    ...
    (this.schema = wy(this.extensions, e)),
  ...
  get plugins () {
    ...
    return Ys([...this.extensions].reverse()).flatMap((r) => {
      ...
      const i = []
      const s = B(r, 'addKeyboardShortcuts', o)
      let l = {}
      if (
        (r.type === 'mark' &&
                    B(r, 'exitable', o) &&
      ...
      const a = Ad(l)
      i.push(a)
      const c = B(r, 'addInputRules', o)
      if (Dd(r, t.options.enableInputRules) && c) {
        const f = c()
        if (f && f.length) {
          const h = Jy({ editor: t, rules: f })
          const p = Array.isArray(h) ? h : [h]
          i.push(...p)
        }
      }
      const d = B(r, 'addPasteRules', o)
      if (Dd(r, t.options.enablePasteRules) && d) {
        const f = d()
        if (f && f.length) {
          const h = t0({ editor: t, rules: f })
          i.push(...h)
        }
      }
      const u = B(r, 'addProseMirrorPlugins', o)
      if (u) {
        const f = u()
        i.push(...f)
      }
  ...
  setupExtensions () {
    ...
    t.forEach((e) => {
      ...
      e.type === 'mark' &&
                    ((n = q(B(e, 'keepOnSplit', r))) == null || n) &&
                    this.splittableMarks.push(e.name)
      const o = B(e, 'onBeforeCreate', r)
      const i = B(e, 'onCreate', r)
      const s = B(e, 'onUpdate', r)
      const l = B(e, 'onSelectionUpdate', r)
      const a = B(e, 'onTransaction', r)
      const c = B(e, 'onFocus', r)
      const d = B(e, 'onBlur', r)
      const u = B(e, 'onDestroy', r);
    ...
    const i = () => {
      ...
      d.steps.forEach((h, p) => {
        ...
        if (h instanceof lt) {
          ...
          const M = f.invert().map(b)
          const w =
                        (m = d.doc.nodeAt(y - 1)) == null
                          ? void 0
                          : m.marks.some((x) => x.eq(h.mark))
          const S =
                        (g = d.doc.nodeAt(b)) == null
                          ? void 0
                          : g.marks.some((x) => x.eq(h.mark))
          this.editor.emit('delete', {
            type: 'mark',
            mark: h.mark,
            from: h.from,
            to: h.to,
            deletedRange: { from: k, to: M },
...
const du = class extends Uy {
  constructor (t = {}) {
    ...
    const n = zd(e, this.options.autofocus);
  ...
  injectCSS () {
    this.options.injectCSS &&
            typeof document < 'u' &&
            (this.css = i0(o0, this.options.injectNonce))
  }
...
const s0 = {}
Ws(s0, {
  createAtomBlockMarkdownSpec: () => l0,
  createBlockMarkdownSpec: () => Xt,
  createInlineMarkdownSpec: () => d0,
  parseAttributes: () => nl,
        ...
        for (x.lastIndex = 0; ;) {
          ...
          if (!((p = v[2]) != null && p.endsWith(':::'))) {
            if ($) M += 1
              ...
              const V = A.slice(0, E)
              S = V.trim()
              const J = u.slice(0, w + E + v[0].length)
              let _ = []
              if (S) {
                if (l === 'block') {
                  for (
...
function d0 (t) {
  const {
    ...
    name: n,
    getContent: r,
    parseAttributes: o = a0,
    serializeAttributes: i = c0,
    defaultAttributes: s = {},
    selfClosing: l = !1,
    allowedAttributes: a
  } = t
...
`
    ...
    for (d += 1; d < l.length;) {
      const w = l[d]
      if (w.trim() === '') {
        const x = l.slice(d + 1).findIndex((E) => E.trim() !== '')
        if (x === -1) break
        if (
          (((o =
                        (r = l[d + 1 + x].match(/^(\s*)/)) == null
                          ? void 0
                          : r[1]) == null
            ? void 0
            : o.length) || 0) > m
...
const se = class t extends D {
  ...
  static valid (e) {
    const n = e.parent
    if (n.isTextblock || !f0(e) || !h0(e)) return !1
...
function g0 (t, e) {
  ...
  const i = t.state.tr.replace(n.pos, n.pos, new O(o, 0, 0))
  return (
...
ue.from = function (e) {
  return e instanceof ue ? e : e && e.length ? new gu(e) : ue.empty
}
var gu = (function (t) {
  function e (r) {
...
const Qt = class t {
  ...
  addTransform (e, n, r, o) {
    ...
    const c = s - r.depth
    return (c > k0 && ((l = w0(l, c)), (s -= c)), new t(l.append(i), s))
  }
...
function S0 (t, e, n, r) {
  ...
  n.getMeta(v0) && (t = new Ze(t.done, t.undone, null, 0, -1))
    ...
    const a =
            ...
            (!s &&
                ...
                (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                    !C0(n, t.prevRanges)))
    const c = s ? ll(t.prevRanges, n.mapping) : yu(n.mapping.maps)
    return new Ze(
      t.done.addTransform(
        n,
...
const Su = W.create({
  ...
  extendNodeSchema (t) {
    ...
    return {
      allowGapCursor:
                (e = q(B(t, 'allowGapCursor', n))) != null ? e : null
    }
  }
})
const ul = W.create({
...
`)
  ...
  addInputRules () {
    return [Ye({ find: T0, type: this.type })]
  }
})
const Mu = A0
const E0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/
const O0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g
const N0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/
const R0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g
const D0 = Z.create({
  name: 'bold',
  addOptions () {
    return { HTMLAttributes: {} }
  ...
  addInputRules () {
    return [
      Le({ find: E0, type: this.type }),
      Le({ find: N0, type: this.type })
    ]
  },
  addPasteRules () {
    return [
      Ce({ find: O0, type: this.type }),
...
const L0 = Z.create({
  ...
  addInputRules () {
    return [Le({ find: I0, type: this.type })]
  },
  addPasteRules () {
    return [Ce({ find: P0, type: this.type })]
  }
})
const Tu = L0
const fl = 4
...
`)
              ...
              return (
                l.delete(M, M + k),
                c - M <= k &&
                                    l.setSelection(R.create(l.doc, M)),
                !0
              )
            })
            : t.commands.command(({ tr: l }) => {
...
const wo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null
const $0 = (t, e, n) => {
  for (let r = t.depth; r > 0; r -= 1) {
    const o = t.node(r)
    const i = e(o)
    const s = wo(t.start(r), n)
    if (i && s) {
      return {
...
const Ou = (t, e) => {
  ...
  if (!u.length || wo(d.start + u[0].pos + 1, t)) return !1
...
const Nu = H.create({
  ...
  addKeyboardShortcuts () {
    return {
      ...
      ArrowRight: ({ editor: t }) => Ou(t, 'right'),
      ArrowDown: ({ editor: t }) => Ou(t, 'down')
    }
  },
  addProseMirrorPlugins () {
    return [
      new L({
        ...
        appendTransaction: (t, e, n) => {
          ...
          if (wo(a.pos, r)) return
          const d = $0(a, (y) => y.type === o, r)
          if (!d) return
          const u = Cn(
            d.node,
  ...
  addKeyboardShortcuts () {
    return {
      Enter: ({ editor: t }) => {
        ...
        const M = k.createAndFill()
        if (!M) return !1
        const { tr: w } = e
        const S = o.after(-2)
        w.replaceWith(S, S, M)
        const x = w.doc.resolve(S)
        const A = D.near(x, 1)
        w.setSelection(A)
        const v = m
        const E = m + p.nodeSize
        return (w.delete(v, E), w.scrollIntoView(), n.dispatch(w), !0)
      }
    }
  },
...
const K0 = Z.create({
  ...
  addPasteRules () {
    return [Ce({ find: j0, type: this.type })]
  }
})
const Hu = K0
const U0 = H.create({
  ...
  addCommands () {
    return {
      setHorizontalRule:
                () =>
                  ({ chain: t, state: e }) => {
                    if (!uu(e, e.schema.nodes[this.name])) return !1
                    const { selection: n } = e
                    const { $to: r } = n
                    const o = t()
                    return (
...
const q0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/
const J0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g
const G0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/
const X0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g
const Y0 = Z.create({
  name: 'italic',
  addOptions () {
    return { HTMLAttributes: {} }
  ...
  addInputRules () {
    return [
      ...
      Le({ find: G0, type: this.type })
    ]
  },
  addPasteRules () {
    return [
      Ce({ find: J0, type: this.type }),
      Ce({ find: X0, type: this.type })
    ]
  }
})
const Fu = Y0
    ...
    if (
      ...
      if (r) {
        if (s.t && typeof s.t === 'string') {
          const a = Object.assign(ib(s.t, r), n)
          Zt(i, a, r)
        } else n && Zt(i, n, r)
      }
      s.t = i
...
const ju = (t, e, n, r, o) => t.ts(e, n, r, o)
const T = (t, e, n, r, o) => t.tt(e, n, r, o)
const bt = 'WORD'
const Cl = 'UWORD'
const Yu = 'ASCIINUMERICAL'
const Qu = 'ALPHANUMERICAL'
const hr = 'LOCALHOST'
const Ml = 'TLD'
const vl = 'UTLD'
const Mo = 'SCHEME'
...
const ar = 'OPENBRACE'
const cr = 'CLOSEBRACE'
const vo = 'OPENBRACKET'
const To = 'CLOSEBRACKET'
const Ao = 'OPENPAREN'
const Eo = 'CLOSEPAREN'
const Oo = 'OPENANGLEBRACKET'
const No = 'CLOSEANGLEBRACKET'
...
const Bo = 'RIGHTWHITECORNERBRACKET'
const zo = 'FULLWIDTHLESSTHAN'
...
function ab (t = []) {
  ...
  T(n, '\\', Vo),
  T(n, '\u30FB', Zu))
  const r = te(n, yt, Al, { [xl]: !0 })
  te(r, yt, r)
  const o = te(r, gt, Yu, { [lr]: !0 })
  const i = te(r, ir, Qu, { [sr]: !0 })
  const s = te(n, gt, bt, { [wl]: !0 });
  ...
  te(i, gt),
  te(i, ir, i))
  const a = T(n, gl, El, { [hl]: !0 })
  const c = T(n, Ku, Tl, { [hl]: !0 })
  ...
  te(d, ml, d),
  T(d, yl, d))
  const u = te(n, pl, ef, { [Xu]: !0 });
  (T(u, '#'), te(u, pl, u), T(u, sb, u))
  const f = T(u, lb);
  (T(f, '#'), te(f, pl, u))
  const h = [
    [gt, s],
  ...
  for (let m = 0; m < ko.length; m++) Nt(n, ko[m], Ml, bt, h)
  for (let m = 0; m < So.length; m++) Nt(n, So[m], vl, Cl, p);
  (Zt(Ml, { tld: !0, ascii: !0 }, e),
  Zt(vl, { utld: !0, alpha: !0 }, e),
  Nt(n, 'file', Mo, bt, h),
  Nt(n, 'mailto', Mo, bt, h),
  Nt(n, 'http', vn, bt, h),
  Nt(n, 'https', vn, bt, h),
  Nt(n, 'ftp', vn, bt, h),
  Nt(n, 'ftps', vn, bt, h),
  Zt(Mo, { scheme: !0, ascii: !0 }, e),
  Zt(vn, { slashscheme: !0, ascii: !0 }, e),
  (t = t.sort((m, g) => (m[0] > g[0] ? 1 : -1))))
  for (let m = 0; m < t.length; m++) {
    const g = t[m][0]
    const b = t[m][1] ? { [nb]: !0 } : { [rb]: !0 };
    (g.indexOf('-') >= 0
      ? (b[Sl] = !0)
      : gt.test(g)
        ? yt.test(g)
  ...
  return (
    ju(n, 'localhost', hr, { ascii: !0 }),
    (n.jd = new Me(Yo)),
    { start: n, tokens: Object.assign({ groups: e }, tf) }
  )
}
function nf (t, e) {
  const n = cb(e.replace(/[A-Z]/g, (l) => l.toLowerCase()))
  const r = n.length
  const o = []
  let i = 0
  let s = 0
...
function ub ({ groups: t }) {
  ...
  F(f, t.domain, u)
  const h = Be(Ju);
  (F(f, t.tld, h), F(f, t.utld, h), T(c, hr, h))
  const p = T(u, ze);
  (T(p, ze, p),
  F(p, t.domain, u),
  F(h, t.domain, u),
  ...
  const g = T(s, ze)
  const y = T(s, et);
  (T(g, ze, g), F(g, t.domain, s), F(y, r, i), F(y, t.domain, s))
  const b = Be(Co);
  (F(y, t.tld, b),
  F(y, t.utld, b),
  F(b, t.domain, s),
  ...
  const w = Be(Co)
  const S = Be();
  (F(w, e, w), F(w, n, S), F(S, e, w), F(S, n, S), T(b, tt, w), T(M, tt, w))
  const x = T(l, Dt)
  const A = T(a, Dt)
  const v = T(A, tt)
  const E = T(v, tt);
  ...
  return (T(o, hr, b), T(o, El, db), { start: o, tokens: tf })
}
function fb (t, e, n) {
  const r = n.length
  let o = 0
  ...
  return (s.length > 0 && i.push(bl(Gu, e, s)), i)
}
function bl (t, e, n) {
  const r = n[0].s
...
const hb = (typeof console < 'u' && console && console.warn) || (() => {})
const pb =
...
function Pl (t, e = !1) {
  if (
    (Y.initialized &&
            hb(
                `linkifyjs: already initialized - will not register custom scheme "${t}" ${pb}`
            ),
...
function Zo (t) {
  return (
    Y.initialized || mb(),
    fb(Y.parser.start, t, nf(Y.scanner.start, t))
  )
}
Zo.scan = nf
...
const Ll = '[\0- \xA0\u1680\u180E\u2000-\u2029\u205F\u3000]'
const gb = new RegExp(Ll)
const yb = new RegExp(`${Ll}$`)
const bb = new RegExp(Ll, 'g')
function xb (t) {
  return t.length === 1
    ? t[0].isLink
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (
        (Zs(l).forEach(({ newRange: c }) => {
          ...
          if (u && f) {
            const h = f.split(gb).filter(Boolean)
...
const sf = Cb
const Mb = Object.defineProperty
const vb = (t, e) => {
  for (const n in e) Mb(t, n, { get: e[n], enumerable: !0 })
}
const Tb = 'listItem'
const lf = 'textStyle'
const af = /^\s*([-+*])\s$/
...
`
  ...
  addInputRules () {
    let t = Ye({ find: af, type: this.type })
    return (
...
vb(Ab, {
  ...
  hasListBefore: () => ff,
  hasListItemAfter: () => Eb,
  hasListItemBefore: () => hf,
  listItemHasSubList: () => pf,
  nextListIsDeeper: () => mf,
  nextListIsHigher: () => gf
})
var mr = (t, e) => {
...
var Bl = (t, e, n) => {
  ...
  if (!Ge(t.state, e) && ff(t.state, e, n)) {
  ...
  const s = pf(e, t.state, i)
  return hf(e, t.state) && !s
  ...
  addExtensions () {
    ...
    return (
      ...
      this.options.listKeymap !== !1 &&
                t.push(Ob.configure(this.options.listKeymap)),
      this.options.orderedList !== !1 &&
                t.push(_l.configure(this.options.orderedList)),
      this.options.taskItem !== !1 &&
                t.push(Lb.configure(this.options.taskItem)),
      this.options.taskList !== !1 &&
                t.push(Bb.configure(this.options.taskList)),
      t
    )
  }
})
...
const xf = W.create({
  ...
  addProseMirrorPlugins () {
    return [zb({ editor: this.editor, ...this.options })]
  }
})
function Hb (t) {
  let e
  ...
  let M = k + g[0].length
  return (
    a && d.test(p.slice(M - 1, M + 1)) && ((g[0] += ' '), (M += 1)),
    k < l.pos && M >= l.pos
      ? {
          range: { from: k, to: M },
...
function Fb ({
  ...
  render: h = () => ({}),
  allow: p = () => !0,
  findSuggestionMatch: m = Hb
}) {
  let g
  const y = h?.()
  const b = () => {
    const S = e.state.selection.$anchor.pos
    const x = e.view.coordsAtPos(S)
    const { top: A, right: v, bottom: E, left: $ } = x
    try {
      return new DOMRect($, A, v - $, E - A)
    } catch {
      return null
    }
  }
  const k = (S, x) =>
    x
      ? () => {
          const A = t.getState(e.state)
          const v = A?.decorationId
          const E = S.dom.querySelector(`[data-decoration-id="${v}"]`)
  ...
  function M (S, x) {
    let A
    try {
      const E = t.getState(S.state)
      const $ = E?.decorationId
        ? S.dom.querySelector(
                      `[data-decoration-id="${E.decorationId}"]`
        )
        : null
      const V = {
        editor: e,
        range: E?.range || { from: 0, to: 0 },
        query: E?.query || null,
        text: E?.text || null,
        items: [],
        command: (J) =>
      ...
      (A = y?.onExit) == null || A.call(y, V)
    } catch {}
    const v = S.state.tr.setMeta(x, { exit: !0 })
    S.dispatch(v)
  }
  const w = new L({
    key: t,
    view () {
      return {
        update: async (S, x) => {
          let A, v, E, $, V, J, _
          const I = (A = this.key) == null ? void 0 : A.getState(x)
          const K =
                        (v = this.key) == null ? void 0 : v.getState(S.state)
          const j =
                        I.active && K.active && I.range.from !== K.range.from
          const ie = !I.active && K.active
          const Te = I.active && !K.active
          const Pt = !ie && !Te && I.query !== K.query
          const Nn = ie || (j && Pt)
          const Sr = Pt || j
          const Si = Te || (j && Pt)
          if (!Nn && !Sr && !Si) return
          ...
          ((g = {
            ...
            items: [],
            command: (Gh) =>
              u({ editor: e, range: sn.range, props: Gh }),
            decorationNode: la,
            clientRect: k(S, la)
          }),
          Nn && ((E = y?.onBeforeStart) == null || E.call(y, g)),
          Sr && (($ = y?.onBeforeUpdate) == null || $.call(y, g)),
          (Sr || Nn) &&
                            (g.items = await f({ editor: e, query: sn.query })),
          Si && ((V = y?.onExit) == null || V.call(y, g)),
          Sr && ((J = y?.onUpdate) == null || J.call(y, g)),
          Nn && ((_ = y?.onStart) == null || _.call(y, g)))
        },
        destroy: () => {
          let S
    ...
    state: {
      ...
      apply (S, x, A, v) {
        ...
        const { composing: $ } = e.view
        const { selection: V } = S
        const { empty: J, from: _ } = V
        const I = { ...x }
        const K = S.getMeta(t)
        if (K && K.exit) {
          return (
        ...
        if (((I.composing = $), E && (J || e.view.composing))) {
          (_ < x.range.from || _ > x.range.to) &&
                        !$ &&
                        !x.composing &&
                        (I.active = !1)
          const j = m({
    ...
    props: {
      handleKeyDown (S, x) {
        let A, v, E, $
        const { active: V, range: J } = w.getState(S.state)
        if (!V) return !1
        if (x.key === 'Escape' || x.key === 'Esc') {
          const I = w.getState(S.state)
          const K = (A = g?.decorationNode) != null ? A : null
          const j =
                        K ??
                        (I?.decorationId
                          ? S.dom.querySelector(
          ...
          const Te = {
            ...
            items: [],
            command: (Pt) =>
              u({ editor: e, range: I.range, props: Pt }),
            decorationNode: j,
            clientRect: j
              ? () => j.getBoundingClientRect() || null
              : null
          }
          return (
            (E = y?.onExit) == null || E.call(y, Te),
            M(S, t),
            !0
          )
        }
        return (
          (($ = y?.onKeyDown) == null
            ? void 0
            : $.call(y, { view: S, event: x, range: J })) || !1
        )
      },
      decorations (S) {
        const {
...
const kf = H.create({
  ...
  addProseMirrorPlugins () {
    return [
      ...this.storage.suggestions.map(wf),
      new L({
        props: {
          handleDrop (t, e) {
            if (
...
const Kb = Z.create({
  ...
  addInputRules () {
    return [Le({ find: Wb, type: this.type })]
  },
  addPasteRules () {
    return [Ce({ find: jb, type: this.type })]
  }
})
const vf = Kb
const Ub = Z.create({
...
const G = class xt extends D {
  ...
  getBookmark () {
    return new nx(this.$anchorCell.pos, this.$headCell.pos)
  }
}
...
var nx = class $f {
  ...
  map (e) {
    return new $f(e.map(this.anchor), e.map(this.head))
  }
...
function Xl (t, e) {
  let n
  const r = (o, i) => {
    o.type.spec.tableRole == 'table' && (n = ax(t, o, i, n))
  }
  return (
    e ? e.doc != t.doc && Ff(e.doc, t.doc, 0, r) : t.doc.descendants(r),
    n
  )
}
function ax (t, e, n, r) {
  ...
  return r.setMeta(lx, { fixTables: !0 })
}
function nt (t) {
  const e = t.selection
  const n = li(t)
...
function _f (t, { map: e, tableStart: n, table: r }, o) {
  let i = o > 0 ? -1 : 0
  tx(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0)
...
function cx (t, { map: e, table: n, tableStart: r }, o) {
...
function jf (t, e) {
  ...
  if (e) {
    ...
    for (let o = n.right - 1; cx(r, n, o), o != n.left; o--) {
...
function Kf (t, { map: e, tableStart: n, table: r }, o) {
  let i
  let s = n
  for (let c = 0; c < o; c++) s += r.child(c).nodeSize
  const l = []
  let a = o > 0 ? -1 : 0
  dx(e, r, o + a) && (a = o == 0 || o == e.height ? null : 0)
...
function qf (t, e) {
  ...
  if (e) {
    const n = nt(t)
    e(Kf(t.tr, n, n.bottom))
  }
  return !0
}
function ux (t, { map: e, table: n, tableStart: r }, o) {
  let i = 0
...
function Jf (t, e) {
  ...
  if (e) {
    ...
    for (let o = n.bottom - 1; ux(r, n, o), o != n.top; o--) {
      const i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc
      if (!i) throw RangeError('No table found');
...
const RM = An('row', { useDeprecatedLogic: !0 })
const DM = An('column', { useDeprecatedLogic: !0 })
const Xf = An('cell', { useDeprecatedLogic: !0 })
function mx (t, e) {
  if (e < 0) {
...
function Zl (t) {
  return function (e, n) {
    ...
    if (n) {
      ...
      n(e.tr.setSelection(R.between(o, ex(o))).scrollIntoView())
    }
    return !0
  }
}
...
function gx (t) {
  ...
  if (i == 'row') {
    for (let a = 0; a < e.childCount; a++) {
      ...
      ((d || u) && (c = ql(ye(s).row, new O(c, d, u)).content),
      l.push(c))
    }
  } else if (i == 'cell' || i == 'header_cell') {
    l.push(n || r ? ql(ye(s).row, new O(e, n, r)).content : e)
  } else return null
  return yx(s, l)
}
function yx (t, e) {
...
function bx ({ width: t, height: e, rows: n }, r, o) {
  if (t != r) {
    const i = []
    const s = []
...
function Df (t, e, n, r, o) {
  ...
  (xx(u, s, i, n, c, d, f) && h(),
  Nf(u, s, i, n, a, c, l, f) && h(),
  Nf(u, s, i, n, a, c, d, f) && h(),
  Rf(u, s, i, n, l, d, a, f) && h(),
  Rf(u, s, i, n, l, d, c, f) && h())
  for (let p = l; p < d; p++) {
...
function ri (t, e) {
  return (n, r, o) => {
    if (!o) return !1
    const i = n.selection
    if (i instanceof G) return ii(n, r, D.near(i.$headCell, e))
    if (t != 'horiz' && !i.empty) return !1
    const s = Qf(o, t, e)
    if (s == null) return !1
    if (t == 'horiz') return ii(n, r, D.near(n.doc.resolve(i.head + e), e))
    {
...
function Sx (t, e, n) {
  ...
  if (o instanceof G) {
    ...
    return (
      (r = bx(r, l.right - l.left, l.bottom - l.top)),
      Df(t.state, t.dispatch, s, l, r),
      !0
    )
  } else if (r) {
    const i = li(t.state)
...
function Cx (t, e) {
  ...
  function l (a) {
    ...
    else if (If(t, c.target) != r && ((u = Wl(t, e)), !u)) return s()
    u && i(u, c)
  }
...
function Zf ({
  ...
  const i = new L({
    ...
    props: {
      ...
      decorations: (s) => {
        const l = Ee.getState(s)
        if (l && l.activeHandle > -1) return Ix(s, l.activeHandle)
      },
      nodeViews: {}
    }
  })
...
function Tx (t, e, n, r) {
  ...
  if (o && !o.dragging) {
    ...
    if (i) {
      ...
      e.clientX - l <= n
        ? (s = Pf(t, e, 'left', n))
        : a - e.clientX <= n && (s = Pf(t, e, 'right', n))
    }
    if (s != o.activeHandle) {
      if (!r && s !== -1) {
...
function Ax (t) {
  ...
  e && e.activeHandle > -1 && !e.dragging && eh(t, -1)
}
function Ex (t, e, n, r) {
  let o
  ...
  const a = Ox(t, s.activeHandle, l.attrs)
  t.dispatch(
  ...
  function c (u) {
    ...
    f?.dragging &&
            (Rx(t, f.activeHandle, Lf(f.dragging, u, n)),
  ...
  function d (u) {
    ...
    const f = Ee.getState(t.state)
    if (f && f.dragging) {
      const h = Lf(f.dragging, u, n)
      Bf(t, f.activeHandle, h, r)
    }
  }
  return (
    Bf(t, s.activeHandle, a, r),
...
function Rx (t, e, n) {
  ...
  for (let c = 0; c < i.height; c++) {
    ...
    const p = f.colwidth ? f.colwidth.slice() : Dx(f.colspan);
...
function th ({ allowTableNodeSelection: t = !1 } = {}) {
  return new L({
    key: It,
    state: {
      init () {
    ...
    for (let u = 0, f = 0; u < d.childCount; u += 1) {
      ...
      for (let m = 0; m < h; m += 1, f += 1) {
        ...
        if (((l += g || r), g || (a = !1), c)) {
          ...
          const b = document.createElement('col')
          const [k, M] = ea(r, g);
          (b.style.setProperty(k, M), e.appendChild(b))
        }
      }
    }
  }
...
const zx = class {
  constructor (t, e) {
    ...
    nh(t, this.colgroup, this.table, e),
    (this.contentDOM = this.table.appendChild(
      document.createElement('tbody')
    )))
  }
  ...
  update (t) {
    return t.type !== this.node.type
      ? !1
      : ((this.node = t),
        nh(t, this.colgroup, this.table, this.cellMinWidth),
        !0)
  }
...
function jx (t, e, n = {}) {
  let r
  const o = (r = n.cellLineSeparator) != null ? r : Vx
...
const Ux = H.create({
  ...
  renderHTML ({ node: t, HTMLAttributes: e }) {
    const {
      ...
      tableWidth: r,
      tableMinWidth: o
    } = Hx(t, this.options.cellMinWidth)
    return [
      'table',
      N(this.options.HTMLAttributes, e, {
  ...
  renderMarkdown: (t, e) => Kx(t, e),
  addCommands () {
    return {
      insertTable:
                ({ rows: t = 3, cols: e = 3, withHeaderRow: n = !0 } = {}) =>
                  ({ tr: r, dispatch: o, editor: i }) => {
                    const s = Fx(i.schema, t, e, n)
                    if (o) {
  ...
  extendNodeSchema (t) {
    ...
    return { tableRole: q(B(t, 'tableRole', e)) }
  }
})
const oh = W.create({
  name: 'tableKit',
  addExtensions () {
    ...
    return (
      this.options.table !== !1 &&
                t.push(Ux.configure(this.options.table)),
      this.options.tableCell !== !1 &&
                t.push(Px.configure(this.options.tableCell)),
      this.options.tableHeader !== !1 &&
                t.push(Lx.configure(this.options.tableHeader)),
      this.options.tableRow !== !1 &&
                t.push(Bx.configure(this.options.tableRow)),
      t
    )
  }
})
...
const br = Math.round
const We = (t) => ({ x: t, y: t })
const Xx = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' }
...
function gr (t) {
  return t.replace(/start|end/g, (e) => Yx[e])
}
const ch = ['left', 'right']
const dh = ['right', 'left']
const Zx = ['top', 'bottom']
...
function yr (t) {
  return t.replace(/left|right|bottom|top/g, (e) => Xx[e])
}
function nw (t) {
...
async function nn (t, e) {
  ...
  const M = (await (i.isElement == null ? void 0 : i.isElement(k)))
  ...
  return {
    top: (y.top - w.top + p.top) / M.y,
    bottom: (w.bottom - y.bottom + p.bottom) / M.y,
    left: (y.left - w.left + p.left) / M.x,
    right: (w.right - y.right + p.right) / M.x
  }
}
const yh = (t) => ({
  name: 'arrow',
  ...
  async fn (e) {
    ...
    const M = i.reference[p] + i.reference[h] - f[h] - i.floating[p]
    const w = f[h] - i.reference[h]
    const S = await (s.getOffsetParent == null
      ? void 0
      : s.getOffsetParent(c))
    let x = S ? S[k] : 0;
    (!x || !(await (s.isElement == null ? void 0 : s.isElement(S)))) &&
            (x = l.floating[k] || i.floating[p])
    const A = M / 2 - w / 2
    const v = x / 2 - m[p] / 2 - 1
    const E = He(u[y], v)
    const $ = He(u[b], v)
    ...
    const K =
            ...
            $e(o) != null &&
            _ !== I &&
            i.reference[p] / 2 - (_ < V ? E : $) - m[p] / 2 < 0
    const j = K ? (_ < V ? _ - V : _ - J) : 0
    return {
      [h]: f[h] + j,
      data: {
        [h]: I,
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const m = u !== void 0 || f === na ? rw(u || null, h, f) : f
        ...
        const M = [g[Oe(b)], g[k[0]], g[k[1]]]
        const w = [
          ...(((r = s.autoPlacement) == null
            ? void 0
            : r.overflows) || []),
          { placement: b, overflows: M }
        ]
        const S = m[y + 1]
        if (S) {
          return {
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const b = je(l)
        const k = Oe(l) === l
        const M = await (a.isRTL == null
          ? void 0
          : a.isRTL(c.floating))
        const w = f || (k || !m ? [yr(l)] : uh(l))
        const S = p !== 'none'
        !f && S && w.push(...fh(l, m, p, M))
        const x = [l, ...w]
        const A = await nn(e, g)
        const v = []
        ...
        if (
          ((E = [...E, { placement: o, overflows: v }]),
          !v.every((_) => _ <= 0))
        ) {
          let $, V
          const _ =
                        ((($ = i.flip) == null ? void 0 : $.index) || 0) + 1
          const I = x[_]
          if (
            I &&
                        (!(u === 'alignment' ? b !== je(I) : !1) ||
                            E.every((ie) =>
                              je(ie.placement) === b
                                ? ie.overflows[0] > 0
                                : !0
            ...
            return {
              data: { index: _, overflows: E },
              reset: { placement: I }
            }
          }
          let K =
                        (V = E.filter((j) => j.overflows[0] <= 0).sort(
                          (j, ie) => j.overflows[1] - ie.overflows[1]
                        )[0]) == null
                          ? void 0
                          : V.placement
          if (!K) {
      ...
      async fn (e) {
        ...
        switch (r) {
          case 'referenceHidden': {
            ...
            const s = ph(i, n.reference)
            return {
              data: {
                referenceHiddenOffsets: s,
                referenceHidden: mh(s)
              }
            }
          }
          case 'escaped': {
            const i = await nn(e, { ...o, altBoundary: !0 })
            const s = ph(i, n.floating)
            return { data: { escapedOffsets: s, escaped: mh(s) } }
          }
          default:
            return {}
        }
        ...
        function p () {
          ...
          if (u.length >= 2) {
            if (je(n) === 'y') {
              ...
              const J = E.top
              const _ = $.bottom
              const I = V ? E.left : $.left
              const K = V ? E.right : $.right
              const j = K - I
              const ie = _ - J
              return {
                top: J,
            ...
            const g = Oe(n) === 'left'
            const y = fe(...u.map((E) => E.right))
            const b = He(...u.map((E) => E.left))
            const k = u.filter((E) =>
              g ? E.left === b : E.right === y
            )
            const M = k[0].top
            const w = k[k.length - 1].bottom
            const S = b
            const x = y
            const A = x - S
            const v = w - M
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        await a({ ...e, availableWidth: A, availableHeight: x })
...
function rn (t) {
  return Ah(t) ? (t.nodeName || '').toLowerCase() : '#document'
}
function ve (t) {
  let e
  return (
...
function ot (t) {
  let e
  return (e = (Ah(t) ? t.ownerDocument : t.document) || window.document) ==
        null
    ? void 0
    : e.documentElement
}
function Ah (t) {
  return pi() ? t instanceof Node || t instanceof ve(t).Node : !1
}
function Fe (t) {
  return pi() ? t instanceof Element || t instanceof ve(t).Element : !1
}
function Ke (t) {
  return pi()
...
const lw = new Set(['inline', 'contents'])
function En (t) {
  const { overflow: e, overflowX: n, overflowY: r, display: o } = _e(t)
  return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !lw.has(o)
}
const aw = new Set(['table', 'td', 'th'])
function Eh (t) {
  return aw.has(rn(t))
}
const cw = [':popover-open', ':modal']
function xr (t) {
  return cw.some((e) => {
    try {
      return t.matches(e)
...
const dw = ['transform', 'translate', 'scale', 'rotate', 'perspective']
const uw = [
  'transform',
  'translate',
  'scale',
...
const hw = new Set(['html', 'body', '#document'])
function on (t) {
  return hw.has(rn(t))
}
function _e (t) {
...
function kt (t) {
  ...
  const e = t.assignedSlot || t.parentNode || (Th(t) && t.host) || ot(t)
...
function kr (t, e, n, r) {
  ...
  if (i) {
    ...
    for (; m && r && h !== p;) {
      ...
      const M = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
      ((a *= g.x),
      (c *= g.y),
      (d *= g.x),
      (u *= g.y),
...
function gw (t) {
  ...
  if (
    (u || (!u && !i)) &&
        ((rn(r) !== 'body' || En(s)) && (a = wr(r)), Ke(r))
  ) {
    const h = kr(r);
    ((c = On(r)), (d.x = h.x + r.clientLeft), (d.y = h.y + r.clientTop))
  }
  const f = s && !u && !i ? zh(s, a) : We(0)
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function Dh (t, e, n) {
  let r
  if (e === 'viewport') r = xw(t, n)
  else if (e === 'document') r = bw(ot(t))
  else if (Fe(e)) r = kw(e, n)
  else {
    const o = Bh(t)
...
function vw (t, e, n) {
  ...
  if (r || (!r && !i)) {
    if (((rn(e) !== 'body' || En(o)) && (l = wr(e)), r)) {
      const h = kr(e, !0, i, e);
      ((a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop))
    } else o && c()
  }
  i && !r && o && c()
  const d = o && !r && !i ? zh(o, l) : We(0)
...
function $h (t, e) {
  ...
  let r = Ih(t, e)
  for (; r && Eh(r) && ia(r);) r = Ih(r, e)
  return r && on(r) && ia(r) && !mi(r) ? n : r || Oh(t) || n
}
const Tw = async function (t) {
  const e = this.getOffsetParent || $h
  const n = this.getDimensions
  const r = await n(t.floating)
  return {
    reference: vw(t.reference, await e(t.floating), t.strategy),
...
const ki = (t, e, n) => {
  const r = new Map()
  const o = { platform: Ew, ...n }
  const i = { ...o.platform, _c: r }
  return gh(t, e, { ...o, platform: i })
}
const Uh = (t, e) => {
  ki(
    {
...
const qh = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
  items: ({ query: n }) =>
    Object.entries(t)
      .filter(
        ([r, o]) =>
  ...
  render: () => {
    ...
    return {
      onStart: (u) => {
        ...
        u.clientRect && Uh(u.editor, n))
      },
      onUpdate: (u) => {
        ((o = u), (r = 0), s(), u.clientRect && Uh(u.editor, n))
      },
      onKeyDown: (u) =>
        u.event.key === 'Escape'
...
const Jh = async ({
  ...
  const b = [
    ...
    $u,
    Fu,
    Vu.configure({ inline: !0 }),
    Wu,
    sf.configure({ autolink: !0, openOnClick: !1 }),
    $l,
    ...(n
      ? [
          xf.configure({
    ...
    Mf.configure({ textColors: m }),
    Cf,
    vf,
    Tf,
    Af,
    oh.configure({ table: { resizable: !0 } }),
    ih,
    sh.configure({
  ...
  const k = await Promise.all(
    r.map(async (M) => {
      ...
      try {
        const S = (await import(M)).default
  ...
  for (let M of k) {
    ...
    const w = b.findIndex((S) => S.name === M.name);
    (M.name === 'placeholder' &&
            M.parent === null &&
            (M = Vl.configure(M.options)),
    w !== -1 ? (b[w] = M) : b.push(M))
  }
  return b
}
  ...
  get middlewares () {
    ...
    return (
      ...
      this.floatingUIOptions.arrow &&
                t.push(jh(this.floatingUIOptions.arrow)),
    ...
    if (e instanceof G) {
      ...
      const u =
                c === d
                  ...
                  : Ow(c.getBoundingClientRect(), d.getBoundingClientRect())
      o = {
...
function Rw ({
  ...
  return {
    ...
    async init () {
      ((x = new du({
        ...
        extensions: await Jh({
          ...
          insertCustomBlockUsing: (v, E = null) =>
            this.$wire.mountAction(
              'customBlock',
              { id: v, dragPosition: E, mode: 'insert' },
              { schemaComponent: l }
            ),
          key: l,
          maxFileSize: h,
      ...
      Object.keys(S).forEach((v) => {
        const E = this.$refs[`floatingToolbar::${v}`]
        if (!E) {
          console.warn(`Floating toolbar [${v}] not found.`)
          return
        }
        x.registerPlugin(
          sa({
            editor: x,
            element: E,
            pluginKey: `floatingToolbar::${v}`,
            shouldShow: ({ editor: $ }) =>
              $.isFocused && $.isActive(v),
      ...
      const A = Alpine.debounce(() => this.$wire.commit(), u ?? 300);
      (x.on('update', ({ editor: v }) =>
        this.$nextTick(() => {
          ((this.editorUpdatedAt = Date.now()),
          (this.state = v.getJSON()),
          (this.shouldUpdateState = !1),
          (this.fileValidationMessage = null),
          c && A())
        })
      ),
      x.on('selectionUpdate', ({ transaction: v }) => {
        ((this.editorUpdatedAt = Date.now()),
        (this.editorSelection = v.selection.toJSON()))
      }),
      d && x.on('blur', () => this.$wire.commit()),
      this.$watch('state', () => {
        if (!this.shouldUpdateState) {
          this.shouldUpdateState = !0
          return
        }
        x.commands.setContent(this.state)
      }),
      window.addEventListener('run-rich-editor-commands', (v) => {
        v.detail.livewireId === f &&
                        v.detail.key === l &&
                        this.runEditorCommands(v.detail)
      }),
      window.addEventListener('rich-editor-uploading-file', (v) => {
        v.detail.livewireId === f &&
                        v.detail.key === l &&
      ...
      window.addEventListener('rich-editor-uploaded-file', (v) => {
        v.detail.livewireId === f &&
                        v.detail.key === l &&
                        ((this.isUploadingFile = !1), v.stopPropagation())
      }),
    ...
    setEditorSelection (A) {
      A &&
                ((this.editorSelection = A),
                x
                  .chain()
                  .command(
                    ({ tr: v }) => (
                      v.setSelection(
                        D.fromJSON(x.state.doc, this.editorSelection)
                      ),
                      !0
                    )
                  )
    ...
    runEditorCommands ({ commands: A, editorSelection: v }) {
      this.setEditorSelection(v)
      let E = x.chain();
      (A.forEach(($) => (E = E[$.name](...($.arguments ?? [])))),
      E.run())
    },
    togglePanel (A = null) {
      if (this.isPanelActive(A)) {
        this.activePanel = null
        return
      }
      this.activePanel = A
    },
    isPanelActive (A = null) {
      return A === null
        ? this.activePanel !== null
        : this.activePanel === A
    },

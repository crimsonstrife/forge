...
function aa (t, e, n) {
  for (let r = 0; ; r++) {
    ...
    if (o.content.size || i.content.size) {
      const s = aa(o.content, i.content, n + 1)
      if (s != null) return s
    }
    n += o.nodeSize
  }
...
function ca (t, e, n, r) {
  for (let o = t.childCount, i = e.childCount; ;) {
    ...
    if (s.content.size || l.content.size) {
      const c = ca(s.content, l.content, n - 1, r - 1)
      if (c) return c
    }
    ((n -= a), (r -= a))
  }
...
function kr (t, e) {
  ...
  if (n) {
    ...
    for (const r in t) if (!(r in e) || !kr(t[r], e[r])) return !1
...
const M = class t {
  ...
  insertAt (e, n) {
    const r = da(this.content, e + this.openStart, n)
...
function pa (t, e, n, r, o) {
  const i = t.depth > o && wi(t, e, o + 1)
  const s = r.depth > o && wi(n, r, o + 1)
  const l = []
  return (
    On(null, t, o, l),
...
function Sa (t, e) {
  const n = Object.create(null)
  if (e) for (const r in e) n[r] = new Mi(t, r, e[r])
  return n
}
const vr = class t {
  constructor (e, n, r) {
...
const Ue = class t {
  ...
  parse (e, n = {}) {
    const r = new Tr(this, n, !1)
    return (r.addAll(e, V.none, n.from, n.to), r.finish())
  }

  parseSlice (e, n = {}) {
    const r = new Tr(this, n, !0)
...
var Tr = class {
  constructor (e, n, r) {
    ...
    const o = n.topNode
    let i
    const s = ra(null, n.preserveWhitespace, 0) | (r ? Nn : 0);
    (o
      ? (i = new on(
          o.type,
          o.attrs,
  ...
  insertNode (e, n, r) {
    ...
    if (o) {
      ...
      for (const l of o.concat(e.marks)) {
        (i.type ? i.type.allowsMarkType(l.type) : ia(l.type, e.type)) &&
                    (s = l.addToSet(s))
      }
...
function Sr (t, e, n, r) {
  ...
  for (let d = u; d < e.length; d++) {
    ...
    if (f === 0) {
      ...
      const { dom: h, contentDOM: p } = Sr(t, f, n, r)
  ...
  _map (e, n, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= d) {
        ...
        const h = a + o + (f < 0 ? 0 : u)
        if (r) return h
        const p = e == (n < 0 ? a : d) ? null : rp(l / 3, e - a)
        let m = e == a ? Oa : e == d ? Ea : Ar
        return (
          (n < 0 ? e != a : e != d) && (m |= Na),
          new Ln(h, m, p)
        )
...
var lt = class t extends ae {
  ...
  apply (e) {
    const n = e.slice(this.from, this.to)
    const r = new M(
      Ri(n.content, (o) => o.mark(this.mark.removeFromSet(o.marks)), e),
      n.openStart,
      n.openEnd
    )
...
var Ni = class {
  ...
  findCloseLevel (e) {
    e: for (let n = Math.min(this.depth, e.depth); n >= 0; n--) {
      ...
      const s = Ei(e, n, o, r, i)
      if (s) {
        for (let l = n - 1; l >= 0; l--) {
          const { match: a, type: c } = this.frontier[l]
          const u = Ei(e, l, c, a, !0)
...
const E = class {
  ...
  replace (e, n = M.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      l == 0 &&
                    $a(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1))
    }
  }
  ...
  replaceWith (e, n) {
    ...
    for (let i = 0; i < o.length; i++) {
      ...
      i
        ? e.deleteRange(c, u)
        : (e.replaceRangeWith(c, u, n), $a(e, r, n.isInline ? -1 : 1))
    }
  }
...
const Pr = class t {
  ...
  static create (e) {
    const n = new $n(e.doc ? e.doc.type.schema : e.schema, e.plugins)
    const r = new t(n)
  ...
  reconfigure (e) {
    const n = new $n(this.schema, e.plugins)
    const r = n.fields
    const o = new t(n)
    for (let i = 0; i < r.length; i++) {
      const s = r[i].name
  ...
  static fromJSON (e, n, r) {
    ...
    const o = new $n(e.schema, e.plugins)
    const i = new t(o)
    return (
      o.fields.forEach((s) => {
...
const ut = function (t, e, n) {
  const r = Wi || (Wi = document.createRange())
...
const Ap = /^(img|br|input|textarea|hr)$/i
...
const _i = /Edge\/(\d+)/.exec(Et)
const vc = /MSIE \d/.exec(Et)
const ji = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Et)
const ke = !!(vc || ji || _i)
const Tt = vc ? document.documentMode : ji ? +ji[1] : _i ? +_i[1] : 0
const Ve = !ke && /gecko\/(\d+)/i.test(Et)
Ve && +(/Firefox\/(\d+)/.exec(Et) || [0, 0])[1]
const Ki = !ke && /Chrome\/(\d+)/.exec(Et)
const ge = !!Ki
const Tc = Ki ? +Ki[1] : 0
...
const Pp = Je ? /Win/.test(Je.platform) : !1
const dt = /Android \d/.test(Et)
const Gn = !!Ja && 'webkitFontSmoothing' in Ja.documentElement.style
const Ip = Gn
...
const At = class t extends qt {
  ...
  updateChildren (e, n) {
    ...
    const l = i && i.pos < 0
    const a = new Gi(this, s && s.node, e);
    (Zp(
      this.node,
      this.innerDeco,
      (c, u, d) => {
  ...
  localCompositionInfo (e, n) {
    ...
    if (this.node.inlineContent) {
      const s = i.nodeValue
      const l = tm(this.node.content, s, r - n, o - n)
...
var Gi = class {
  ...
  addHackNode (e, n) {
    if (
      ...
      const o = new Br(this.top, [], r, null);
      (n != this.top
        ? n.children.push(o)
...
function dm (t, e) {
  ...
  if (n == 37 || (Re && n == 66 && r == 'c')) {
    ...
    const o =
            n == 39 ? (ac(t, t.state.selection.from) == 'ltr' ? 1 : -1) : 1
    return lc(t, o, r) || hn(t, o)
  } else {
    if (n == 38 || (Re && n == 80 && r == 'c')) {
...
function _c (t, e) {
  if (e == 0) return t
  const n = t.content.replaceChild(t.childCount - 1, _c(t.lastChild, e - 1))
...
const we = {}
const Se = {}
const bm = { touchstart: !0, touchmove: !0 }
const es = class {
  constructor () {
    ((this.shiftKey = !1),
    (this.mouseDown = null),
...
function Rm (t) {
  ...
  const n = Ep(e.focusNode, e.focusOffset)
  const r = Op(e.focusNode, e.focusOffset)
  if (n && r && n != r) {
...
const jn = (ke && Tt < 15) || (yn && Ip < 604)
we.copy = Se.cut = (t, e) => {
  const n = e
  const r = t.state.selection
  const o = n.type == 'cut'
  if (r.empty) return
  const i = jn ? null : n.clipboardData
  const s = r.content()
  const { dom: l, text: a } = us(t, s);
  (i
    ? (n.preventDefault(),
      i.clearData(),
...
function Kn (t, e, n, r, o) {
  const i = $c(t, e, n, r, t.state.selection.$from)
...
Se.paste = (t, e) => {
  ...
  const r = jn ? null : n.clipboardData
  const o = t.input.shiftKey && t.input.lastKeyCode != 45
...
we.dragstart = (t, e) => {
  ...
  const i = o.empty ? null : t.posAtCoords(Kr(n))
  let s
  if (
  ...
  const { dom: a, text: c, slice: u } = us(t, l);
...
const jt = class t {
  ...
  eq (e) {
    return (
      this == e ||
            (e instanceof t && Un(this.attrs, e.attrs) && Un(this.spec, e.spec))
    )
  }
    ...
    e.forEach((l, a) => {
      ...
      if ((u = Zc(n, l, c))) {
        ...
        (o[i] == a
          ...
          : o.splice(i, 0, a, a + l.nodeSize, _r(u, l, c + 1, Kt)),
        (i += 3))
      }
    })
    const s = Qc(i ? eu(n) : n, -r)
    for (let l = 0; l < s.length; l++) {
...
function _r (t, e, n, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      i = !0
      const u = _r(c, l, n + a + 1, r)
      u != me && o.push(a, a + l.nodeSize, u)
    }
  })
  const s = Qc(i ? eu(t) : t, -n).sort(Ut)
  for (let l = 0; l < s.length; l++) {
...
function Jm (t, e, n, r, o) {
  ...
  if (!p) {
    if (
      ...
      if (c.sel) {
        const v = bc(t, t.state.doc, c.sel)
...
const Zm = typeof navigator < 'u' && /Mac/.test(navigator.platform)
const eg =
    typeof navigator < 'u' &&
...
const ng = typeof navigator < 'u' && /Win/.test(navigator.platform)
function rg (t) {
  const e = t.split(/-(?!$)/)
  let n = e[e.length - 1]
  n == 'Space' && (n = ' ')
...
const ys = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (xn(i, 'end') || O.isSelectable(i))) {
    for (let s = r.depth; ; s--) {
      const l = Fn(t.doc, r.before(s), r.after(s), M.empty)
...
const ws = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (xn(i, 'start') || O.isSelectable(i))) {
    const s = Fn(t.doc, r.before(), r.after(), M.empty)
...
const Ts = (t, e) => {
  ...
  const i = Ms(o.parent.contentMatchAt(o.indexAfter()))
...
const lg = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0)
function ag (t, e, n) {
  const r = e.nodeBefore
  const o = e.nodeAfter
  const i = e.index()
...
const gs = Rs(qr, ys, bs)
const ru = Rs(qr, ws, Ss)
const Ot = {
...
const pg = Object.defineProperty
const Tu = (t, e) => {
  for (const n in e) pg(t, n, { get: e[n], enumerable: !0 })
}
function no (t) {
...
function Nu (t) {
  const e = []
  const { nodeExtensions: n, markExtensions: r } = Qn(t)
  const o = [...n, ...r]
  const i = {
    default: null,
    validate: void 0,
...
function bg (t, e) {
  let n
  const r = Nu(t)
  const { nodeExtensions: o, markExtensions: i } = Qn(t)
  ...
  const l = Object.fromEntries(
    o.map((c) => {
      ...
      m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: eo(y, u) }))
  ...
  const a = Object.fromEntries(
    i.map((c) => {
      ...
      return (
        m &&
                    (h.toDOM = (g) => m({ mark: g, HTMLAttributes: eo(g, u) })),
        [c.name, h]
      )
    })
  )
...
function Ws (t, e) {
  const n = oo(typeof e === 'string' ? e : e.name, t.schema)
...
function Ks (t, e, n) {
  ...
  for (
    ;
    a < t.parent.childCount && Su([...t.parent.child(a).marks], e, n);
...
function Yr (t) {
  ...
  return (
    s.forEach((f) => {
      ...
      if (!h) return
      const p = a.state.tr
      const m = no({ state: a.state, transaction: p })
...
function Dg (t) {
  ...
  const { commands: a, chain: c, can: u } = new ro({ editor: e, state: n })
  const d = []
  return (
...
function Ig (t) {
  ...
  const a = ({ state: u, from: d, to: f, rule: h, pasteEvt: p }) => {
    const m = u.tr
    const g = no({ state: u, transaction: m })
    if (
      !(
        !Dg({
          editor: e,
...
const co = class {
  ...
  get plugins () {
    const { editor: t } = this
    const e = Vs([...this.extensions].reverse())
    const n = []
    const r = []
    const o = e
      .map((i) => {
  ...
  get nodeViews () {
    const { editor: t } = this
    const { nodeExtensions: e } = Qn(this.extensions)
    return Object.fromEntries(
      e
  ...
  get markViews () {
    const { editor: t } = this
    const { markExtensions: e } = Qn(this.extensions)
    return Object.fromEntries(
      e
...
var Xg =
    (t = null, e = {}) =>
      ({ editor: n, view: r, tr: o, dispatch: i }) => {
        ...
        const l = $u(o.doc, t) || n.state.selection
...
var gy =
    (t, e) =>
      ({ tr: n, state: r, dispatch: o }) => {
        let i = null
        let s = null
        const l = oo(typeof t === 'string' ? t : t.name, r.schema)
        return l
...
var Dy =
    ({ keepMarks: t = !0 } = {}) =>
      ({ tr: e, state: n, dispatch: r, editor: o }) => {
        ...
        const u = Zr(c, l.node().type.name, l.node().attrs)
...
var Py =
    (t, e = {}) =>
      ({ tr: n, state: r, dispatch: o, editor: i }) => {
        ...
        const p = { ...Zr(f, d.type.name, d.attrs), ...e }
        const m = { ...Zr(f, a.node().type.name, a.node().attrs), ...e }
...
var Iy =
    (t, e, n, r = {}) =>
      ({
        ...
        if (!x) return !1
        const S = Ye((R) => Cu(R.type.name, d))(m)
    ...
    return [
      new N({
        ...
        appendTransaction: (t, e, n) => {
          ...
          const f = n.tr
          const h = no({ state: n, transaction: f })
          const { commands: p } = new ro({
            editor: this.editor,
            state: h
          })
...
const nd = class extends mg {
  constructor (t = {}) {
    ...
    const n = $u(e, this.options.autofocus);
    ...
    const a =
            ...
            (!s &&
                ...
                (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                    !i0(n, t.prevRanges)))
    const c = s ? Qs(t.prevRanges, n.mapping) : cd(n.mapping.maps)
    return new Ze(
      t.done.addTransform(
        n,
...
const u0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/
const d0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g
const f0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/
const h0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g
const p0 = te.create({
  name: 'bold',
  addOptions () {
    return { HTMLAttributes: {} }
...
const go = (t, e) => e.view.domAtPos(t).node.offsetParent !== null
const S0 = (t, e, n) => {
  for (let r = t.depth; r > 0; r -= 1) {
    const o = t.node(r)
    const i = e(o)
    const s = go(t.start(r), n)
    if (i && s) {
      return {
...
const k0 = z.create({ name: 'doc', topNode: !0, content: 'block+' })
const vd = k0
const C0 = z.create({
  name: 'hardBreak',
  addOptions () {
...
const E0 = z.create({
  ...
  addInputRules () {
    return [uo({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type })]
  }
})
const Od = E0
const O0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/
const N0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g
const R0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/
const D0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g
const P0 = te.create({
  name: 'italic',
  addOptions () {
    return { HTMLAttributes: {} }
...
const ul = 'ascii'
const dl = 'alpha'
const or = 'asciinumeric'
const rr = 'alphanumeric'
const fl = 'domain'
const $d = 'emoji'
const H0 = 'scheme'
const F0 = 'slashscheme'
const rl = 'whitespace'
function $0 (t, e) {
    ...
    if (
      ...
      if (r) {
        if (s.t && typeof s.t === 'string') {
          const a = Object.assign(V0(s.t, r), n)
          Xt(i, a, r)
        } else n && Xt(i, n, r)
      }
      s.t = i
...
const Id = (t, e, n, r, o) => t.ts(e, n, r, o)
const k = (t, e, n, r, o) => t.tt(e, n, r, o)
const bt = 'WORD'
const hl = 'UWORD'
const Vd = 'ASCIINUMERICAL'
...
const ir = 'OPENBRACE'
const sr = 'CLOSEBRACE'
const So = 'OPENBRACKET'
const ko = 'CLOSEBRACKET'
const Co = 'OPENPAREN'
const Mo = 'CLOSEPAREN'
const vo = 'OPENANGLEBRACKET'
const To = 'CLOSEANGLEBRACKET'
const Ao = 'FULLWIDTHLEFTPAREN'
const Eo = 'FULLWIDTHRIGHTPAREN'
const Oo = 'LEFTCORNERBRACKET'
const No = 'RIGHTCORNERBRACKET'
const Ro = 'LEFTWHITECORNERBRACKET'
const Do = 'RIGHTWHITECORNERBRACKET'
const Po = 'FULLWIDTHLESSTHAN'
const Io = 'FULLWIDTHGREATERTHAN'
const Lo = 'AMPERSAND'
const Bo = 'APOSTROPHE'
const zo = 'ASTERISK'
const Rt = 'AT'
...
function j0 (t = []) {
  ...
  k(n, '\\', Ho),
  k(n, '\u30FB', _d))
  const r = Z(n, yt, yl, { [cl]: !0 })
  Z(r, yt, r)
  const o = Z(r, gt, Vd, { [or]: !0 })
  const i = Z(r, nr, Wd, { [rr]: !0 })
  const s = Z(n, gt, bt, { [ul]: !0 });
  (Z(s, yt, o), Z(s, gt, s), Z(o, yt, o), Z(o, gt, o))
  const l = Z(n, nr, hl, { [dl]: !0 });
  (Z(l, gt), Z(l, yt, i), Z(l, nr, l), Z(i, yt, i), Z(i, gt), Z(i, nr, i))
  const a = k(n, sl, bl, { [rl]: !0 })
  const c = k(n, Ld, gl, { [rl]: !0 })
  const u = Z(n, il, gl, { [rl]: !0 });
  (k(n, ll, u),
  k(c, sl, a),
  k(c, ll, u),
  Z(c, il, u),
...
function Ud (t, e) {
  const n = K0(e.replace(/[A-Z]/g, (l) => l.toLowerCase()))
  const r = n.length
  const o = []
  let i = 0
  let s = 0
...
const G0 = (typeof console < 'u' && console && console.warn) || (() => {})
const Y0 =
...
const vl = '[\0- \xA0\u1680\u180E\u2000-\u2029\u205F\u3000]'
const Q0 = new RegExp(vl)
const Z0 = new RegExp(`${vl}$`)
const eb = new RegExp(vl, 'g')
function tb (t) {
  return t.length === 1
    ? t[0].isLink
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (
        (_s(l).forEach(({ newRange: c }) => {
          const u = Eu(r.doc, c, (h) => h.isTextblock)
          let d
          let f
          if (u.length > 1) {
            ((d = u[0]),
          ...
          if (d && f) {
            const h = f.split(Q0).filter(Boolean)
  ...
  return new N({
    ...
    props: {
      handleClick: (e, n, r) => {
        ...
        if (!s) return !1
        const l = Ws(e.state, t.type.name)
  ...
  return new N({
    ...
    props: {
      handlePaste: (e, n, r) => {
        ...
        const a = Yo(l, { defaultProtocol: t.defaultProtocol }).find(
...
const Gd = ib
const sb = Object.defineProperty
const lb = (t, e) => {
  for (const n in e) sb(t, n, { get: e[n], enumerable: !0 })
}
const ab = 'listItem'
const Yd = 'textStyle'
const Xd = /^\s*([-+*])\s$/
...
const sf = ['image/png', 'image/jpeg', 'image/gif', 'image/webp']
const Xo = (t, e, n = {}) => {
  t.dom
    .closest('form')
    ?.dispatchEvent(
        ...
        return a.length
          ? (l.preventDefault(),
            ...
            a.forEach((c, u) => {
              ...
              const d = ('10000000-1000-4000-8000' + -1e11).replace(
                /[018]/g,
                (f) =>
                  (
                    f ^
          ...
          ((g = {
            ...
            clientRect: Xl
              ? () => {
                  ...
                  return Ql?.getBoundingClientRect() || null
                }
              : null
          }),
...
const ZC = vn('row', { useDeprecatedLogic: !0 })
const eM = vn('column', { useDeprecatedLogic: !0 })
const Hf = vn('cell', { useDeprecatedLogic: !0 })
function qb (t, e) {
  if (e < 0) {
...
function lx (t, e, n, r) {
  ...
  const a = ax(t, s.activeHandle, l.attrs)
  t.dispatch(
...
const oi = ({ editor: t }) => {
  ...
  if (!wx(e)) return !1
  let n = 0
  const r = Hs(e.ranges[0].$from, (i) => i.type.name === 'table')
  return (
...
const kx = z.create({ name: 'text', group: 'inline' })
const Jf = kx
const Cx = $.create({
  name: 'textAlign',
  addOptions () {
...
const mr = Math.round
const _e = (t) => ({ x: t, y: t })
const vx = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' }
const Tx = { start: 'end', end: 'start' }
function ii (t, e, n) {
  return fe(t, ze(e, n))
}
function rt (t, e) {
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const m = d !== void 0 || f === Kl ? Dx(d || null, h, f) : f
...
const Vx = ['paint', 'layout', 'strict', 'content']
function di (t) {
  const e = fi()
  const n = Fe(t) ? $e(t) : t
  return (
...
const Wx = new Set(['html', 'body', '#document'])
function nn (t) {
  return Wx.has(tn(t))
}
function $e (t) {
...
function St (t) {
  ...
  const e = t.assignedSlot || t.parentNode || (ph(t) && t.host) || ot(t)
...
function An (t) {
  ...
  const { width: r, height: o, $: i } = Sh(e)
  let s = (i ? mr(n.width) : n.width) / r
  let l = (i ? mr(n.height) : n.height) / o
  return (
...
function Gl (t, e) {
  const n = yr(t).scrollLeft
  return e ? e.left + n : br(ot(t)).left + n
}
function Mh (t, e, n) {
  n === void 0 && (n = !1)
  const r = t.getBoundingClientRect()
  const o = r.left + e.scrollLeft - (n ? 0 : Gl(t, r))
...
const Gx = new Set(['absolute', 'fixed'])
function Yx (t, e) {
  const n = br(t, !0, e === 'fixed')
  const r = n.top + t.clientTop
  const o = n.left + t.clientLeft
  const i = Ke(t) ? An(t) : _e(1)
...
const tw = async function (t) {
  const e = this.getOffsetParent || Th
...
const Ih = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
  items: ({ query: n }) =>
    t.filter((r) =>
...
const iw = class {
  constructor ({
    ...
    (this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
      ...
      const { empty: h } = f
      const p = !d.textBetween(c, u).length && lo(a.selection)
    ...
    if (t instanceof K) {
      ...
      const a =
                s === l
                  ...
                  : ow(s.getBoundingClientRect(), l.getBoundingClientRect())

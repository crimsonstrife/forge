...
function da (t, e, n, r) {
  for (let o = t.childCount, i = e.childCount; ;) {
    ...
    if (s.content.size || l.content.size) {
      const c = da(s.content, l.content, n - 1, r - 1)
      if (c) return c
    }
    ((n -= a), (r -= a))
  }
...
function ha (t, e, n, r) {
  ...
  if (o == e.index(r) && r < t.depth - n.openStart) {
    ...
    if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
      ...
      const { start: s, end: l } = Wh(n, t)
      return Bt(i, ma(t, s, l, e, r))
    }
  } else return Bt(i, Mr(t, e, r))
}
function pa (t, e) {
...
function ma (t, e, n, r, o) {
  ...
  return (
    ...
    i && s && e.index(o) == n.index(o)
      ...
      : (i && Lt(Bt(i, Mr(t, e, o + 1)), l),
        Nn(e, n, o, l),
        s && Lt(Bt(s, Mr(n, r, o + 1)), l)),
    Nn(r, null, o, l),
    new w(l)
  )
}
...
const vr = class t {
  ...
  static resolveCached (e, n) {
    ...
    } else ea.set(e, (r = new Mi()))
    const o = (r.elts[r.i] = t.resolve(e, n))
    return ((r.i = (r.i + 1) % jh), o)
  }
}
var Mi = class {
  constructor () {
...
const le = class t {
  ...
  hasMarkup (e, n, r) {
    return (
      this.type == e &&
            Cr(this.attrs, n || e.defaultAttrs || Kh) &&
  ...
  replace (e, n, r) {
    return _h(this.resolve(e), this.resolve(n), r)
  }
...
const Tr = class t {
  ...
  create (e = null, n, r) {
    ...
    return new le(this, this.computeAttrs(e), w.from(n), K.setFrom(r))
  }
  ...
  createAndFill (e = null, n, r) {
    ...
    const i = o && o.fillBefore(w.empty, !0)
...
const ln = class {
  ...
  text (e, n) {
    ...
    return new vi(r, r.defaultAttrs, e, K.setFrom(n))
  }
...
const sn = class {
  ...
  findWrapping (e) {
    if (!this.match) {
      if (!this.type) return []
      const n = this.type.contentMatch.fillBefore(w.from(e))
...
`
  ...
  addElement (e, n, r) {
    ...
    let l
    Ma.hasOwnProperty(s) && this.parser.normalizeLists && op(e)
    const a =
            (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
            (l = this.parser.matchTag(e, this, r))
    e: if (a ? a.ignore : rp.hasOwnProperty(s)) {
...
function sp (t) {
  let e = aa.get(t)
  return (e === void 0 && aa.set(t, (e = lp(t))), e)
}
function lp (t) {
  let e = null
  function n (r) {
  ...
  _map (e, n, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        const h = a + o + (f < 0 ? 0 : d)
        if (r) return h
        const p = e == (n < 0 ? a : u) ? null : ap(l / 3, e - a)
        let m = e == a ? Na : e == u ? Oa : Er
        return (
          (n < 0 ? e != a : e != u) && (m |= Ra),
          new Bn(h, m, p)
        )
...
function Li (t, e, n, r = n.contentMatch, o = !0) {
  ...
  if (!r.validEnd) {
    const a = r.fillBefore(w.empty, !0)
...
function at (t) {
  ...
  for (let r = t.depth; ; --r) {
    ...
    if (r == 0 || o.type.spec.isolating || !fp(o, i, s)) break
  }
  return null
}
function hp (t, e, n) {
  ...
  for (let p = i, m = !1; p > n; p--) {
    m || r.index(p) > 0
      ? ((m = !0), (d = w.from(r.node(p).copy(d))), u++)
      : a--
  }
  let f = w.empty
  let h = 0
  ...
  t.step(new re(a, c, s, l, new A(d.append(f), u, h), d.size - u, !0))
}
function dn (t, e, n = null, r = t) {
  const o = pp(t, e)
  const i = o && mp(r, e)
      ...
      return (
        t.step(
          new re(
            ...
            u + 1,
            f - 1,
            new A(w.from(r.create(a, null, s.marks)), 0, 0),
            1,
            !0
          )
        ),
...
function wp (t, e, n = 1, r) {
  ...
  for (let l = o.depth, a = o.depth - n, c = n - 1; l > a; l--, c--) {
    ...
    const d = r && r[c]
    s = w.from(d ? d.type.create(d.attrs, s) : o.node(l).copy(s))
  }
...
function kp (t, e, n) {
  ...
  if ((t.step(new pe(c, a.map(e + n, -1), A.empty, !0)), r === !0)) {
    ...
    Da(t, d.node(), d.before(), t.steps.length)
  }
  return t
}
function Cp (t, e, n) {
...
var Pi = class {
  ...
  placeNodes ({
    ...
    (p || (h = -1),
    (this.placed = Ln(this.placed, n, w.from(d))),
  ...
  openFrontierNode (e, n = null, r) {
    ...
    (this.placed = Ln(this.placed, this.depth, w.from(e.create(n, r)))),
    this.frontier.push({ type: e, match: e.contentMatch }))
  }

  closeFrontierNode () {
    const n = this.frontier.pop().match.fillBefore(w.empty, !0)
    n.childCount &&
...
function Ri (t, e, n, r, o) {
  ...
  return l && !Mp(n, i.content, s) ? l : null
}
function Mp (t, e, n) {
...
function Ap (t, e, n, r) {
  if (!r.isInline && e == n && t.doc.resolve(e).parent.content.size) {
    const o = Cp(t.doc, e, r.type)
    o != null && (e = n = o)
  }
  t.replaceRange(e, n, new A(w.from(r), 0, 0))
}
function Ep (t, e, n) {
...
const kt = class {
  ...
  replaceWith (e, n, r) {
    return this.replace(e, n, new A(w.from(r), 0, 0))
  }
  ...
  wrap (e, n) {
    return (gp(this, e, n), this)
  }

  setBlockType (e, n = e, r, o = null) {
    return (yp(this, e, n, r, o), this)
  }

  setNodeMarkup (e, n, r = null, o) {
    return (xp(this, e, n, r, o), this)
  }
  ...
  split (e, n = 1, r) {
    return (wp(this, e, n, r), this)
  }

  addMark (e, n, r) {
    return (dp(this, e, n, r), this)
  }
...
const D = class {
  ...
  replaceWith (e, n) {
    ...
    for (let i = 0; i < o.length; i++) {
      ...
      i
        ? e.deleteRange(c, d)
        : (e.replaceRangeWith(c, d, n), Va(e, r, n.isInline ? -1 : 1))
    }
  }
...
const P = class t extends D {
  ...
  content () {
    return new A(w.from(this.node), 0, 0)
  }
...
function un (t, e, n, r, o, i = !1) {
  ...
  for (
    ...
    if (l.isAtom) {
      ...
      const a = un(t, l, n + o, o < 0 ? l.childCount : 0, o, i)
      if (a) return a
    }
    n += l.nodeSize * o
  }
...
const Dp = /^(img|br|input|textarea|hr)$/i
...
function Pp (t, e) {
  for (;;) {
    ...
    } else if (t.parentNode && !Gn(t)) ((e = de(t)), (t = t.parentNode))
    else return null
  }
}
function Ip (t, e) {
...
const Hp = Je ? /Win/.test(Je.platform) : !1
const ut = /Android \d/.test(Et)
...
function Wp ({ refDOM: t, refTop: e, stack: n }) {
...
function Gp (t, e) {
  ...
  if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
    ...
    if (!ds(e, c) || ((s = Rc(t.dom, e, c)), !s)) return null
  }
...
function Dc (t, e, n) {
  ...
  if (r.nodeType == 3) {
    if (
      s &&
            (Yp.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))
    ) {
      const a = Ct(dt(r, o, o), n)
      if (
        Pe &&
                o &&
        ...
        const c = Ct(dt(r, o - 1, o - 1), -1)
        if (c.top == a.top) {
          const d = Ct(dt(r, o, o + 1), -1)
          if (d.top != a.top) return _n(d, d.left < c.left)
        }
      }
      return a
    } else {
  ...
  return _n(Ct(r.nodeType == 3 ? dt(r) : r, -n), n >= 0)
}
function _n (t, e) {
...
function Zp (t, e, n) {
  ...
  return l
    ? !Qp.test(r.parent.textContent) || !l.modify
        ? n == 'left' || n == 'backward'
          ? i
          : s
        : Pc(t, e, () => {
...
function em (t, e, n) {
  return Xa == e && Qa == n
    ...
    : ((Xa = e),
      (Qa = n),
      (Za = n == 'up' || n == 'down' ? Xp(t, e, n) : Zp(t, e, n)))
}
const Ie = 0
const ec = 1
const Wt = 2
...
const At = class t extends Gt {
  ...
  static create (e, n, r, o, i, s) {
    ...
    return (
      (d = Bc(d, r, n)),
      c
        ? (a = new Yi(e, n, r, o, d, u || null, f, c, i, s + 1))
        : n.isText
          ? new Br(e, n, r, o, d, f, i)
  ...
  localCompositionInfo (e, n) {
    ...
    if (this.node.inlineContent) {
      const s = i.nodeValue
      const l = sm(this.node.content, s, r - n, o - n)
...
var Qi = class {
  constructor (e, n, r) {
    ...
    (this.changed = !1),
    (this.top = e),
    (this.preMatch = nm(e.node.content, e)))
  }
  ...
  if (Kr(n)) {
    ...
    if (
      o &&
            ...
            P.isSelectable(u) &&
            o.parent &&
            !(u.isInline && Lp(n.focusNode, n.focusOffset, o.dom))
    ) {
      const f = o.posBefore
    ...
    if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) am(t)
      ...
      n.visible
        ...
        : (t.dom.classList.add('ProseMirror-hideselection'),
          'onselectionchange' in document && lm(t)))
    }
...
function hm (t, e) {
  for (; t && !e && !Gn(t);) ((e = de(t)), (t = t.parentNode))
  for (; t && e;) {
...
function ts (t, e, n) {
  if (e.nodeType != 3) {
    ...
    (s = fm(e, n))
      ? ((e = s), (n = 0))
      : (i = hm(e, n)) && ((e = i), (n = i.nodeValue.length))
  }
...
function cc (t, e) {
  ...
  if (!(ge || Hp) && n.parent.inlineContent) {
...
function gm (t, e) {
  const n = e.keyCode
  const r = mm(e)
  if (n == 8 || (Re && n == 72 && r == 'c')) return uc(t, -1) || pn(t, -1)
  if ((n == 46 && !e.shiftKey) || (Re && n == 68 && r == 'c')) {
    return uc(t, 1) || pn(t, 1)
  }
  ...
  if (n == 37 || (Re && n == 66 && r == 'c')) {
    ...
    if (n == 38 || (Re && n == 80 && r == 'c')) {
      return dc(t, -1, r) || pn(t, -1)
    }
    if (n == 40 || (Re && n == 78 && r == 'c')) {
      return pm(t) || dc(t, 1, r) || pn(t, 1)
    }
    if (
      r == (Re ? 'm' : 'c') &&
            (n == 66 || n == 73 || n == 89 || n == 90)
...
function hs (t, e) {
  ...
  let d
  let u = 0
  for (; c && c.nodeType == 1 && (d = Kc[c.nodeName.toLowerCase()]);) {
...
`
  ...
  if (
    ...
    l = km(hc(l, +d[1], +d[2]), d[4])
  } else if (
    ((l = A.maxOpen(bm(l.content, o), !0)), l.openStart || l.openEnd)
  ) {
    let u = 0
    let f = 0
    for (
...
function Wc (t, e, n, r, o) {
  if (o < t.length && o < e.length && t[o] == e[o]) {
    ...
    if (
      ...
      return r.copy(r.content.append(w.from(_c(n, t, o + 1))))
    }
  }
}
function jc (t, e) {
  ...
  const r = t.contentMatchAt(t.childCount).fillBefore(w.empty, !0)
...
const we = {}
const Se = {}
const Cm = { touchstart: !0, touchmove: !0 }
const rs = class {
  constructor () {
    ((this.shiftKey = !1),
    (this.mouseDown = null),
...
Se.keydown = (t, e) => {
  ...
  if (
    ...
    if (
      ...
      t.someProp('handleKeyDown', (r) => r(t, n)) || gm(t, n)
        ? n.preventDefault()
        : vt(t, 'key')
    }
  }
...
function Im (t, e, n) {
  ...
  if (e == -1) {
    return r.inlineContent
      ? (gn(t, R.create(r, 0, r.content.size), 'pointer'), !0)
      : !1
  }
  const o = r.resolve(e)
  for (let i = o.depth + 1; i > 0; i--) {
    ...
    const l = o.before(i)
    if (s.inlineContent) {
      gn(t, R.create(r, l + 1, l + 1 + s.content.size), 'pointer')
...
we.mousedown = (t, e) => {
  ...
  s &&
        (i == 'singleClick'
          ...
          : (i == 'doubleClick' ? Dm : Pm)(t, s.pos, s.inside, n)
              ? n.preventDefault()
              : vt(t, 'pointer'))
}
var ss = class {
  ...
  up (e) {
    ...
    this.allowDefault || !n
      ...
      : Rm(this.view, n.pos, n.inside, e, this.selectNode)
        ? e.preventDefault()
        : e.button == 0 &&
                      (this.flushed ||
                          (xe &&
...
we.touchstart = (t) => {
  ((t.input.lastTouch = Date.now()), gs(t), vt(t, 'pointer'))
}
we.touchmove = (t) => {
...
function Yc (t) {
  for (
    t.composing &&
        ((t.input.composing = !1), (t.input.compositionEndedAt = zm()));
...
function Bm (t) {
  ...
  const n = Pp(e.focusNode, e.focusOffset)
  const r = Ip(e.focusNode, e.focusOffset)
  if (n && r && n != r) {
...
we.dragstart = (t, e) => {
  ...
  const { dom: a, text: c, slice: d } = hs(t, l);
    ...
    e.forEach((l, a) => {
      ...
      if ((d = ed(n, l, c))) {
        ...
        (o[i] == a
          ...
          : o.splice(i, 0, a, a + l.nodeSize, jr(d, l, c + 1, Ut)),
        (i += 3))
      }
    })
    const s = Zc(i ? td(n) : n, -r)
    for (let l = 0; l < s.length; l++) {
...
function jr (t, e, n, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      i = !0
      const d = jr(c, l, n + a + 1, r)
      d != me && o.push(a, a + l.nodeSize, d)
    }
  })
  const s = Zc(i ? td(t) : t, -n).sort(Jt)
  for (let l = 0; l < s.length; l++) {
...
const cs = class {
  ...
  start () {
    (this.observer &&
            ...
            this.observer.observe(this.view.dom, jm)),
    this.onCharData &&
  ...
  flush () {
    ...
    i < 0 &&
      ...
      ? ((e.input.lastFocus = 0),
        ...
        e.scrollToSelection())
      : (i > -1 || o) &&
              (i > -1 && (e.docView.markDirty(i, s), Um(e)),
...
function Qm (t, e, n, r, o) {
  ...
  if (((t.input.compositionPendingChanges = 0), e < 0)) {
    ...
    if (N && !t.state.selection.eq(N)) {
      ...
      const v = t.state.tr.setSelection(N);
      (x == 'pointer'
        ? v.setMeta('pointer', !0)
        : x == 'key' && v.scrollIntoView(),
  ...
  if (
    ...
    ((bn && t.input.lastIOSEnter > Date.now() - 225) || ut) &&
            o.some((x) => x.nodeType == 1 && !Xm.test(x.nodeName)) &&
            (!p || p.endA >= p.endB) &&
            t.someProp('handleKeyDown', (x) => x(t, _t(13, 'Enter'))))
  ) {
    t.input.lastIOSEnter = 0
    return
  }
  if (!p) {
    if (
      ...
      if (c.sel) {
        const x = xc(t, t.state.doc, c.sel)
        if (x && !x.eq(t.state.selection)) {
          const N = t.state.tr.setSelection(x);
  ...
  if (
    t.state.selection.anchor > p.start &&
        ...
        t.someProp('handleKeyDown', (x) => x(t, _t(8, 'Backspace')))
  ) {
      ...
      v &&
                !(
                  (ge &&
                        ...
                        (v.head == E || v.head == N.mapping.map(S) - 1)) ||
                    (ke && v.empty && v.head == E)
                ) &&
                N.setSelection(v)
    }
  ...
  if (b) {
    if (m.pos == g.pos) {
      ke &&
                ...
                setTimeout(() => ft(t), 20))
      const x = C(t.state.tr.delete(E, S))
      ...
      const x = C(t.state.tr);
      (T.type == 'add'
        ? x.addMark(E, S, T.mark)
        : x.removeMark(E, S, T.mark),
      t.dispatch(x))
    } else if (
      m.parent.child(m.index()).isText &&
            m.index() == g.index() - (g.textOffset ? 0 : 1)
    ) {
      const x = m.parent.textBetween(m.parentOffset, g.parentOffset)
      const N = () => C(t.state.tr.insertText(x, E, S))
      t.someProp('handleTextInput', (v) => v(t, E, S, x, N)) ||
                t.dispatch(N())
    }
  } else t.dispatch(C())
}
...
const qn = class {
  ...
  update (e) {
    ...
    ((this._props = e),
    e.plugins &&
                (e.plugins.forEach(vc), (this.directPlugins = e.plugins)),
  ...
  updateStateInner (e, n) {
    ...
    if (s) {
      ...
      let h =
                ...
                !o.selection.empty &&
                !e.selection.empty &&
                ng(o.selection, e.selection)
      if (u) {
        const p = ge
          ? (this.trackWrites = this.domSelectionRange().focusNode)
          : null;
        (this.composing && (this.input.compositionNode = Bm(this)),
  ...
  domSelectionRange () {
    ...
    return e
      ? (xe &&
                  ...
                  Bp(this.dom.ownerDocument) == this.dom &&
                  Jm(this, e)) ||
                  e
      : {
          focusNode: null,
...
const og = typeof navigator < 'u' && /Mac/.test(navigator.platform)
const ig =
    typeof navigator < 'u' &&
...
function nd (t) {
  const e =
        (og && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
...
const lg = typeof navigator < 'u' && /Win/.test(navigator.platform)
function ag (t) {
  const e = t.split(/-(?!$)/)
  let n = e[e.length - 1]
  n == 'Space' && (n = ' ')
  ...
  for (let l = 0; l < e.length - 1; l++) {
    ...
    else if (/^mod$/i.test(a)) sg ? (s = !0) : (o = !0)
...
const fg = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0)
function hg (t, e, n) {
  const r = e.nodeBefore
  const o = e.nodeAfter
  const i = e.index()
...
function pd (t, e, n, r) {
  ...
  const d = i.type.spec.isolating || (r > 0 && a) ? null : D.findFrom(e, 1)
...
const od = Is(Gr, Cs, Ms)
const Ot = {
  Enter: Is(Ts, Os, Ns, ug),
  'Mod-Enter': Es,
  Backspace: xs,
  'Mod-Backspace': xs,
  'Shift-Backspace': xs,
...
function yd (t, e = null) {
  return function (n, r) {
    ...
    if (!s) return !1
    const l = r ? n.tr : null
    return mg(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1
  }
}
function mg (t, e, n, r = null) {
  ...
  const l = dn(i, n, r, e)
  return l ? (t && gg(t, e, l, o, n), !0) : !1
}
function gg (t, e, n, r, o) {
  let i = w.empty
  ...
  i < s &&
        (o.step(
          new re(
            ...
            i,
            s,
            new A(w.from(n.create(null, r.parent.copy())), 1, 0),
            1,
            !0
          )
        ),
...
function xd (t) {
  return function (e, n) {
    ...
    if (n) {
      ...
      const d = w.from(c ? t.create() : null)
      const u = new A(
        w.from(t.create(null, w.from(l.type.create(null, d)))),
        c ? 3 : 1,
        0
      )
      const f = i.start
...
const xg = Object.defineProperty
const Ad = (t, e) => {
  for (const n in e) xg(t, n, { get: e[n], enumerable: !0 })
}
function ro (t) {
...
function U (t, e = void 0, ...n) {
  return Nd(t) ? (e ? t.bind(e)(...n) : t(...n)) : t
}
function Sg (t = {}) {
  ...
  const l = Object.fromEntries(
    o.map((c) => {
      ...
      const f = t.reduce((y, b) => {
        const k = L(b, 'extendNodeSchema', u)
        return { ...y, ...(k ? k(c) : {}) }
      }, {})
      const h = Sd({
        ...f,
        content: U(L(c, 'content', u)),
        marks: U(L(c, 'marks', u)),
        group: U(L(c, 'group', u)),
        inline: U(L(c, 'inline', u)),
        atom: U(L(c, 'atom', u)),
        selectable: U(L(c, 'selectable', u)),
        draggable: U(L(c, 'draggable', u)),
        code: U(L(c, 'code', u)),
        whitespace: U(L(c, 'whitespace', u)),
        linebreakReplacement: U(L(c, 'linebreakReplacement', u)),
        defining: U(L(c, 'defining', u)),
        isolating: U(L(c, 'isolating', u)),
      ...
      const p = U(L(c, 'parseHTML', u))
      p && (h.parseDOM = p.map((y) => wd(y, d)))
      const m = L(c, 'renderHTML', u)
      m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: to(y, d) }))
      const g = L(c, 'renderText', u)
  ...
  const a = Object.fromEntries(
    i.map((c) => {
      ...
      const f = t.reduce((g, y) => {
        const b = L(y, 'extendMarkSchema', u)
        return { ...g, ...(b ? b(c) : {}) }
      }, {})
      const h = Sd({
        ...f,
        inclusive: U(L(c, 'inclusive', u)),
        excludes: U(L(c, 'excludes', u)),
        group: U(L(c, 'group', u)),
        spanning: U(L(c, 'spanning', u)),
        code: U(L(c, 'code', u)),
        attrs: Object.fromEntries(
          d.map((g) => {
            let y, b
      ...
      const p = U(L(c, 'parseHTML', u))
      p && (h.parseDOM = p.map((g) => wd(g, d)))
      const m = L(c, 'renderHTML', u)
      return (
        m &&
                    (h.toDOM = (g) => m({ mark: g, HTMLAttributes: to(g, d) })),
        [c.name, h]
      )
    })
  )
...
function Ks (t, e) {
  ...
  return n === 'node' ? Tg(t, e) : n === 'mark' ? Ld(t, e) : {}
}
function Ag (t, e = JSON.stringify) {
  const n = {}
  return t.filter((r) => {
    const o = e(r)
...
function qs (t, e, n) {
  ...
  for (; s > 0 && kd([...t.parent.child(s - 1).marks], e, n);) {
    ((s -= 1), (l -= t.parent.child(s).nodeSize))
  }
  for (
    ;
    a < t.parent.childCount && kd([...t.parent.child(a).marks], e, n);
...
function Fs (t, e, n = {}) {
  ...
  const a = l
    ...
    .filter((u) => no(u.mark.attrs, n, { strict: !1 }))
...
function Ge (t, e, n = {}) {
  ...
  const c = l
    ...
    .filter((u) => no(u.node.attrs, n, { strict: !1 }))
  ...
  return (
    Qr(t) &&
            ...
            Object.keys(e).forEach((r) => {
              Qr(e[r]) && Qr(t[r]) ? (n[r] = _d(t[r], e[r])) : (n[r] = e[r])
            }),
    n
  )
}
...
function zg (t) {
  ...
  const { commands: a, chain: c, can: d } = new oo({ editor: e, state: n })
  const u = []
  return (
    n.doc.nodesBetween(r, o, (h, p) => {
      ...
      const E =
                (k =
                  ...
                  ? k
                  : 0
      const S = Math.max(r, p)
      const C = Math.min(o, p + E)
      if (S >= C) return
      const T = h.isText
        ? h.text || ''
        : h.textBetween(S - p, C - p, void 0, '\uFFFC')
      Bg(T, i.find, s).forEach((N) => {
        if (N.index === void 0) return
        const v = S + N.index + 1
        const F = v + N[0].length
        const _ = {
...
function Fg (t) {
  ...
  const a = ({ state: d, from: u, to: f, rule: h, pasteEvt: p }) => {
    const m = d.tr
    const g = ro({ state: d, transaction: m })
    if (
      !(
        !zg({
          editor: e,
...
const uo = class {
  constructor (t, e) {
    ...
    (this.editor = e),
    (this.extensions = Dd(t)),
    (this.schema = Cg(this.extensions, e)),
  ...
  get plugins () {
    ...
    return js([...this.extensions].reverse())
      .map((r) => {
        ...
        if (Cd(r, t.options.enableInputRules) && c) {
          const f = c()
          if (f && f.length) {
            const h = Dg({ editor: t, rules: f })
            const p = Array.isArray(h) ? h : [h]
            i.push(...p)
          }
        }
        const d = L(r, 'addPasteRules', o)
        if (Cd(r, t.options.enablePasteRules) && d) {
          const f = d()
          if (f && f.length) {
            const h = Fg({ editor: t, rules: f })
            i.push(...h)
          }
        }
        const u = L(r, 'addProseMirrorPlugins', o)
        if (u) {
          const f = u()
          i.push(...f)
        }
  ...
  setupExtensions () {
    ...
    t.forEach((e) => {
      ...
      const d = L(e, 'onBlur', r)
      const u = L(e, 'onDestroy', r);
...
var ny =
    (t = null, e = {}) =>
      ({ editor: n, view: r, tr: o, dispatch: i }) => {
        ...
        const l = Vd(o.doc, t) || n.state.selection
      ...
      ({ tr: r, dispatch: o, editor: i }) => {
        ...
        if (o) {
          ...
          if (f) {
            ...
            const E = y.content.size > 0;
            (b && k && E && (d = Math.max(0, d - 1)),
            r.replaceWith(d, u, m))
          }
          (n.updateSelection && Ng(r, r.steps.length - 1, -1),
          n.applyInputRules &&
...
function my (t) {
  ...
  for (let l = 0; l < e.length - 1; l += 1) {
    ...
    else if (/^mod$/i.test(a)) Xs() || Jd() ? (s = !0) : (o = !0)
    else throw new Error(`Unrecognized modifier name: ${a}`)
  }
  return (
    r && (n = `Alt-${n}`),
            ...
            o &&
                  n.selection.ranges.forEach((a) => {
                    r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, d) => {
                      (i &&
                              i === c.type &&
                              n.setNodeMarkup(d, void 0, vd(c.attrs, e)),
                      s &&
                                  c.marks.length &&
                                  c.marks.forEach((u) => {
                                    s === u.type &&
...
var zy =
    ({ keepMarks: t = !0 } = {}) =>
      ({ tr: e, state: n, dispatch: r, editor: o }) => {
        ...
        const d = eo(c, l.node().type.name, l.node().attrs)
        if (i instanceof P && i.node.isBlock) {
          return !l.parentOffset || !Ae(s, l.pos)
            ? !1
            : (r &&
                      (t && Td(n, o.extensionManager.splittableMarks),
      ...
      ({ tr: n, state: r, dispatch: o, editor: i }) => {
        ...
        if (
          ...
          if (o) {
            ...
            n.replace(C, a.after(-k), new A(y, 4 - b, 0))
            let T = -1;
            (n.doc.nodesBetween(C, n.doc.content.size, (x, N) => {
              if (T > -1) return !1
              x.isTextblock && x.content.size === 0 && (T = N + 1)
            }),
            T > -1 && n.setSelection(R.near(n.doc.resolve(T))),
            n.scrollIntoView())
          }
          return !0
        }
        const h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null
        const p = { ...eo(f, u.type.name, u.attrs), ...e }
        ...
        if (o) {
          ...
          if ((n.split(a.pos, 2, g).scrollIntoView(), !E || !o)) {
            return !0
          }
          const S = E.filter((C) => k.includes(C.type.name))
          n.ensureMarks(S)
        }
        return !0
      }
        ...
        return !n || !E || !l
          ...
          : a()
            .command(() => {
              ...
              const T = E.filter((x) => f.includes(x.type.name))
              return (i.ensureMarks(T), C ? !0 : c.clearNodes())
            })
            .wrapInList(h, r)
            .command(() => Bs(i, h))
            .command(() => zs(i, h))
        ...
        if (h instanceof lt) {
          ...
          const S =
                        (m = d.doc.nodeAt(y - 1)) == null
                          ? void 0
                          : m.marks.some((T) => T.eq(h.mark))
          const C =
                        (g = d.doc.nodeAt(b)) == null
                          ? void 0
                          : g.marks.some((T) => T.eq(h.mark))
          this.editor.emit('delete', {
            type: 'mark',
            mark: h.mark,
            from: h.from,
            to: h.to,
            deletedRange: { from: k, to: E },
...
const ru = class extends wg {
  constructor (t = {}) {
    ...
    const n = Vd(e, this.options.autofocus);
  ...
  injectCSS () {
    this.options.injectCSS &&
            typeof document < 'u' &&
            (this.css = Xy(Yy, this.options.injectNonce))
  }
...
`,
    ...
    return vg(this.state.doc, {
      blockSeparator: e,
      textSerializers: { ...Id(this.schema), ...n }
    })
  }
...
const se = class t extends D {
  ...
  static valid (e) {
    const n = e.parent
    if (n.isTextblock || !Zy(e) || !e0(e)) return !1
...
function au () {
  return new I({
    props: {
      ...
      handleClick: n0,
      handleKeyDown: t0,
      handleDOMEvents: { beforeinput: r0 }
    }
  })
}
var t0 = Xn({
...
ue.from = function (e) {
  return e instanceof ue ? e : e && e.length ? new cu(e) : ue.empty
}
var cu = (function (t) {
  function e (r) {
...
const Xt = class t {
  ...
  addTransform (e, n, r, o) {
    ...
    const c = s - r.depth
    return (c > a0 && ((l = l0(l, c)), (s -= c)), new t(l.append(i), s))
  }
...
function c0 (t, e, n, r) {
  ...
  n.getMeta(f0) && (t = new Ze(t.done, t.undone, null, 0, -1))
    ...
    const a =
            ...
            (!s &&
                ...
                (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                    !d0(n, t.prevRanges)))
    const c = s ? tl(t.prevRanges, n.mapping) : du(n.mapping.maps)
    return new Ze(
      t.done.addTransform(
        n,
    ...
    return [
      new I({
        ...
        appendTransaction: (n, r, o) => {
          ...
          const d = l.nodes[this.options.node]
          if (a) return s.insert(c, d.create())
        },
        state: {
          init: (n, r) => {
            const o = r.tr.doc.lastChild
            return !hu({ node: o, types: e })
          },
          apply: (n, r) => {
...
const p0 = H.create({
  ...
  addInputRules () {
    return [Xe({ find: h0, type: this.type })]
  }
})
const yu = p0
const m0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/
const g0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g
const y0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/
const b0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g
const x0 = Z.create({
  name: 'bold',
  addOptions () {
    return { HTMLAttributes: {} }
  ...
  addInputRules () {
    return [
      Le({ find: m0, type: this.type }),
      Le({ find: y0, type: this.type })
    ]
  },
  addPasteRules () {
    return [
      Ce({ find: g0, type: this.type }),
      Ce({ find: b0, type: this.type })
    ]
  }
})
const bu = x0
...
const k0 = Z.create({
  ...
  addInputRules () {
    return [Le({ find: w0, type: this.type })]
  },
  addPasteRules () {
    return [Ce({ find: S0, type: this.type })]
  }
})
const xu = k0
const C0 = /^```([a-z]+)?[\s\n]$/
...
`
              ...
              .map((f) => i + f).join(`
`)
            return (s.replaceWith(l, a, e.schema.text(u)), !0)
          })
      },
      'Shift-Tab': ({ editor: t }) => {
        if (!this.options.enableTabIndentation) return !1
...
`)
              ...
              return (
                i.delete(b, b + y),
                l - b <= y &&
                                    i.setSelection(R.create(i.doc, b)),
                !0
              )
            })
            : t.commands.command(({ tr: i }) => {
...
`)
              return (i.replaceWith(s, l, e.schema.text(d)), !0)
            })
      },
      Enter: ({ editor: t }) => {
...
const ku = (t, e) => {
  ...
  const d = Ye((y) => y.type === i.nodes.details)(s)
  if (!d) return !1
  const u = kn(d.node, (y) => y.type === i.nodes.detailsContent)
  if (!u.length || yo(d.start + u[0].pos + 1, t)) return !1
...
const Cu = H.create({
  ...
  addKeyboardShortcuts () {
    return {
      ...
      ArrowRight: ({ editor: t }) => ku(t, 'right'),
      ArrowDown: ({ editor: t }) => ku(t, 'down')
    }
  },
  addProseMirrorPlugins () {
    return [
  ...
  addKeyboardShortcuts () {
    return {
      Enter: ({ editor: t }) => {
        ...
        const k = er(y.contentMatchAt(b))
        if (!k || !y.canReplaceWith(b, b, k)) return !1
        const E = k.createAndFill()
        if (!E) return !1
        const { tr: S } = e
        const C = o.after(-2)
        S.replaceWith(C, C, E)
        const T = S.doc.resolve(C)
        const x = D.near(T, 1)
        S.setSelection(x)
        const N = m
        const v = m + p.nodeSize
        return (S.delete(N, v), S.scrollIntoView(), n.dispatch(S), !0)
      }
    }
  }
})
...
const A0 = H.create({ name: 'doc', topNode: !0, content: 'block+' })
const Tu = A0
const Au = H.create({
  name: 'grid',
  group: 'block',
...
const D0 = Z.create({
  ...
  addInputRules () {
    return [Le({ find: N0, type: this.type })]
  },
  addPasteRules () {
    return [Ce({ find: R0, type: this.type })]
  }
})
const Ru = D0
const P0 = H.create({
  ...
  addCommands () {
    return {
      setHorizontalRule:
                () =>
                  ({ chain: t, state: e }) => {
                    if (!ou(e, e.schema.nodes[this.name])) return !1
                    const { selection: n } = e
                    const { $to: r } = n
                    const o = t()
                    return (
...
const H0 = Z.create({
  ...
  addInputRules () {
    return [
      ...
      Le({ find: B0, type: this.type })
    ]
  },
  addPasteRules () {
    return [
      Ce({ find: L0, type: this.type }),
...
Me.prototype = {
  ...
  tr (t, e, n, r) {
    ...
    let o
    return (
      e && e.j ? (o = e) : ((o = new Me(e)), n && r && Qt(e, n, r)),
      this.jr.push([t, o]),
      o
    )
  },
    ...
    if (
      ...
      if (r) {
        if (s.t && typeof s.t === 'string') {
          const a = Object.assign(U0(s.t, r), n)
          Qt(i, a, r)
        } else n && Qt(i, n, r)
      }
      s.t = i
...
const zu = (t, e, n, r, o) => t.ts(e, n, r, o)
const M = (t, e, n, r, o) => t.tt(e, n, r, o)
const bt = 'WORD'
const gl = 'UWORD'
const ju = 'ASCIINUMERICAL'
const Ku = 'ALPHANUMERICAL'
const ur = 'LOCALHOST'
const yl = 'TLD'
const bl = 'UTLD'
const So = 'SCHEME'
...
function G0 (t = []) {
  ...
  M(n, '\\', Fo),
  M(n, '\u30FB', Uu))
  const r = te(n, yt, wl, { [fl]: !0 })
  te(r, yt, r)
  const o = te(r, gt, ju, { [ir]: !0 })
  const i = te(r, rr, Ku, { [or]: !0 })
  const s = te(n, gt, bt, { [hl]: !0 });
  (te(s, yt, o), te(s, gt, s), te(o, yt, o), te(o, gt, o))
  const l = te(n, rr, gl, { [pl]: !0 });
  (te(l, gt),
  te(l, yt, i),
  te(l, rr, l),
  te(i, yt, i),
  ...
  const c = M(n, Hu, xl, { [sl]: !0 })
  const d = te(n, al, xl, { [sl]: !0 });
  (M(n, dl, d),
  M(c, cl, a),
  M(c, dl, d),
  te(c, al, d),
  ...
  te(d, al, d),
  M(d, dl, d))
  const u = te(n, ll, Ju, { [Wu]: !0 });
  (M(u, '#'), te(u, ll, u), M(u, J0, u))
  const f = M(u, q0);
  (M(f, '#'), te(f, ll, u))
  const h = [
    [gt, s],
  ...
  Qt(Mn, { slashscheme: !0, ascii: !0 }, e),
  (t = t.sort((m, g) => (m[0] > g[0] ? 1 : -1))))
  for (let m = 0; m < t.length; m++) {
    const g = t[m][0]
    const b = t[m][1] ? { [W0]: !0 } : { [j0]: !0 };
    (g.indexOf('-') >= 0
      ? (b[ml] = !0)
      : gt.test(g)
        ? yt.test(g)
  ...
  return (
    zu(n, 'localhost', ur, { ascii: !0 }),
    (n.jd = new Me(qo)),
    { start: n, tokens: Object.assign({ groups: e }, qu) }
  )
}
function Gu (t, e) {
  const n = Y0(e.replace(/[A-Z]/g, (l) => l.toLowerCase()))
  const r = n.length
  const o = []
  let i = 0
  let s = 0
...
function Q0 ({ groups: t }) {
  ...
  ($(d, r, i), $(d, t.domain, i))
  const u = Be();
  ($(c, t.domain, u), $(u, t.domain, u))
  const f = M(u, et)
  $(f, t.domain, u)
  const h = Be(Vu);
  ($(f, t.tld, h), $(f, t.utld, h), M(c, ur, h))
  const p = M(u, ze);
  (M(p, ze, p),
  $(p, t.domain, u),
  $(h, t.domain, u),
  ...
  const S = Be(wo)
  const C = Be();
  ($(S, e, S), $(S, n, C), $(C, e, S), $(C, n, C), M(b, tt, S), M(E, tt, S))
  const T = M(l, Dt)
  const x = M(a, Dt)
  const N = M(x, tt)
  const v = M(N, tt);
  ...
  return (M(o, ur, b), M(o, Sl, X0), { start: o, tokens: qu })
}
function Z0 (t, e, n) {
  const r = n.length
  let o = 0
  ...
  return (s.length > 0 && i.push(ul(_u, e, s)), i)
}
function ul (t, e, n) {
  const r = n[0].s
...
const eb = (typeof console < 'u' && console && console.warn) || (() => {})
const tb =
...
function Al (t, e = !1) {
  if (
    (X.initialized &&
            eb(
                `linkifyjs: already initialized - will not register custom scheme "${t}" ${tb}`
            ),
...
function Yo (t) {
  return (
    X.initialized || nb(),
    Z0(X.parser.start, t, Gu(X.scanner.start, t))
  )
}
Yo.scan = Gu
...
const El = '[\0- \xA0\u1680\u180E\u2000-\u2029\u205F\u3000]'
const rb = new RegExp(El)
const ob = new RegExp(`${El}$`)
const ib = new RegExp(El, 'g')
function sb (t) {
  return t.length === 1
    ? t[0].isLink
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (
        (Us(l).forEach(({ newRange: c }) => {
          const d = Od(r.doc, c, (h) => h.isTextblock)
          let u
          let f
          if (d.length > 1) {
            ((u = d[0]),
          ...
          if (u && f) {
            const h = f.split(rb).filter(Boolean)
...
const Qu = db
const ub = Object.defineProperty
const fb = (t, e) => {
  for (const n in e) ub(t, n, { get: e[n], enumerable: !0 })
}
const hb = 'listItem'
const Zu = 'textStyle'
const ef = /^\s*([-+*])\s$/
const Rl = H.create({
  ...
  addInputRules () {
    let t = Xe({ find: ef, type: this.type })
    return (
...
var Ol = (t, e, n) => {
  ...
  if (!Ge(t.state, e) && rf(t.state, e, n)) {
  ...
  if (!Ge(t.state, e) || !Fd(t.state)) return !1
  const r = hr(e, t.state)
  if (!r) return !1
  const i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth)
  const s = sf(e, t.state, i)
  return of(e, t.state) && !s
...
var Nl = (t, e) => {
  if (!Ge(t.state, e) || !Hd(t.state, e)) return !1
  ...
  addExtensions () {
    ...
    return (
      ...
      this.options.listKeymap !== !1 &&
                t.push(gb.configure(this.options.listKeymap)),
      this.options.orderedList !== !1 &&
                t.push(Il.configure(this.options.orderedList)),
      this.options.taskItem !== !1 &&
                t.push(xb.configure(this.options.taskItem)),
      this.options.taskList !== !1 &&
                t.push(wb.configure(this.options.taskList)),
      t
    )
  }
})
  ...
  return new I({
    ...
    props: {
      handleDrop (d, u) {
        ...
        (Qo(d, 'form-processing-started', { message: a }),
        u.preventDefault(),
        u.stopPropagation())
...
const df = V.create({
  ...
  addProseMirrorPlugins () {
    return [Sb({ editor: this.editor, ...this.options })]
  }
})
function kb (t) {
  let e
  ...
  let E = k + g[0].length
  return (
    a && d.test(p.slice(E - 1, E + 1)) && ((g[0] += ' '), (E += 1)),
    k < l.pos && E >= l.pos
      ? {
          range: { from: k, to: E },
...
function Mb ({
  ...
  render: h = () => ({}),
  allow: p = () => !0,
  findSuggestionMatch: m = kb
}) {
  let g
  const y = h?.()
  const b = () => {
    const C = e.state.selection.$anchor.pos
    const T = e.view.coordsAtPos(C)
    const { top: x, right: N, bottom: v, left: F } = T
    try {
      return new DOMRect(F, x, N - F, v - x)
    } catch {
      return null
    }
  }
  const k = (C, T) =>
    T
      ? () => {
          const x = t.getState(e.state)
          const N = x?.decorationId
          const v = C.dom.querySelector(`[data-decoration-id="${N}"]`)
          return v?.getBoundingClientRect() || null
        }
      : b
  function E (C, T) {
    let x
    try {
      const v = t.getState(C.state)
      const F = v?.decorationId
        ? C.dom.querySelector(
                      `[data-decoration-id="${v.decorationId}"]`
        )
        : null
      const _ = {
        editor: e,
        range: v?.range || { from: 0, to: 0 },
        query: v?.query || null,
        text: v?.text || null,
        items: [],
        command: (G) =>
      ...
      (x = y?.onExit) == null || x.call(y, _)
    } catch {}
    const N = C.state.tr.setMeta(T, { exit: !0 })
    C.dispatch(N)
  }
  const S = new I({
    key: t,
    view () {
      return {
        update: async (C, T) => {
          let x, N, v, F, _, G, q
          const B = (x = this.key) == null ? void 0 : x.getState(T)
          const j =
                        (N = this.key) == null ? void 0 : N.getState(C.state)
          const W =
          ...
          ((g = {
            ...
            items: [],
            command: (Vh) =>
              u({ editor: e, range: on.range, props: Vh }),
            decorationNode: Zl,
            clientRect: k(C, Zl)
          }),
          On && ((v = y?.onBeforeStart) == null || v.call(y, g)),
    ...
    state: {
      ...
      apply (C, T, x, N) {
        ...
        if (((B.composing = F), v && (G || e.view.composing))) {
          (q < T.range.from || q > T.range.to) &&
                        !F &&
                        !T.composing &&
                        (B.active = !1)
          const W = m({
    ...
    props: {
      handleKeyDown (C, T) {
        let x, N, v, F
        const { active: _, range: G } = S.getState(C.state)
        if (!_) return !1
        if (T.key === 'Escape' || T.key === 'Esc') {
          const B = S.getState(C.state)
          const j = (x = g?.decorationNode) != null ? x : null
          const W =
                        j ??
                        (B?.decorationId
                          ? C.dom.querySelector(
          ...
          const Te = {
            ...
            items: [],
            command: (It) =>
              u({ editor: e, range: B.range, props: It }),
            decorationNode: W,
            clientRect: W
        ...
        return (
          ((F = y?.onKeyDown) == null
            ? void 0
            : F.call(y, { view: C, event: T, range: G })) || !1
        )
      },
      decorations (C) {
        const {
...
const ff = H.create({
  ...
  addProseMirrorPlugins () {
    return [
      ...this.storage.suggestions.map(uf),
      new I({
        props: {
          handleDrop (t, e) {
            if (
...
const Ob = Z.create({
  ...
  addInputRules () {
    return [Le({ find: Ab, type: this.type })]
  },
  addPasteRules () {
    return [Ce({ find: Eb, type: this.type })]
  }
})
const yf = Ob
const Nb = Z.create({
...
const J = class xt extends D {
  constructor (e, n = e) {
    ...
    const c = a.map((d) => {
      ...
      const f = i + d + 1
      return new fn(l.resolve(f), l.resolve(f + u.content.size))
    });
  ...
  replaceWith (e, n) {
    this.replace(e, new A(w.from(n), 0, 0))
  }
  ...
  getBookmark () {
    return new $b(this.$anchorCell.pos, this.$headCell.pos)
  }
}
...
function _l (t, e) {
  let n
  const r = (o, i) => {
    o.type.spec.tableRole == 'table' && (n = Ub(t, o, i, n))
  }
  return (
    e ? e.doc != t.doc && Df(e.doc, t.doc, 0, r) : t.doc.descendants(r),
    n
  )
}
function Ub (t, e, n, r) {
  ...
  return r.setMeta(Kb, { fixTables: !0 })
}
function nt (t) {
  const e = t.selection
  const n = oi(t)
...
function Pf (t, { map: e, tableStart: n, table: r }, o) {
  let i = o > 0 ? -1 : 0
  Fb(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0)
...
function zf (t, { map: e, tableStart: n, table: r }, o) {
  let i
  let s = n
  for (let c = 0; c < o; c++) s += r.child(c).nodeSize
  const l = []
  let a = o > 0 ? -1 : 0
  qb(e, r, o + a) && (a = o == 0 || o == e.height ? null : 0)
...
function Ff (t, e) {
  ...
  if (e) {
    const n = nt(t)
    e(zf(t.tr, n, n.bottom))
  }
  return !0
}
function Gb (t, { map: e, table: n, tableStart: r }, o) {
  let i = 0
...
function $f (t, e) {
  ...
  if (e) {
    ...
    for (let o = n.bottom - 1; Gb(r, n, o), o != n.top; o--) {
      const i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc
      if (!i) throw RangeError('No table found');
...
function Yb ({ width: t, height: e, map: n }, r) {
...
function jl (t, e) {
  const n = ye(t.schema)
  return Xb(({ node: r }) => n[r.type.spec.tableRole])(t, e)
}
function Xb (t) {
  return (e, n) => {
    let r
    ...
    if (o instanceof J) {
      ...
      if (((i = Bb(o.$from)), !i)) return !1
      s = (r = vn(o.$from)) == null ? void 0 : r.pos
    }
    if (
      i == null ||
            s == null ||
...
const uM = Tn('row', { useDeprecatedLogic: !0 })
const fM = Tn('column', { useDeprecatedLogic: !0 })
const _f = Tn('cell', { useDeprecatedLogic: !0 })
function Zb (t, e) {
  if (e < 0) {
...
function Kl (t) {
  return function (e, n) {
    ...
    if (n) {
      ...
      n(e.tr.setSelection(R.between(o, Hb(o))).scrollIntoView())
    }
    return !0
  }
}
...
function ex (t) {
  ...
  if (i == 'row') {
    for (let a = 0; a < e.childCount; a++) {
      ...
      ((d || u) && (c = Fl(ye(s).row, new A(c, d, u)).content),
      l.push(c))
    }
...
function nx ({ width: t, height: e, rows: n }, r, o) {
  if (t != r) {
    const i = []
    const s = []
      ...
      for (let d = i[l] || 0, u = 0; d < r; u++) {
        ...
        (d + f.attrs.colspan > r &&
                    (f = f.type.createChecked(
                      en(f.attrs, f.attrs.colspan, d + f.attrs.colspan - r),
                      f.content
                    )),
        c.push(f),
        (d += f.attrs.colspan))
...
function rx (t, e, n, r, o, i, s) {
  ...
  if (i > e.height) {
    ...
    const f = a.row.create(null, w.from(u))
    const h = []
...
function Mf (t, e, n, r, o) {
  ...
  (rx(u, s, i, n, c, d, f) && h(),
  kf(u, s, i, n, a, c, l, f) && h(),
  kf(u, s, i, n, a, c, d, f) && h(),
  Cf(u, s, i, n, l, d, a, f) && h(),
  Cf(u, s, i, n, l, d, c, f) && h())
  for (let p = l; p < d; p++) {
...
function ti (t, e) {
  return (n, r, o) => {
    ...
    const l = Of(s.$headCell, t, e)
    return l ? ni(n, r, new J(s.$anchorCell, l)) : !1
  }
}
function ix (t, e) {
  const n = t.state.doc
  const r = vn(n.resolve(e))
  ...
  if (o instanceof J) {
    r ||
            (r = {
              width: 1,
              height: 1,
              rows: [w.from(Fl(ye(t.state.schema).cell, n))]
            })
    ...
    return (
      (r = nx(r, l.right - l.left, l.bottom - l.top)),
      Mf(t.state, t.dispatch, s, l, r),
      !0
    )
  } else if (r) {
    const i = oi(t.state)
...
function lx (t, e) {
  ...
  if (e.shiftKey && t.state.selection instanceof J) {
    ...
    e.shiftKey &&
        r &&
        (o = vn(t.state.selection.$anchor)) != null &&
  ...
  function i (a, c) {
    let d = Ll(t, c)
    const u = Pt.getState(t.state) == null
    if (!d || !Vl(a, d)) {
      if (u) d = a
      else return
    }
    ...
    if (u || !t.state.selection.eq(f)) {
      ...
      (u && h.setMeta(Pt, a.pos), t.dispatch(h))
    }
  }
  function s () {
  ...
  function l (a) {
    const c = a
    const d = Pt.getState(t.state)
    let u
    if (d != null) u = t.state.doc.resolve(d)
    else if (vf(t, c.target) != r && ((u = Ll(t, e)), !u)) return s()
    u && i(u, c)
  }
...
function Ll (t, e) {
  ...
  return n && n ? vn(t.state.doc.resolve(n.pos)) : null
}
const ax = class {
  constructor (t, e) {
    ((this.node = t),
...
function Kf ({
  ...
  const i = new I({
    ...
    props: {
      ...
      decorations: (s) => {
        const l = Ee.getState(s)
        if (l && l.activeHandle > -1) return yx(s, l.activeHandle)
      },
      nodeViews: {}
    }
  })
...
function dx (t, e, n, r) {
  ...
  if (o && !o.dragging) {
    ...
    if (i) {
      ...
      e.clientX - l <= n
        ? (s = Tf(t, e, 'left', n))
        : a - e.clientX <= n && (s = Tf(t, e, 'right', n))
    }
    if (s != o.activeHandle) {
      if (!r && s !== -1) {
...
function ux (t) {
  ...
  e && e.activeHandle > -1 && !e.dragging && Uf(t, -1)
}
function fx (t, e, n, r) {
  let o
  ...
  const a = hx(t, s.activeHandle, l.attrs)
  t.dispatch(
  ...
  function c (u) {
    ...
    f?.dragging &&
            (mx(t, f.activeHandle, Af(f.dragging, u, n)),
  ...
  function d (u) {
    ...
    const f = Ee.getState(t.state)
    if (f && f.dragging) {
      const h = Af(f.dragging, u, n)
      Ef(t, f.activeHandle, h, r)
    }
  }
  return (
    Ef(t, s.activeHandle, a, r),
...
function hx (t, e, { colspan: n, colwidth: r }) {
...
function Tf (t, e, n, r) {
  ...
  if (!i) return -1
  const { pos: s } = i
  const l = vn(t.state.doc.resolve(s))
  if (!l) return -1
...
function mx (t, e, n) {
  ...
  for (let c = 0; c < i.height; c++) {
    ...
    const p = f.colwidth ? f.colwidth.slice() : gx(f.colspan);
...
function Jf ({ allowTableNodeSelection: t = !1 } = {}) {
  return new I({
    ...
    props: {
      decorations: Vb,
      handleDOMEvents: { mousedown: lx },
      createSelectionBetween (e) {
        return Pt.getState(e.state) != null ? e.state.selection : null
      },
      handleTripleClick: ix,
      handleKeyDown: ox,
      handlePaste: sx
    },
    appendTransaction (e, n, r) {
      return jb(r, _l(r, n), t)
    }
  })
}
const bx = H.create({
    ...
    for (let u = 0, f = 0; u < d.childCount; u += 1) {
      ...
      for (let m = 0; m < h; m += 1, f += 1) {
        ...
        if (((l += g || r), g || (a = !1), c)) {
          ...
          const b = document.createElement('col')
          const [k, E] = Ul(r, g);
          (b.style.setProperty(k, E), e.appendChild(b))
        }
      }
    }
  }
...
const Sx = class {
  constructor (t, e) {
    ...
    qf(t, this.colgroup, this.table, e),
    (this.contentDOM = this.table.appendChild(
      document.createElement('tbody')
    )))
  }
  ...
  update (t) {
    return t.type !== this.node.type
      ? !1
      : ((this.node = t),
        qf(t, this.colgroup, this.table, this.cellMinWidth),
        !0)
  }
...
const Tx = H.create({
  ...
  renderHTML ({ node: t, HTMLAttributes: e }) {
    const {
      ...
      tableWidth: r,
      tableMinWidth: o
    } = kx(t, this.options.cellMinWidth)
    return [
      'table',
      O(this.options.HTMLAttributes, e, {
  ...
  addExtensions () {
    ...
    return (
      this.options.table !== !1 &&
                t.push(Tx.configure(this.options.table)),
      this.options.tableCell !== !1 &&
                t.push(bx.configure(this.options.tableCell)),
      this.options.tableHeader !== !1 &&
                t.push(xx.configure(this.options.tableHeader)),
      this.options.tableRow !== !1 &&
                t.push(wx.configure(this.options.tableRow)),
      t
    )
  }
})
const Ax = H.create({ name: 'text', group: 'inline' })
const Xf = Ax
const Ex = V.create({
  name: 'textAlign',
  addOptions () {
...
const gr = Math.round
const We = (t) => ({ x: t, y: t })
const Nx = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' }
...
const Dx = new Set(['top', 'bottom'])
function je (t) {
  return Dx.has(Oe(t)) ? 'y' : 'x'
}
function ai (t) {
  return Gl(je(t))
}
...
function pr (t) {
  return t.replace(/start|end/g, (e) => Rx[e])
}
const th = ['left', 'right']
const nh = ['right', 'left']
const Px = ['top', 'bottom']
...
function mr (t) {
  return t.replace(/left|right|bottom|top/g, (e) => Nx[e])
}
function Bx (t) {
...
async function tn (t, e) {
  ...
  const E = (await (i.isElement == null ? void 0 : i.isElement(k)))
  ...
  return {
    top: (y.top - S.top + p.top) / E.y,
    bottom: (S.bottom - y.bottom + p.bottom) / E.y,
    left: (y.left - S.left + p.left) / E.x,
    right: (S.right - y.right + p.right) / E.x
  }
}
const ch = (t) => ({
  name: 'arrow',
  ...
  async fn (e) {
    ...
    const S = f[h] - i.reference[h]
    const C = await (s.getOffsetParent == null
      ? void 0
      : s.getOffsetParent(c))
    let T = C ? C[k] : 0;
    (!T || !(await (s.isElement == null ? void 0 : s.isElement(C)))) &&
            (T = l.floating[k] || i.floating[p])
    const x = E / 2 - S / 2
    const N = T / 2 - m[p] / 2 - 1
    const v = He(u[y], N)
    const F = He(u[b], N)
    ...
    const j =
            ...
            Fe(o) != null &&
            q !== B &&
            i.reference[p] / 2 - (q < _ ? v : F) - m[p] / 2 < 0
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const m = u !== void 0 || f === ql ? zx(u || null, h, f) : f
        ...
        const T = S.map((v) => {
          const F = Fe(v.placement)
          return [
            v.placement,
            F && d
              ? v.overflows.slice(0, 2).reduce((_, G) => _ + G, 0)
              : v.overflows[0],
            v.overflows
          ]
        }).sort((v, F) => v[1] - F[1])
        const N =
                    ((o = T.filter((v) =>
                      v[2].slice(0, Fe(v[0]) ? 2 : 3).every((F) => F <= 0)
                    )[0]) == null
                      ? void 0
                      : o[0]) || T[0][0]
        return N !== l
    ...
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const E = await (a.isRTL == null
          ? void 0
          : a.isRTL(c.floating))
        const S = f || (k || !m ? [mr(l)] : rh(l))
        const C = p !== 'none'
        !f && C && S.push(...oh(l, m, p, E))
        const T = [l, ...S]
        const x = await tn(e, g)
        const N = []
      ...
      async fn (e) {
        ...
        switch (r) {
          case 'referenceHidden': {
            ...
            const s = sh(i, n.reference)
            return {
              data: {
                referenceHiddenOffsets: s,
                referenceHidden: lh(s)
              }
            }
          }
          case 'escaped': {
            const i = await tn(e, { ...o, altBoundary: !0 })
            const s = sh(i, n.floating)
            return { data: { escapedOffsets: s, escaped: lh(s) } }
          }
          default:
            return {}
        }
        ...
        function p () {
          ...
          if (u.length >= 2) {
            if (je(n) === 'y') {
              ...
              const G = v.top
              const q = F.bottom
              const B = _ ? v.left : F.left
              const j = _ ? v.right : F.right
              const W = j - B
              const ie = q - G
              return {
                top: G,
            ...
            const g = Oe(n) === 'left'
            const y = fe(...u.map((v) => v.right))
            const b = He(...u.map((v) => v.left))
            const k = u.filter((v) =>
              g ? v.left === b : v.right === y
            )
            const E = k[0].top
            const S = k[k.length - 1].bottom
            const C = b
            const T = y
            const x = T - C
            const N = S - E
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const E = He(m - d[g], b)
        const S = He(p - d[y], k)
        const C = !e.middlewareData.shift
        let T = E
        let x = S
        if (
          ...
          const v = fe(d.left, 0)
          const F = fe(d.right, 0)
          const _ = fe(d.top, 0)
          const G = fe(d.bottom, 0)
          h
            ? (x =
                              p -
                              2 *
        ...
        await a({ ...e, availableWidth: x, availableHeight: T })
...
function nn (t) {
  return xh(t) ? (t.nodeName || '').toLowerCase() : '#document'
}
function ve (t) {
  let e
  return (
...
function ot (t) {
  let e
  return (e = (xh(t) ? t.ownerDocument : t.document) || window.document) ==
        null
    ? void 0
    : e.documentElement
}
...
const Vx = new Set(['inline', 'contents'])
function An (t) {
  const { overflow: e, overflowX: n, overflowY: r, display: o } = Ve(t)
  return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !Vx.has(o)
}
const _x = new Set(['table', 'td', 'th'])
function wh (t) {
  return _x.has(nn(t))
}
...
const Ux = ['paint', 'layout', 'strict', 'content']
function fi (t) {
  const e = hi()
  const n = $e(t) ? Ve(t) : t
  return (
    jx.some((r) => (n[r] ? n[r] !== 'none' : !1)) ||
        ...
        Ux.some((r) => (n.contain || '').includes(r))
  )
}
function Sh (t) {
  let e = St(t)
...
function St (t) {
  ...
  const e = t.assignedSlot || t.parentNode || (bh(t) && t.host) || ot(t)
...
function xr (t, e, n, r) {
  ...
  return wt({ width: d, height: u, x: a, y: c })
}
function mi (t, e) {
...
const ew = new Set(['absolute', 'fixed'])
function tw (t, e) {
...
function Mh (t, e, n) {
  let r
  if (e === 'viewport') r = Zx(t, n)
  else if (e === 'document') r = Qx(ot(t))
  else if ($e(e)) r = tw(e, n)
  else {
    const o = Eh(t)
...
function Nh (t, e) {
  ...
  return n === e || !$e(n) || rn(n)
    ? !1
    : Ve(n).position === 'fixed' || Nh(n, e)
}
function nw (t, e) {
  const n = e.get(t)
  if (n) return n
  let r = di(t, [], !1).filter((l) => $e(l) && nn(l) !== 'body')
  let o = null
...
function Rh (t, e) {
  ...
  let r = vh(t, e)
  for (; r && wh(r) && Xl(r);) r = vh(r, e)
  return r && rn(r) && Xl(r) && !fi(r) ? n : r || Sh(t) || n
}
const sw = async function (t) {
  const e = this.getOffsetParent || Rh
...
const bi = (t, e, n) => {
  const r = new Map()
  const o = { platform: aw, ...n }
  const i = { ...o.platform, _c: r }
  return ah(t, e, { ...o, platform: i })
}
const Hh = (t, e) => {
  bi(
    {
...
const Fh = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
  items: ({ query: n }) =>
    Object.entries(t)
      .filter(
        ([r, o]) =>
  ...
  render: () => {
    ...
    return {
      onStart: (u) => {
        ...
        u.clientRect && Hh(u.editor, n))
      },
      onUpdate: (u) => {
        ((o = u), (r = 0), s(), u.clientRect && Hh(u.editor, n))
      },
      onKeyDown: (u) =>
        u.event.key === 'Escape'
...
const $h = async ({
  ...
  mergeTags: d,
  noMergeTagSearchResultsMessage: u,
  placeholder: f,
  statePath: h,
  textColors: p,
  ...
  Du,
  Pu,
  Lu.configure({ inline: !0 }),
  Bu,
  Qu.configure({ autolink: !0, openOnClick: !1 }),
  Dl,
  df.configure({
    acceptedTypes: t,
  ...
  Il,
  hf,
  pf.configure({ placeholder: f }),
  gf.configure({ textColors: p }),
  mf,
  yf,
  bf,
  xf,
  Yf.configure({ table: { resizable: !0 } }),
  Xf,
  Qf.configure({
  ...
  ...(
    await Promise.all(
      n.map(
        async (y) => (
          new RegExp('^(?:[a-z+]+:)?//', 'i').test(y) ||
                        (y = new URL(y, document.baseURI).href),
          (await import(y)).default
        )
      )
    )
  ).flat()
...
const dw = class {
  constructor ({
    ...
    (this.shouldShow = ({ view: d, state: u, from: f, to: h }) => {
      ...
      const { empty: g } = m
      const y = !p.textBetween(f, h).length && ao(u.selection)
  ...
  get middlewares () {
    ...
    return (
      ...
      this.floatingUIOptions.arrow &&
                t.push(Bh(this.floatingUIOptions.arrow)),
  ...
  get virtualElement () {
    ...
    const n =
            (t = this.getReferencedVirtualElement) == null
              ...
              : t.call(this)
    if (n) return n
    const r = $d(this.view, e.from, e.to)
    let o = {
    ...
    if (e instanceof J) {
      ...
      const u =
                c === d
                  ...
                  : cw(c.getBoundingClientRect(), d.getBoundingClientRect())
      o = {
...
function uw ({
  ...
  return {
    ...
    async init () {
      ((C = new ru({
        ...
        extensions: await $h({
          ...
          insertCustomBlockUsing: (x, N = null) =>
            this.$wire.mountAction(
              'customBlock',
              { id: x, dragPosition: N, mode: 'insert' },
              { schemaComponent: s }
            ),
          key: s,
          maxFileSize: f,
      ...
      Object.keys(S).forEach((x) => {
        const N = this.$refs[`floatingToolbar::${x}`]
        if (!N) {
      ...
      const T = Alpine.debounce(() => this.$wire.commit(), d ?? 300);
      (C.on('update', ({ editor: x }) =>
        this.$nextTick(() => {
          ((this.editorUpdatedAt = Date.now()),
        ...
        (x) => {
          x.detail.livewireId === u &&
                            ...
                            (this.fileValidationMessage =
                                x.detail.validationMessage),
                            x.stopPropagation())
        }
      ),
      window.dispatchEvent(
        new CustomEvent(`schema-component-${u}-${s}-loaded`)
      ))
    },
    getEditor () {
      return C
    ...
    setEditorSelection (T) {
      T &&
                ((this.editorSelection = T),
                C.chain()
                  .command(
                    ({ tr: x }) => (
                      x.setSelection(
                        D.fromJSON(C.state.doc, this.editorSelection)
                      ),
                      !0
                    )
                  )
    ...
    runEditorCommands ({ commands: T, editorSelection: x }) {
      this.setEditorSelection(x)
      let N = C.chain();
      (T.forEach((v) => (N = N[v.name](...(v.arguments ?? [])))),
      N.run())
    },
    togglePanel (T = null) {
      if (this.isPanelActive(T)) {
        this.activePanel = null
        return
      }
      this.activePanel = T
    },
    isPanelActive (T = null) {
      return T === null
        ? this.activePanel !== null
        : this.activePanel === T
    },

  ...
  if (b) {
    if (m.pos == g.pos) {
      ke &&
                ...
                setTimeout(() => ft(t), 20))
      const v = R(t.state.tr.delete(k, S))
      ...
      const B = () => R(t.state.tr.insertText(v, k, S))
    ...
    (u) =>
      new N({
        ...
        appendTransaction: (d, f, h) => {
          ...
          const k = f.doc.content.findDiffEnd(h.doc.content)
          if (!(!Og(x) || !k || x === k.b)) {
            return a({
              rule: u,
              state: h,
    ...
    (t, e = {}) =>
      ({ tr: n, state: r, dispatch: o, editor: i }) => {
        ...
        if (o) {
          ...
          const k = b || (y.$to.parentOffset && y.$from.marks())
          if ((n.split(a.pos, 2, g).scrollIntoView(), !k || !o)) {
            return !0
          }
          const S = k.filter((R) => x.includes(R.type.name))
          n.ensureMarks(S)
        }
        return !0
      }
...
var Iy =
    (t, e, n, r = {}) =>
      ({
        ...
        const k = g || (m.$to.parentOffset && m.$from.marks())
        if (!x) return !1
        ...
        return !n || !k || !l
          ...
          : a()
            .command(() => {
              ...
              const P = k.filter((v) => f.includes(v.type.name))
...
const C = (t, e, n, r, o) => t.tt(e, n, r, o)
const bt = 'WORD'
const hl = 'UWORD'
...
function j0 (t = []) {
  ...
  const a = C(n, sl, bl, { [rl]: !0 })
  const c = C(n, Ld, gl, { [rl]: !0 })
  ...
  const b = new N({
    ...
    view () {
      return {
        update: async (x, k) => {
          let S, R, P, v, B, D, _
          const H = (S = this.key) == null ? void 0 : S.getState(k)
          const j =
...
async function en (t, e) {
  ...
  const k = (await (i.isElement == null ? void 0 : i.isElement(x)))
...
const ih = (t) => ({
  ...
  async fn (e) {
    ...
    const k = i.reference[p] + i.reference[h] - f[h] - i.floating[p]
...
function br (t, e, n, r) {
  ...
  if (i) {
    ...
    for (; m && r && h !== p;) {
      ...
      const k = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
      ((a *= g.x),
      (c *= g.y),
      (u *= g.x),
      (d *= g.y),
  ...
  return {
    ...
    async init () {
      ...
      Object.keys(g).forEach((x) => {
        const k = this.$refs[`floatingToolbar::${x}`]
        if (!k) {
      ...
      const b = Alpine.debounce(() => this.$wire.commit(), a ?? 300);

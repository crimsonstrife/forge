...
function Sr(t, e) {
    return ((xi.index = t), (xi.offset = e), xi);
}
function Cr(t, e) {
    if (t === e) return !0;
...
function ha(t, e, n, r) {
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            ...
            const { start: s, end: l } = Fh(n, t);
            return Lt(i, ma(t, s, l, e, r));
        }
    } else return Lt(i, Mr(t, e, r));
}
function pa(t, e) {
...
function ma(t, e, n, r, o) {
    const i = t.depth > o && Si(t, e, o + 1);
    const s = r.depth > o && Si(n, r, o + 1);
    const l = [];
    return (
        Nn(null, t, o, l),
        i && s && e.index(o) == n.index(o)
            ? (pa(i, s), It(Lt(i, ma(t, e, n, r, o + 1)), l))
            : (i && It(Lt(i, Mr(t, e, o + 1)), l),
              Nn(e, n, o, l),
              s && It(Lt(s, Mr(n, r, o + 1)), l)),
        Nn(r, null, o, l),
        new w(l)
    );
}
...
const vr = class t {
    ...
    static resolveCached(e, n) {
        ...
        } else ea.set(e, (r = new ki()));
        const o = (r.elts[r.i] = t.resolve(e, n));
        return ((r.i = (r.i + 1) % $h), o);
    }
};
var ki = class {
    constructor() {
...
const le = class t {
    ...
    hasMarkup(e, n, r) {
        return (
            this.type == e &&
            Cr(this.attrs, n || e.defaultAttrs || Vh) &&
    ...
    replace(e, n, r) {
        return Hh(this.resolve(e), this.resolve(n), r);
    }
...
function qh(t) {
    ...
    function n(r) {
        ...
        const i = (e[r.join(",")] = new Ht(r.indexOf(t.length - 1) > -1));
...
function ka(t, e) {
    const n = Object.create(null);
    if (e) for (const r in e) n[r] = new vi(t, r, e[r]);
    return n;
}
const Tr = class t {
    constructor(e, n, r) {
...
const sn = class {
    constructor(e) {
        ...
        ((n.nodes = bi.from(e.nodes)),
            (n.marks = bi.from(e.marks || {})),
        ...
        for (const o in this.nodes) {
            ...
            if (
                ((i.contentMatch = r[s] || (r[s] = Ht.parse(s, this.nodes))),
    ...
    text(e, n) {
        ...
        return new Ci(r, r.defaultAttrs, e, V.setFrom(n));
    }
    ...
    constructor(e, n, r) {
        ...
        (o
            ...
            : r
              ...
              : (i = new on(e.schema.topNodeType, null, V.none, !0, null, s)),
            (this.nodes = [i]),
...
`,
    ...
    addElement(e, n, r) {
        ...
        let l;
        Ma.hasOwnProperty(s) && this.parser.normalizeLists && ep(e);
        const a =
            (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
            (l = this.parser.matchTag(e, this, r));
        e: if (a ? a.ignore : Zh.hasOwnProperty(s)) {
...
const it = class t {
    ...
    serializeMark(e, n, r = {}) {
        ...
        return o && kr(wi(r), o(e, n), null, e.attrs);
    }
...
function np(t) {
    let e = aa.get(t);
    return (e === void 0 && aa.set(t, (e = rp(t))), e);
}
function rp(t) {
    let e = null;
    function n(r) {
    ...
    _map(e, n, r) {
        ...
        for (let l = 0; l < this.ranges.length; l += 3) {
            ...
            if (e <= d) {
                ...
                const h = a + o + (f < 0 ? 0 : u);
                if (r) return h;
                const p = e == (n < 0 ? a : d) ? null : op(l / 3, e - a);
...
const ae = class {
    ...
    static fromJSON(e, n) {
        ...
        const r = Ai[n.stepType];
        if (!r) throw new RangeError(`No step type ${n.stepType} defined`);
        return r.fromJSON(e, n);
    }

    static jsonID(e, n) {
        if (e in Ai) throw new RangeError("Duplicate use of step JSON ID " + e);
        return ((Ai[e] = n), (n.prototype.jsonID = e), n);
    }
};
const ce = class t {
    constructor(e, n) {
...
function Di(t, e, n) {
    ...
    for (let o = 0; o < t.childCount; o++) {
        let i = t.child(o);
        (i.content.size && (i = i.copy(Di(i.content, e, i))),
...
var lt = class t extends ae {
    ...
    apply(e) {
        const n = e.slice(this.from, this.to);
        const r = new M(
            Di(n.content, (o) => o.mark(this.mark.removeFromSet(o.marks)), e),
            n.openStart,
            n.openEnd,
        );
...
const pe = class t extends ae {
    ...
    apply(e) {
        return this.structure && Ni(e, this.from, this.to)
...
const ne = class t extends ae {
    ...
    apply(e) {
        if (
            this.structure &&
            (Ni(e, this.from, this.gapFrom) || Ni(e, this.gapTo, this.to))
        ) {
...
function Pi(t, e, n, r = n.contentMatch, o = !0) {
...
function at(t) {
    ...
    for (let r = t.depth; ; --r) {
        ...
        if (r == 0 || o.type.spec.isolating || !ap(o, i, s)) break;
    }
    return null;
}
function cp(t, e, n) {
...
function hp(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (
            s.isTextblock &&
            !s.hasMarkup(r, a) &&
            pp(t.doc, t.mapping.slice(i).map(l), r)
        ) {
            let c = null;
            ...
            (c === !1 && Pa(t, s, l, i),
                Pi(t, t.mapping.slice(i).map(l, 1), r, void 0, c === null));
...
function bp(t, e, n) {
    ...
    s.inlineContent &&
        Pi(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
...
function $n(t, e, n = e, r = M.empty) {
    if (e == n && !r.size) return null;
    const o = t.resolve(e);
    const i = t.resolve(n);
    return La(o, i, r) ? new pe(e, n, r) : new Ri(o, i, r).fit();
}
function La(t, e, n) {
    return (
        !n.openStart &&
...
var Ri = class {
    ...
    findFittable() {
        ...
        for (let n = 1; n <= 2; n++) {
            for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
                ...
                let i = null;
                r
                    ? ((i = Ei(this.unplaced.content, r - 1).firstChild),
                      (o = i.content))
    ...
    dropNode() {
        ...
        if (o.childCount <= 1 && n > 0) {
            ...
            this.unplaced = new M(In(e, n - 1, 1), n - 1, i ? n - 1 : r);
        } else this.unplaced = new M(In(e, n, 1), n, r);
    }
    ...
    placeNodes({
        ...
        (p || (h = -1),
            (this.placed = Ln(this.placed, n, w.from(u))),
        ...
        this.unplaced = p
            ...
            : new M(In(s.content, e, c), s.openStart, s.openEnd);
    }
    ...
    mustMoveInline() {
        ...
        if (
            !e.type.isTextblock ||
            !Oi(this.$to, this.$to.depth, e.type, e.match, !1) ||
    ...
    findCloseLevel(e) {
        e: for (let n = Math.min(this.depth, e.depth); n >= 0; n--) {
            ...
            const s = Oi(e, n, o, r, i);
            if (s) {
                for (let l = n - 1; l >= 0; l--) {
                    const { match: a, type: c } = this.frontier[l];
                    const u = Oi(e, l, c, a, !0);
...
function Oi(t, e, n, r, o) {
    ...
    return l && !wp(n, i.content, s) ? l : null;
}
function wp(t, e, n) {
            ...
            for (let m = 0; m < s.length; m++) {
                ...
                if (b.canReplaceWith(x, x, p.type, p.marks)) {
                    return t.replace(
                        o.before(g),
                        y ? i.after(g) : n,
                        new M(za(r.content, 0, r.openStart, h), h, r.openEnd),
                    );
                }
            }
        }
...
const kt = class {
    ...
    setBlockType(e, n = e, r, o = null) {
        return (hp(this, e, n, r, o), this);
    }

    setNodeMarkup(e, n, r = null, o) {
        return (mp(this, e, n, r, o), this);
    }
...
var A = class t extends E {
    ...
    static between(e, n, r) {
        ...
        if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
            const i = E.findFrom(n, r, !0) || E.findFrom(n, -r, !0);
            if (i) n = i.$head;
...
const zi = class extends kt {
    ...
    setSelection(e) {
        ...
        return (
            (this.curSelection = e),
            (this.curSelectionFor = this.steps.length),
            (this.updated = (this.updated | Wa) & ~Dr),
    ...
    ensureMarks(e) {
        return (
            V.sameSet(this.storedMarks || this.selection.$from.marks(), e) ||
            ...
            n &&
                n.forEach((r) => {
                    ...
                    (this.plugins.push(r),
                        ...
                        r.spec.state &&
                            this.fields.push(new $t(r.key, r.spec.state, r)));
                }));
    }
};
const Ir = class t {
...
function Ua(t) {
    return t in Li ? t + "$" + ++Li[t] : ((Li[t] = 0), t + "$");
}
const L = class {
    constructor(e = "key") {
        this.key = Ua(e);
...
const ut = function (t, e, n) {
    const r = _i || (_i = document.createRange());
...
const Ep = /^(img|br|input|textarea|hr)$/i;
...
const ji = /Edge\/(\d+)/.exec(Et);
const Tc = /MSIE \d/.exec(Et);
const Ki = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Et);
const ke = !!(Tc || Ki || ji);
const Tt = Tc ? document.documentMode : Ki ? +Ki[1] : ji ? +ji[1] : 0;
const Ve = !ke && /gecko\/(\d+)/i.test(Et);
Ve && +(/Firefox\/(\d+)/.exec(Et) || [0, 0])[1];
const Ui = !ke && /Chrome\/(\d+)/.exec(Et);
const ge = !!Ui;
const Ac = Ui ? +Ui[1] : 0;
const xe = !ke && !!Je && /Apple Computer/.test(Je.vendor);
const yn = xe && (/Mobile\/\w+/.test(Et) || (!!Je && Je.maxTouchPoints > 2));
const Re = yn || (Je ? /Mac/.test(Je.platform) : !1);
const Ip = Je ? /Win/.test(Je.platform) : !1;
...
function Kp(t, e) {
    ...
    if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
        ...
        if (!as(e, c) || ((s = Rc(t.dom, e, c)), !s)) return null;
    }
...
function Dc(t, e, n) {
    ...
    if (r.nodeType == 3) {
        if (
            s &&
            (Up.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))
        ) {
            ...
            if (
                ...
                if (c.top == a.top) {
                    ...
                    if (u.top != a.top) return Wn(u, u.left < c.left);
                }
            }
            return a;
        } else {
    ...
    if (!t.state.doc.resolve(e - (i || 0)).parent.inlineContent) {
        if (i == null && o && (n < 0 || o == De(r))) {
            ...
            if (a.nodeType == 1) return Hi(a.getBoundingClientRect(), !1);
        }
        if (i == null && o < De(r)) {
            const a = r.childNodes[o];
            if (a.nodeType == 1) return Hi(a.getBoundingClientRect(), !0);
        }
        return Hi(r.getBoundingClientRect(), n >= 0);
    }
    if (i == null && o && (n < 0 || o == De(r))) {
        const a = r.childNodes[o - 1];
        const c =
        ...
        const c = a
            ? a.nodeType == 3
                ...
                : a.nodeType == 1
                  ...
                  : null
            : null;
        if (c) return Wn(Ct(c, -1), !0);
    }
    return Wn(Ct(r.nodeType == 3 ? ut(r) : r, -n), n >= 0);
}
function Wn(t, e) {
...
function Yp(t, e, n) {
    return Xa == e && Qa == n
        ...
        : ((Xa = e),
          (Qa = n),
          (Za = n == "up" || n == "down" ? Jp(t, e, n) : Gp(t, e, n)));
}
const Pe = 0;
const ec = 1;
const Wt = 2;
...
const bn = class t extends qt {
    ...
    slice(e, n, r) {
        ...
        let i = this.children;
        const s = this.size;
        (n < s && (i = Xi(i, n, s, r)), e > 0 && (i = Xi(i, 0, e, r)));
...
const At = class t extends qt {
    ...
    static create(e, n, r, o, i, s) {
        ...
        return (
            (u = Bc(u, r, n)),
            c
                ? (a = new qi(e, n, r, o, u, d || null, f, c, i, s + 1))
                : n.isText
    ...
    updateChildren(e, n) {
        ...
        const l = i && i.pos < 0;
        const a = new Yi(this, s && s.node, e);
        (em(
            this.node,
            this.innerDeco,
            (c, u, d) => {
    ...
    localCompositionInfo(e, n) {
        ...
        if (this.node.inlineContent) {
            const s = i.nodeValue;
            const l = nm(this.node.content, s, r - n, o - n);
    ...
    protectLocalComposition(e, { node: n, pos: r, text: o }) {
        ...
        const s = new Ji(this, i, n, o);
        (e.input.compositionNodes.push(s),
            (this.children = Xi(this.children, r, r + o.length, e, s)));
    }
...
_n.prototype = Object.create(null);
const _t = [new _n()];
function Gi(t, e, n) {
    ...
    for (let i = 0; i < t.length; i++) {
        ...
        if (s) {
            s.nodeName && o.push((r = new _n(s.nodeName)));
            for (const l in s) {
                const a = s[l];
                a != null &&
                    (n &&
                        o.length == 1 &&
                        o.push((r = new _n(e.isInline ? "span" : "div"))),
                    l == "class"
...
function Bc(t, e, n) {
    return Lc(t, t, _t, Gi(e, n, t.nodeType != 1));
}
function Hr(t, e) {
    if (t.length != e.length) return !1;
...
var Yi = class {
    constructor(e, n, r) {
        ((this.lock = n),
            ...
            (this.changed = !1),
            (this.top = e),
            (this.preMatch = Qp(e.node.content, e)));
    }
    ...
    syncToMarks(e, n, r) {
        ...
        for (; i < e.length; ) {
            ...
            if (l > -1) {
                ...
                const a = bn.create(this.top, e[i], n, r);
...
function cs(t, e = null) {
    ...
    if (Kr(n)) {
        ...
        if (
            ...
            O.isSelectable(d) &&
            o.parent &&
            !(d.isInline && Rp(n.focusNode, n.focusOffset, o.dom))
        ) {
            const f = o.posBefore;
...
function ft(t, e = !1) {
    ...
    if ((Hc(t, n), !!zc(t))) {
        ...
        if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) om(t);
        else {
            ...
            (rc &&
                ...
                n.visible
                    ...
                    : (t.dom.classList.add("ProseMirror-hideselection"),
                      "onselectionchange" in document && rm(t)));
        }
...
function oc(t, e) {
    ...
    if (xe && o && o.contentEditable == "false") return Fi(o);
    if (
...
function Zi(t, e, n) {
    if (e.nodeType != 3) {
        ...
        (s = am(e, n))
            ? ((e = s), (n = 0))
            : (i = cm(e, n)) && ((e = i), (n = i.nodeValue.length));
    }
...
function cc(t, e) {
    ...
    if (!(ge || Ip) && n.parent.inlineContent) {
...
function uc(t, e, n) {
    ...
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? "up" : "down")) {
        const s = Qi(t.state, e);
        if (s && s instanceof O) return Mt(t, s);
    }
    if (!o.parent.inlineContent) {
        const s = e < 0 ? o : i;
        const l = r instanceof be ? E.near(s, e) : E.findFrom(s, e);
        return l ? Mt(t, l) : !1;
    }
    return !1;
}
...
function fm(t, e) {
    const n = e.keyCode;
    const r = dm(e);
    if (n == 8 || (Re && n == 72 && r == "c")) return dc(t, -1) || hn(t, -1);
    if ((n == 46 && !e.shiftKey) || (Re && n == 68 && r == "c")) {
        return dc(t, 1) || hn(t, 1);
    }
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (Re && n == 66 && r == "c")) {
        const o =
            n == 37 ? (cc(t, t.state.selection.from) == "ltr" ? -1 : 1) : -1;
        return ac(t, o, r) || hn(t, o);
        ...
        if (n == 38 || (Re && n == 80 && r == "c")) {
            return uc(t, -1, r) || hn(t, -1);
        }
        if (n == 40 || (Re && n == 78 && r == "c")) {
            return um(t) || uc(t, 1, r) || hn(t, 1);
        }
        if (
            r == (Re ? "m" : "c") &&
            (n == 66 || n == 73 || n == 89 || n == 90)
...
`,
    ...
    if (
        ...
        l = bm(hc(l, +u[1], +u[2]), u[4]);
    } else if (
        ((l = M.maxOpen(pm(l.content, o), !0)), l.openStart || l.openEnd)
    ) {
        let d = 0;
        let f = 0;
        for (
    ...
    for (let n = e.depth; n >= 0; n--) {
        ...
        if (
            (t.forEach((l) => {
                ...
                if (
                    (c =
                        s.length && i.length && _c(a, i, l, s[s.length - 1], 0))
                ) {
                    s[s.length - 1] = c;
                } else {
                    s.length &&
...
function _c(t, e, n, r, o) {
    if (o < t.length && o < e.length && t[o] == e[o]) {
        const i = _c(t, e, n, r.lastChild, o + 1);
        ...
        if (
            ...
            return r.copy(r.content.append(w.from(Wc(n, t, o + 1))));
        }
    }
}
function jc(t, e) {
...
function hc(t, e, n) {
    return (
        e < t.openStart &&
            (t = new M(
                es(t.content, -1, e, t.openStart, 0, t.openEnd),
                e,
                t.openEnd,
            )),
        n < t.openEnd &&
            (t = new M(es(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var Kc = {
...
const we = {};
const Se = {};
const xm = { touchstart: !0, touchmove: !0 };
const ts = class {
    constructor() {
        ((this.shiftKey = !1),
            (this.mouseDown = null),
...
function wm(t) {
    for (const e in we) {
        ...
        t.dom.addEventListener(
            ...
            xm[e] ? { passive: !0 } : void 0,
        );
    }
    (xe && t.dom.addEventListener("input", () => null), ns(t));
}
function vt(t, e) {
    ...
    t.someProp("handleDOMEvents", (e) => {
        for (const n in e) {
            t.input.eventHandlers[n] ||
                t.dom.addEventListener(
                    n,
                    (t.input.eventHandlers[n] = (r) => fs(t, r)),
                );
        }
    });
}
...
Se.keydown = (t, e) => {
    ...
    if (
        ...
        if (
            ...
            t.someProp("handleKeyDown", (r) => r(t, n)) || fm(t, n)
                ? n.preventDefault()
                : vt(t, "key");
        }
    }
...
function Em(t, e, n, r) {
    return (
        hs(t, "handleDoubleClickOn", e, n, r) ||
        t.someProp("handleDoubleClick", (o) => o(t, e, r))
    );
}
function Om(t, e, n, r) {
    return (
        hs(t, "handleTripleClickOn", e, n, r) ||
    ...
    s &&
        (i == "singleClick"
            ? (t.input.mouseDown && t.input.mouseDown.done(),
              (t.input.mouseDown = new rs(t, s, n, !!r)))
            : (i == "doubleClick" ? Em : Om)(t, s.pos, s.inside, n)
              ? n.preventDefault()
              : vt(t, "pointer"));
};
var rs = class {
    ...
    up(e) {
        ...
        (this.view.state.doc != this.startDoc &&
            ...
            this.allowDefault || !n
                ...
                : Am(this.view, n.pos, n.inside, e, this.selectNode)
                  ? e.preventDefault()
                  : e.button == 0 &&
                      (this.flushed ||
                          (xe &&
...
we.touchstart = (t) => {
    ((t.input.lastTouch = Date.now()), ps(t), vt(t, "pointer"));
};
we.touchmove = (t) => {
    ((t.input.lastTouch = Date.now()), vt(t, "pointer"));
};
we.contextmenu = (t) => ps(t);
function qc(t, e) {
    return t.composing
        ? !0
...
function Yc(t) {
    for (
        t.composing &&
        ((t.input.composing = !1), (t.input.compositionEndedAt = Pm()));
...
function Dm(t) {
    ...
    const n = Op(e.focusNode, e.focusOffset);
    const r = Np(e.focusNode, e.focusOffset);
    if (n && r && n != r) {
...
we.dragstart = (t, e) => {
    ...
    const { dom: a, text: c, slice: u } = ds(t, l);
...
Se.drop = (t, e) => {
    ...
    if (
        ...
        (c.mapping.maps[c.mapping.maps.length - 1].forEach(
            ...
            c.setSelection(us(t, h, c.doc.resolve(p))));
    }
...
const J = class t {
    constructor(e, n) {
        ((this.local = e.length ? e : pn), (this.children = n.length ? n : pn));
    }

    static create(e, n) {
        return n.length ? jr(n, e, 0, Kt) : me;
    }
        ...
        e.forEach((l, a) => {
            ...
            if ((u = eu(n, l, c))) {
                ...
                (o[i] == a
                    ...
                    : o.splice(i, 0, a, a + l.nodeSize, jr(u, l, c + 1, Kt)),
                    (i += 3));
            }
        });
    ...
    forChild(e, n) {
        ...
        if (o) {
            const l = new t(o.sort(Ut), pn);
            return r ? new _r([l, r]) : l;
        }
        return r || me;
    }
...
var _r = class t {
    ...
    map(e, n) {
        const r = this.members.map((o) => o.map(e, n, Kt));
        return t.from(r);
    }
...
function Wm(t) {
    if (
        ...
        if (((t.requiresGeckoHackNode = Ve), yc)) return;
        (console.warn(
...
function qm(t, e, n, r, o) {
    ...
    if (((t.input.compositionPendingChanges = 0), e < 0)) {
        ...
        if (B && !t.state.selection.eq(B)) {
            ...
            const D = t.state.tr.setSelection(B);
            (v == "pointer"
                ? D.setMeta("pointer", !0)
    ...
    if (
        ...
        ((yn && t.input.lastIOSEnter > Date.now() - 225) || dt) &&
            o.some((v) => v.nodeType == 1 && !Jm.test(v.nodeName)) &&
            (!p || p.endA >= p.endB) &&
        ...
        if (
            ...
            if (c.sel) {
                ...
                if (v && !v.eq(t.state.selection)) {
                    const B = t.state.tr.setSelection(v);
    ...
    if (b) {
        if (m.pos == g.pos) {
            ke &&
                ...
                setTimeout(() => ft(t), 20));
            const v = R(t.state.tr.delete(C, S));
            const B = u.resolve(p.start).marksAcross(u.resolve(p.endA));
            ...
            const B = () => R(t.state.tr.insertText(v, C, S));
...
function xc(t, e, n) {
    return Math.max(n.anchor, n.head) > e.content.size
        ? null
        : us(t, e.resolve(n.anchor), e.resolve(n.head));
}
function Gm(t, e) {
...
function Ym(t, e, n, r, o) {
    if (n - e <= o.pos - r.pos || Wi(r, !0, !1) < o.pos) return !1;
    const i = t.resolve(e);
    ...
    const s = t.resolve(Wi(i, !0, !0));
    return !s.parent.isTextblock || s.pos > n || Wi(s, !0, !1) < n
        ? !1
...
const qn = class {
    constructor(e, n) {
        ((this._root = null),
            ...
            (this.domObserver = new ls(this, (r, o, i, s) =>
                qm(this, r, o, i, s),
            )),
    ...
    updateStateInner(e, n) {
        ...
        if (
            ...
            const h = Mc(this);
            Zm(h, this.nodeViews) && ((this.nodeViews = h), (i = !0));
        }
        ((l || n.handleDOMEvents != this._props.handleDOMEvents) && ns(this),
            (this.editable = Cc(this)),
            kc(this));
        const a = Vi(this);
        const c = Sc(this);
    ...
    destroy() {
        this.docView &&
            ...
            this.destroyPluginViews(),
            this.mounted
                ? (this.docView.update(this.state.doc, [], Vi(this), this),
    ...
    domSelectionRange() {
        ...
        return e
            ? (xe &&
                  ...
                  Dp(this.dom.ownerDocument) == this.dom &&
                  _m(this, e)) ||
                  e
            : {
                  focusNode: null,
...
const eg = typeof navigator < "u" && /Mac/.test(navigator.platform);
const tg =
    typeof navigator < "u" &&
...
function nu(t) {
    const e =
        (eg && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
        (tg && t.shiftKey && t.key && t.key.length == 1) ||
        t.key == "Unidentified";
    let n =
        (!e && t.key) ||
...
const rg = typeof navigator < "u" && /Win/.test(navigator.platform);
function og(t) {
    const e = t.split(/-(?!$)/);
    let n = e[e.length - 1];
    n == "Space" && (n = " ");
    ...
    for (let l = 0; l < e.length - 1; l++) {
        ...
        else if (/^mod$/i.test(a)) ng ? (s = !0) : (o = !0);
...
function ru(t) {
    return new N({ props: { handleKeyDown: Xn(t) } });
}
function Xn(t) {
    const e = ig(t);
    return function (n, r) {
...
const bs = (t, e, n) => {
    ...
    if (r.parent.content.size == 0 && (xn(i, "end") || O.isSelectable(i))) {
        for (let s = r.depth; ; s--) {
            const l = $n(t.doc, r.before(s), r.after(s), M.empty);
...
const Ss = (t, e, n) => {
    ...
    const i = o.nodeAfter;
    if (pu(t, o, e, 1)) return !0;
    if (r.parent.content.size == 0 && (xn(i, "start") || O.isSelectable(i))) {
        const s = $n(t.doc, r.before(), r.after(), M.empty);
...
const ks = (t, e, n) => {
    ...
    return !s || !O.isSelectable(s)
        ? !1
        : (e && e(t.tr.setSelection(O.create(t.doc, i.pos)).scrollIntoView()),
          !0);
};
function Cs(t) {
    if (!t.parent.type.spec.isolating) {
...
const As = (t, e) => {
    ...
    const i = vs(o.parent.contentMatchAt(o.indexAfter()));
...
const ag = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0);
function cg(t, e, n) {
    const r = e.nodeBefore;
    const o = e.nodeAfter;
    const i = e.index();
...
function pu(t, e, n, r) {
    ...
    if (
        ...
        if (n) {
            ...
            p = w.from(o.copy(p));
            const m = t.tr.step(
                new ne(e.pos - 1, h, e.pos, h, new M(p, 1, 0), s.length, !0),
            );
    ...
    const u = i.type.spec.isolating || (r > 0 && a) ? null : E.findFrom(e, 1);
...
const ys = Ds(Gr, bs, xs);
const ou = Ds(Gr, Ss, ks);
const Ot = {
    Enter: Ds(Ms, As, Es, lg),
    "Mod-Enter": Ts,
    Backspace: ys,
    "Mod-Backspace": ys,
    "Shift-Backspace": ys,
...
function yu(t, e = null) {
    return function (n, r) {
        ...
        if (!s) return !1;
        const l = r ? n.tr : null;
        return dg(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1;
    };
}
function dg(t, e, n, r = null) {
    let o = !1;
    let i = e;
    const s = e.$from.doc;
    if (
...
function xu(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            const u = w.from(c ? t.create() : null);
            const d = new M(
...
const mg = Object.defineProperty;
const Au = (t, e) => {
    for (const n in e) mg(t, n, { get: e[n], enumerable: !0 });
};
function ro(t) {
...
function Ru(t) {
    ...
    return (
        t.forEach((s) => {
            ...
            const a = I(s, "addGlobalAttributes", l);
            if (!a) return;
            a().forEach((u) => {
                u.types.forEach((d) => {
...
function xg(t, e) {
    ...
    const s = (n = o.find((c) => I(c, "topNode"))) == null ? void 0 : n.name;
    const l = Object.fromEntries(
        o.map((c) => {
            ...
            const h = Su({
                ...
                linebreakReplacement: W(I(c, "linebreakReplacement", d)),
    ...
    const a = Object.fromEntries(
        i.map((c) => {
            ...
            const f = t.reduce((g, y) => {
                const b = I(y, "extendMarkSchema", d);
                return { ...g, ...(b ? b(c) : {}) };
            }, {});
            const h = Su({
                ...f,
...
function Ws(t) {
    return t.sort((n, r) => {
        const o = I(n, "priority") || 100;
        const i = I(r, "priority") || 100;
        return o > i ? -1 : o < i ? 1 : 0;
    });
}
function Du(t) {
    const e = Ws($s(t));
    const n = wg(e.map((r) => r.name));
    return (
        n.length &&
            console.warn(
...
function _s(t, e) {
    ...
    return n === "node" ? kg(t, e) : n === "mark" ? Lu(t, e) : {};
}
function Cg(t, e = JSON.stringify) {
    const n = {};
    return t.filter((r) => {
        const o = e(r);
...
function Js(t, e, n = {}) {
    if (!e) return Ge(t, null, n) || zs(t, null, n);
    const r = io(e, t.schema);
    return r === "node" ? Ge(t, e, n) : r === "mark" ? zs(t, e, n) : !1;
}
const Hu = (t, e) => {
    ...
    return (
        Qr(t) &&
            ...
            Object.keys(e).forEach((r) => {
                Qr(e[r]) && Qr(t[r]) ? (n[r] = Wu(t[r], e[r])) : (n[r] = e[r]);
            }),
        n
    );
}
...
function Pg(t) {
    ...
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            const g = Math.min(o, p + h.content.size);
            const y = h.textBetween(m - p, g - p, void 0, "\uFFFC");
            Dg(y, i.find, s).forEach((x) => {
                if (x.index === void 0) return;
                const C = m + x.index + 1;
                const S = C + x[0].length;
                const R = {
                    from: n.tr.mapping.map(C),
        ...
        (u) =>
            new N({
                ...
                appendTransaction: (d, f, h) => {
                    ...
                    const x = f.doc.content.findDiffStart(h.doc.content);
                    const C = f.doc.content.findDiffEnd(h.doc.content);
                    if (!(!Ng(x) || !C || x === C.b)) {
                        return a({
                            rule: u,
                            state: h,
...
const uo = class {
    constructor(t, e) {
        ((this.splittableMarks = []),
            ...
            (this.schema = xg(this.extensions, e)),
    ...
    get plugins() {
        const { editor: t } = this;
        const e = Ws([...this.extensions].reverse());
        const n = [];
        const r = [];
        const o = e
            .map((i) => {
                const s = {
                    ...
                    editor: t,
                    type: Ps(i.name, this.schema),
                };
                const l = [];
                const a = I(i, "addKeyboardShortcuts", s);
                let c = {};
                if (
                    (i.type === "mark" &&
                        I(i, "exitable", s) &&
                ...
                const u = ru(c);
                l.push(u);
                const d = I(i, "addInputRules", s);
                Cu(i, t.options.enableInputRules) && d && n.push(...d());
                const f = I(i, "addPasteRules", s);
                Cu(i, t.options.enablePasteRules) && f && r.push(...f());
                const h = I(i, "addProseMirrorPlugins", s);
                if (h) {
                    const p = h();
                    l.push(...p);
                }
    ...
    setupExtensions() {
        ...
        ((this.editor.extensionStorage = Object.fromEntries(
            ...
            t.forEach((e) => {
                ...
                const o = I(e, "onBeforeCreate", r);
                const i = I(e, "onCreate", r);
                const s = I(e, "onUpdate", r);
                const l = I(e, "onSelectionUpdate", r);
                const a = I(e, "onTransaction", r);
                const c = I(e, "onFocus", r);
                const u = I(e, "onBlur", r);
                const d = I(e, "onDestroy", r);
    ...
    ({ tr: n, state: r, dispatch: o }) => {
        ...
        if (o) {
            ...
            if (d && d.from <= c && d.to >= u) {
                const f = A.create(s, d.from, d.to);
                n.setSelection(f);
            }
        }
        return !0;
    ...
    ({ tr: r, dispatch: o, editor: i }) => {
        ...
        if (o) {
            ...
            if (h) {
                ...
                const x = a.$from.node().content.size > 0;
                (y && b && x && (d = Math.max(0, d - 1)),
                    r.replaceWith(d, f, g));
            }
            (n.updateSelection && Tg(r, r.steps.length - 1, -1),
                n.applyInputRules &&
...
function dy(t) {
    ...
    for (let l = 0; l < e.length - 1; l += 1) {
        ...
        else if (/^mod$/i.test(a)) Gs() || Ju() ? (s = !0) : (o = !0);
        else throw new Error(`Unrecognized modifier name: ${a}`);
    }
    return (
        r && (n = `Alt-${n}`),
              ...
              o &&
                  n.selection.ranges.forEach((a) => {
                      r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, u) => {
                          (i &&
                              i === c.type &&
                              n.setNodeMarkup(u, void 0, vu(c.attrs, e)),
                              s &&
                                  c.marks.length &&
                                  c.marks.forEach((d) => {
                                      s === d.type &&
...
var Ry =
    ...
    ({ tr: e, dispatch: n }) => {
        if (n) {
            ...
            const s = A.atStart(r).from;
            const l = A.atEnd(r).to;
            const a = pt(o, s, l);
            const c = pt(i, s, l);
            const u = A.create(r, a, c);
            e.setSelection(u);
        }
        return !0;
    };
...
var Iy =
    ...
    ({ tr: n, state: r, dispatch: o, editor: i }) => {
        ...
        if (o) {
            ...
            const { splittableMarks: x } = i.extensionManager;
            const C = b || (y.$to.parentOffset && y.$from.marks());
            if ((n.split(a.pos, 2, g).scrollIntoView(), !C || !o)) return !0;
            const S = C.filter((R) => x.includes(R.type.name));
            n.ensureMarks(S);
        }
        return !0;
    };
...
var Ly =
    ...
    ({
        ...
        const h = Q(t, s.schema);
        const p = Q(e, s.schema);
        const { selection: m, storedMarks: g } = s;
        const { $from: y, $to: b } = m;
        const x = y.blockRange(b);
        const C = g || (m.$to.parentOffset && m.$from.marks());
        if (!x) return !1;
        const S = Ye((R) => Mu(R.type.name, d))(m);
        if (x.depth >= 1 && S && x.depth - S.depth <= 1) {
            if (S.node.type === h) return c.liftListItem(p);
            if (
                Mu(S.node.type.name, d) &&
        ...
        return !n || !C || !l
            ...
            : a()
                  .command(() => {
                      const R = u().wrapInList(h, r);
                      const P = C.filter((v) => f.includes(v.type.name));
...
var zy =
    (t, e, n = {}) =>
    ({ state: r, commands: o }) => {
        const i = Q(t, r.schema);
        const s = Q(e, r.schema);
        const l = Ge(r, i, n);
        let a;
        return (
        ...
        const i = () => {
            ...
            u.steps.forEach((h, p) => {
                ...
                if (h instanceof lt) {
                    ...
                    const x = f.invert().map(y, -1);
                    const C = f.invert().map(b);
                    const S =
        ...
        return [
            new N({
                ...
                appendTransaction: (t, e, n) => {
                    ...
                    const a = E.atStart(e.doc).from;
                    const c = E.atEnd(e.doc).to;
    ...
    get children() {
        ...
        return (
            this.node.content.forEach((n, r) => {
                ...
                const a = new wn(l, this.editor, o, o ? n : null);
...
const rd = class extends gg {
    ...
    injectCSS() {
        this.options.injectCSS &&
            typeof document < "u" &&
            (this.css = Jy(Uy, this.options.injectNonce));
    }
...
function Ie(t) {
    return new co({
        ...
        handler: ({ state: e, range: n, match: r }) => {
            const o = W(t.getAttributes, void 0, r);
...
function nr(t) {
    return new co({
        ...
        handler: ({ state: e, range: n, match: r }) => {
            ...
            const i = W(t.getAttributes, void 0, r) || {};
            if (
                !o
                    .node(-1)
...
function Ce(t) {
    return new Rg({
        ...
        handler: ({ state: e, range: n, match: r, pasteEvent: o }) => {
            const i = W(t.getAttributes, void 0, r, o);
...
const se = class t extends E {
    ...
    static valid(e) {
        const n = e.parent;
        if (n.isTextblock || !Gy(e) || !Yy(e)) return !1;
...
function ad() {
    return new N({
        props: {
            ...
            handleClick: Qy,
            handleKeyDown: Xy,
            handleDOMEvents: { beforeinput: Zy },
        },
    });
}
var Xy = Xn({
...
function Zy(t, e) {
    ...
    const i = t.state.tr.replace(n.pos, n.pos, new M(o, 0, 0));
    return (
...
const Yt = class t {
    ...
    addTransform(e, n, r, o) {
        ...
        const c = s - r.depth;
        return (c > o0 && ((l = r0(l, c)), (s -= c)), new t(l.append(i), s));
    }
    ...
    compress(e = this.items.length) {
        ...
        return (
            ...
            new t(Qs.from(o.reverse()), i)
        );
    }
};
Yt.empty = new Yt(Qs.empty, 0);
function r0(t, e) {
    let n;
    return (
        t.forEach((r, o) => {
...
var o0 = 20;
function i0(t, e, n, r) {
    const o = n.getMeta(Gt);
    let i;
    if (o) return o.historyState;
    n.getMeta(a0) && (t = new Ze(t.done, t.undone, null, 0, -1));
        ...
        const a =
            ...
            (!s &&
                ...
                (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                    !s0(n, t.prevRanges)));
        const c = s ? Zs(t.prevRanges, n.mapping) : ud(n.mapping.maps);
        return new Ze(
            t.done.addTransform(
                n,
                ...
                props: {
                    decorations(n) {
                        return n.selection.empty ||
                            ...
                            ? null
                            : J.create(n.doc, [
                                  Y.inline(n.selection.from, n.selection.to, {
                                      class: e.className,
                                  }),
                              ]);
                    },
...
const u0 = z.create({
    ...
    addInputRules() {
        return [Xe({ find: c0, type: this.type })];
    },
});
const yd = u0;
const d0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/;
const f0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g;
const h0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/;
...
const m0 = te.create({
    ...
    addInputRules() {
        return [
            Ie({ find: d0, type: this.type }),
            Ie({ find: h0, type: this.type }),
        ];
    },
    addPasteRules() {
        return [
            Ce({ find: f0, type: this.type }),
...
const b0 = te.create({
    ...
    addInputRules() {
        return [Ie({ find: g0, type: this.type })];
    },
    addPasteRules() {
        return [Ce({ find: y0, type: this.type })];
    },
});
const xd = b0;
const x0 = /^```([a-z]+)?[\s\n]$/;
...
const kd = (t, e) => {
    ...
    if (!u) return !1;
    const d = Sn(u.node, (y) => y.type === i.nodes.detailsContent);
...
const Cd = z.create({
    ...
    addNodeView() {
        return ({ editor: t, getPos: e, node: n, HTMLAttributes: r }) => {
            ...
            const i = T(this.options.HTMLAttributes, r, {
                "data-type": this.name,
            });
        ...
        return [
            new N({
                ...
                appendTransaction: (t, e, n) => {
                    ...
                    if (yo(l.pos, r)) return;
                    const c = k0(l, (g) => g.type === o, r);
                    if (!c) return;
                    const u = Sn(
                        c.node,
...
const Md = z.create({
    ...
    addNodeView() {
        return ({ HTMLAttributes: t }) => {
            const e = document.createElement("div");
            const n = T(this.options.HTMLAttributes, t, {
                "data-type": this.name,
                hidden: "hidden",
            });
            return (
    ...
    addKeyboardShortcuts() {
        return {
            Enter: ({ editor: t }) => {
                ...
                const s = Ye((_) => _.type === this.type)(r);
                ...
                const x = er(y.contentMatchAt(b));
                if (!x || !y.canReplaceWith(b, b, x)) return !1;
                const C = x.createAndFill();
                if (!C) return !1;
                const { tr: S } = e;
                const R = o.after(-2);
                S.replaceWith(R, R, C);
                const P = S.doc.resolve(R);
                const v = E.near(P, 1);
                S.setSelection(v);
                const B = m;
                const D = m + p.nodeSize;
                return (S.delete(B, D), S.scrollIntoView(), n.dispatch(S), !0);
            },
        };
    },
});
...
const C0 = z.create({ name: "doc", topNode: !0, content: "block+" });
const Td = C0;
const M0 = z.create({
    name: "hardBreak",
    addOptions() {
...
const E0 = te.create({
    ...
    addInputRules() {
        return [Ie({ find: T0, type: this.type })];
    },
    addPasteRules() {
        return [Ce({ find: A0, type: this.type })];
    },
});
const Od = E0;
const O0 = z.create({
...
const N0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/;
const R0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g;
const D0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/;
const P0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g;
const I0 = te.create({
    name: "italic",
    addOptions() {
        return { HTMLAttributes: {} };
    ...
    addInputRules() {
        return [
            Ie({ find: N0, type: this.type }),
            Ie({ find: D0, type: this.type }),
        ];
    },
    addPasteRules() {
        return [
            Ce({ find: R0, type: this.type }),
            Ce({ find: P0, type: this.type }),
        ];
    },
});
...
const F = (t, e, n, r, o) => t.ta(e, n, r, o);
const Z = (t, e, n, r, o) => t.tr(e, n, r, o);
const Ld = (t, e, n, r, o) => t.ts(e, n, r, o);
const k = (t, e, n, r, o) => t.tt(e, n, r, o);
const bt = "WORD";
const pl = "UWORD";
const Wd = "ASCIINUMERICAL";
const _d = "ALPHANUMERICAL";
const dr = "LOCALHOST";
const ml = "TLD";
const gl = "UTLD";
const So = "SCHEME";
const Cn = "SLASH_SCHEME";
const bl = "NUM";
const yl = "WS";
const xl = "NL";
const sr = "OPENBRACE";
...
function K0(t = []) {
    ...
    (bo == null && (bo = zd(z0)),
        ...
        k(n, "\\", Fo),
        k(n, "\u30FB", jd));
    const r = Z(n, yt, bl, { [ul]: !0 });
    Z(r, yt, r);
    const o = Z(r, gt, Wd, { [ir]: !0 });
    const i = Z(r, rr, _d, { [or]: !0 });
    const s = Z(n, gt, bt, { [dl]: !0 });
    (Z(s, yt, o), Z(s, gt, s), Z(o, yt, o), Z(o, gt, o));
    const l = Z(n, rr, pl, { [fl]: !0 });
    (Z(l, gt), Z(l, yt, i), Z(l, rr, l), Z(i, yt, i), Z(i, gt), Z(i, rr, i));
    const a = k(n, ll, xl, { [ol]: !0 });
    const c = k(n, Bd, yl, { [ol]: !0 });
    const u = Z(n, sl, yl, { [ol]: !0 });
    (k(n, al, u),
        k(c, ll, a),
        k(c, al, u),
        Z(c, sl, u),
        ...
        Z(u, sl, u),
        k(u, al, u));
    const d = Z(n, il, Kd, { [Vd]: !0 });
    (k(d, "#"), Z(d, il, d), k(d, _0, d));
    const f = k(d, j0);
    (k(f, "#"), Z(f, il, d));
    const h = [
        [gt, s],
    ...
    for (let m = 0; m < bo.length; m++) Nt(n, bo[m], ml, bt, h);
    for (let m = 0; m < xo.length; m++) Nt(n, xo[m], gl, pl, p);
    (Xt(ml, { tld: !0, ascii: !0 }, e),
        Xt(gl, { utld: !0, alpha: !0 }, e),
        Nt(n, "file", So, bt, h),
        Nt(n, "mailto", So, bt, h),
        Nt(n, "http", Cn, bt, h),
        Nt(n, "https", Cn, bt, h),
    ...
    return (
        ...
        (n.jd = new Me(qo)),
        { start: n, tokens: Mn({ groups: e }, Ud) }
    );
}
function Jd(t, e) {
    const n = U0(e.replace(/[A-Z]/g, (l) => l.toLowerCase()));
    const r = n.length;
    const o = [];
    let i = 0;
    let s = 0;
...
function Ml(t, e = null) {
    let n = Mn({}, fr);
    t && (n = Mn(n, t instanceof Ml ? t.o : t));
...
function q0({ groups: t }) {
    ...
    F(f, t.domain, d);
    const h = Le(Fd);
    (F(f, t.tld, h), F(f, t.utld, h), k(c, dr, h));
    const p = k(d, Be);
    (k(p, Be, p),
        F(p, t.domain, d),
        F(h, t.domain, d),
    ...
    return (k(o, dr, b), k(o, xl, J0), { start: o, tokens: Ud });
}
function G0(t, e, n) {
    const r = n.length;
    let o = 0;
    ...
    return (s.length > 0 && i.push(cl($d, e, s)), i);
}
function cl(t, e, n) {
    const r = n[0].s;
...
const Y0 = (typeof console < "u" && console && console.warn) || (() => {});
const X0 =
...
function vl(t, e = !1) {
    if (
        (q.initialized &&
            Y0(
                `linkifyjs: already initialized - will not register custom scheme "${t}" ${X0}`,
            ),
...
function Yo(t) {
    return (
        q.initialized || Q0(),
        G0(q.parser.start, t, Jd(q.scanner.start, t))
    );
}
Yo.scan = Jd;
...
const Tl = "[\0- \xA0\u1680\u180E\u2000-\u2029\u205F\u3000]";
const Z0 = new RegExp(Tl);
const eb = new RegExp(`${Tl}$`);
const tb = new RegExp(Tl, "g");
function nb(t) {
    return t.length === 1
        ? t[0].isLink
        ...
        appendTransaction: (e, n, r) => {
            ...
            if (
                (js(l).forEach(({ newRange: c }) => {
                    ...
                    if (d && f) {
                        const h = f.split(Z0).filter(Boolean);
    ...
    return new N({
        ...
        props: {
            handleClick: (e, n, r) => {
                ...
                if (!s) return !1;
                const l = _s(e.state, t.type.name);
...
const Yd = sb;
const lb = Object.defineProperty;
const ab = (t, e) => {
    for (const n in e) lb(t, n, { get: e[n], enumerable: !0 });
};
const cb = "listItem";
const Xd = "textStyle";
const Qd = /^\s*([-+*])\s$/;
    ...
    addExtensions() {
        ...
        return (
            this.options.bulletList !== !1 &&
                t.push(Ol.configure(this.options.bulletList)),
            this.options.listItem !== !1 &&
                t.push(Nl.configure(this.options.listItem)),
            this.options.listKeymap !== !1 &&
                t.push(fb.configure(this.options.listKeymap)),
            this.options.orderedList !== !1 &&
                t.push(Dl.configure(this.options.orderedList)),
            this.options.taskItem !== !1 &&
                t.push(mb.configure(this.options.taskItem)),
...
const lf = ["image/png", "image/jpeg", "image/gif", "image/webp"];
const Qo = (t, e, n = {}) => {
    t.dom
        .closest("form")
        ?.dispatchEvent(
    ...
    return new N({
        ...
        props: {
            handleDrop(s, l) {
                ...
                const a = Array.from(l.dataTransfer.files).filter((u) =>
                    lf.includes(u.type),
                );
                if (!a.length) return !1;
                (Qo(s, "form-processing-started", { message: o }),
                    l.preventDefault(),
                    l.stopPropagation());
                const c = s.posAtCoords({ left: l.clientX, top: l.clientY });
                return (
                    a.forEach((u, d) => {
                        (t.setEditable(!1),
                            s.dom.dispatchEvent(
                        ...
                        const h = ("10000000-1000-4000-8000" + -1e11).replace(
                            /[018]/g,
                            (p) =>
                                (
                                    p ^
            ...
            handlePaste(s, l) {
                ...
                const a = Array.from(l.clipboardData.files).filter((c) =>
                    lf.includes(c.type),
                );
                return a.length
                    ? (l.preventDefault(),
                      ...
                      a.forEach((c, u) => {
                          ...
                          const f = ("10000000-1000-4000-8000" + -1e11).replace(
                              /[018]/g,
                              (h) =>
                                  (
                                      h ^
...
const af = $.create({
    ...
    addProseMirrorPlugins() {
        return [yb({ editor: this.editor, ...this.options })];
    },
});
function bb(t) {
    let e;
    ...
    const b = new N({
        ...
        view() {
            return {
                update: async (x, C) => {
                    let S, R, P, v, B, D, _;
                    const H = (S = this.key) == null ? void 0 : S.getState(C);
                    const j =
                        (R = this.key) == null ? void 0 : R.getState(x.state);
                    const U =
                        H.active && j.active && H.range.from !== j.range.from;
                    const oe = !H.active && j.active;
                    const X = H.active && !j.active;
                    const G = !oe && !X && H.query !== j.query;
                    const ie = oe || (U && G);
                    const Te = G || U;
                    const On = X || (U && G);
                    if (!ie && !Te && !On) return;
                    const rn = On && !ie ? H : j;
                    const Ql = x.dom.querySelector(
                    ...
                    ((g = {
                        ...
                        items: [],
                        command: (wr) =>
                            d({ editor: e, range: rn.range, props: wr }),
                        decorationNode: Ql,
                        clientRect: Ql
                            ? () => {
                                  let wr;
                                  const { decorationId: zh } =
                                      (wr = this.key) == null
                                          ? void 0
                                          : wr.getState(e.state);
                                  const Zl = x.dom.querySelector(
                                      `[data-decoration-id="${zh}"]`,
                                  );
                                  return Zl?.getBoundingClientRect() || null;
                              }
                            : null,
                    }),
                        ie && ((P = y?.onBeforeStart) == null || P.call(y, g)),
                        Te && ((v = y?.onBeforeUpdate) == null || v.call(y, g)),
                        (Te || ie) &&
                            (g.items = await f({ editor: e, query: rn.query })),
                        On && ((B = y?.onExit) == null || B.call(y, g)),
        ...
        state: {
            ...
            apply(x, C, S, R) {
                ...
                const { composing: v } = e.view;
                const { selection: B } = x;
                const { empty: D, from: _ } = B;
                const H = { ...C };
                if (((H.composing = v), P && (D || e.view.composing))) {
                    ...
                    const U = `id_${Math.floor(Math.random() * 4294967295)}`;
                    j &&
                    p({
                        editor: e,
                        state: R,
        ...
        props: {
            handleKeyDown(x, C) {
                let S;
                const { active: R, range: P } = b.getState(x.state);
                return (
                    (R &&
                        ((S = y?.onKeyDown) == null
                            ? void 0
                            : S.call(y, { view: x, event: C, range: P }))) ||
                    !1
                );
            },
            decorations(x) {
...
const uf = z.create({
    ...
    renderHTML({ node: t, HTMLAttributes: e }) {
        ...
        return typeof o === "string"
            ? [
                  "span",
                  T({ "data-type": this.name }, this.options.HTMLAttributes, e),
                  o,
              ]
            : o;
    },
...
const vb = te.create({
    ...
    addInputRules() {
        return [Ie({ find: Cb, type: this.type })];
    },
    addPasteRules() {
...
if (typeof WeakMap < "u") {
    const t = new WeakMap();
    ((Il = (e) => t.get(e)), (Ll = (e, n) => (t.set(e, n), n)));
} else {
    const t = [];
    let n = 0;
    ((Il = (r) => {
...
const K = class xt extends E {
    ...
    getBookmark() {
        return new Bb(this.$anchorCell.pos, this.$headCell.pos);
    }
};
...
function Nf(t, { map: e, tableStart: n, table: r }, o) {
    let i = o > 0 ? -1 : 0;
    Lb(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0);
...
function _b(t, { map: e, table: n, tableStart: r }, o) {
...
function Pf(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.right - 1; _b(r, n, o), o != n.left; o--) {
...
function If(t, { map: e, tableStart: n, table: r }, o) {
    ...
    const l = [];
    let a = o > 0 ? -1 : 0;
    jb(e, r, o + a) && (a = o == 0 || o == e.height ? null : 0);
...
function Kb(t, { map: e, table: n, tableStart: r }, o) {
    let i = 0;
...
function zf(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.bottom - 1; Kb(r, n, o), o != n.top; o--) {
            const i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
            if (!i) throw RangeError("No table found");
...
function Ub({ width: t, height: e, map: n }, r) {
...
function Wl(t, e) {
    const n = ye(t.schema);
    return Jb(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function Jb(t) {
    return (e, n) => {
        let r;
...
const eM = Tn("row", { useDeprecatedLogic: !0 });
const tM = Tn("column", { useDeprecatedLogic: !0 });
...
function _l(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            n(e.tr.setSelection(A.between(o, Ib(o))).scrollIntoView());
        }
        return !0;
    };
}
...
function Yb(t) {
    ...
    if (i == "row") {
        for (let a = 0; a < e.childCount; a++) {
            ...
            ((u || d) && (c = zl(ye(s).row, new M(c, u, d)).content),
                l.push(c));
        }
    } else if (i == "cell" || i == "header_cell") {
        l.push(n || r ? zl(ye(s).row, new M(e, n, r)).content : e);
    } else return null;
    return Xb(s, l);
}
function Xb(t, e) {
...
function Qb({ width: t, height: e, rows: n }, r, o) {
    if (t != r) {
        const i = [];
        const s = [];
...
function Zb(t, e, n, r, o, i, s) {
    ...
    if (i > e.height) {
        ...
        const f = a.row.create(null, w.from(d));
        const h = [];
...
function ei(t, e) {
    return (n, r, o) => {
        if (!o) return !1;
        const i = n.selection;
        if (i instanceof K) return ni(n, r, E.near(i.$headCell, e));
        if (t != "horiz" && !i.empty) return !1;
        const s = Vf(o, t, e);
        if (s == null) return !1;
        if (t == "horiz") return ni(n, r, E.near(n.doc.resolve(i.head + e), e));
        {
...
function ti(t, e) {
    return (n, r, o) => {
        ...
        return l ? ni(n, r, new K(s.$anchorCell, l)) : !1;
    };
}
function tx(t, e) {
    const n = t.state.doc;
    ...
    if (o instanceof K) {
        r ||
            (r = {
                width: 1,
                height: 1,
                rows: [w.from(zl(ye(t.state.schema).cell, n))],
            });
        ...
        return (
            (r = Qb(r, l.right - l.left, l.bottom - l.top)),
...
function rx(t, e) {
    ...
    if (e.shiftKey && t.state.selection instanceof K) {
        ...
        ((n = Pl(t, e)) == null ? void 0 : n.pos) != o.pos
    ) {
    ...
    function l(a) {
        ...
        else if (kf(t, c.target) != r && ((d = Pl(t, e)), !d)) return s();
        d && i(d, c);
    }
...
const ox = class {
    constructor(t, e) {
        ((this.node = t),
            ...
            Hl(t, this.colgroup, this.table, e),
    ...
    update(t) {
        return t.type != this.node.type
            ? !1
            : ((this.node = t),
              Hl(t, this.colgroup, this.table, this.defaultCellMinWidth),
              !0);
    }
...
const Ee = new L("tableColumnResizing");
function Wf({
    handleWidth: t = 5,
    cellMinWidth: e = 25,
    ...
    const i = new N({
        ...
        props: {
            ...
            decorations: (s) => {
                const l = Ee.getState(s);
                if (l && l.activeHandle > -1) return hx(s, l.activeHandle);
            },
            nodeViews: {},
        },
    });
...
var ix = class ri {
    ...
    apply(e) {
        ...
        if (n.activeHandle > -1 && e.docChanged) {
            ...
            return (Bl(e.doc.resolve(o)) || (o = -1), new ri(o, n.dragging));
        }
        return n;
    }
};
...
function lx(t) {
    ...
    e && e.activeHandle > -1 && !e.dragging && _f(t, -1);
}
function ax(t, e, n, r) {
    let o;
    ...
    const a = cx(t, s.activeHandle, l.attrs);
    t.dispatch(
    ...
    function c(d) {
        ...
        f?.dragging &&
            (dx(t, f.activeHandle, Mf(f.dragging, d, n)),
    ...
    function u(d) {
        ...
        const f = Ee.getState(t.state);
        if (f && f.dragging) {
            const h = Mf(f.dragging, d, n);
            vf(t, f.activeHandle, h, r);
        }
    }
    return (
        vf(t, s.activeHandle, a, r),
...
function cx(t, e, { colspan: n, colwidth: r }) {
...
function dx(t, e, n) {
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        const p = f.colwidth ? f.colwidth.slice() : fx(f.colspan);
...
function vf(t, e, n, r) {
    ...
    const i = o.node(-1);
    const s = o.start(-1);
    const l = ee.get(i).colCount(o.pos - s) + o.nodeAfter.attrs.colspan - 1;
    let a = t.domAtPos(o.start(-1)).node;
    for (; a && a.nodeName != "TABLE"; ) a = a.parentNode;
    a && Hl(i, a.firstChild, a, r, l, n);
}
function fx(t) {
...
const ii = ({ editor: t }) => {
    ...
    if (!Sx(e)) return !1;
    let n = 0;
    const r = Fs(e.ranges[0].$from, (i) => i.type.name === "table");
    return (
...
const kx = z.create({
    ...
    renderHTML({ node: t, HTMLAttributes: e }) {
        const {
            ...
            tableWidth: r,
            tableMinWidth: o,
        } = bx(t, this.options.cellMinWidth);
        return [
            "table",
            T(this.options.HTMLAttributes, e, {
    ...
    addCommands() {
        return {
            ...
            fixTables:
                () =>
                ({ state: t, dispatch: e }) => (e && $l(t), !0),
            setCellSelection:
                (t) =>
                ({ tr: e, dispatch: n }) => {
                    if (n) {
                        const r = K.create(e.doc, t.anchorCell, t.headCell);
                        e.setSelection(r);
                    }
                    return !0;
                },
    ...
    addExtensions() {
        ...
        return (
            this.options.table !== !1 &&
                t.push(kx.configure(this.options.table)),
            this.options.tableCell !== !1 &&
                t.push(px.configure(this.options.tableCell)),
            this.options.tableHeader !== !1 &&
                t.push(mx.configure(this.options.tableHeader)),
            this.options.tableRow !== !1 &&
                t.push(gx.configure(this.options.tableRow)),
            t
        );
    },
});
const Cx = z.create({ name: "text", group: "inline" });
const qf = Cx;
const Mx = $.create({
    name: "textAlign",
    addOptions() {
...
const Yf = vx;
const Kl = ["top", "right", "bottom", "left"];
const Xf = ["start", "end"];
const Ul = Kl.reduce(
...
const gr = Math.round;
const _e = (t) => ({ x: t, y: t });
const Tx = { left: "right", right: "left", bottom: "top", top: "bottom" };
const Ax = { start: "end", end: "start" };
function si(t, e, n) {
    return fe(t, ze(e, n));
}
function rt(t, e) {
...
function pr(t) {
    return t.replace(/start|end/g, (e) => Ax[e]);
}
const Qf = ["left", "right"];
const Zf = ["right", "left"];
const Ox = ["top", "bottom"];
...
async function en(t, e) {
    ...
    const b =
        d === "floating"
            ...
            : s.reference;
    const x = await (i.getOffsetParent == null
        ? void 0
        : i.getOffsetParent(l.floating));
    const C = (await (i.isElement == null ? void 0 : i.isElement(x)))
...
const sh = (t) => ({
    ...
    async fn(e) {
        ...
        const x = g ? "clientHeight" : "clientWidth";
        const C = i.reference[p] + i.reference[h] - f[h] - i.floating[p];
        const S = f[h] - i.reference[h];
        const R = await (s.getOffsetParent == null
            ? void 0
            : s.getOffsetParent(c));
        let P = R ? R[x] : 0;
...
function Px(t, e, n) {
    return (
        t
            ...
            : n.filter((o) => Oe(o) === o)
    ).filter((o) => (t ? He(o) === t || (e ? pr(o) !== o : !1) : !0));
}
const lh = function (t) {
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                const {
                    crossAxis: u = !1,
                    alignment: d,
                    allowedPlacements: f = Ul,
                    autoAlignment: h = !0,
                    ...p
                } = rt(t, e);
                const m = d !== void 0 || f === Ul ? Px(d || null, h, f) : f;
                const g = await en(e, p);
                const y =
                ...
                const P = S.map((D) => {
                    const _ = He(D.placement);
                    return [
                        D.placement,
                        _ && u
                            ? D.overflows.slice(0, 2).reduce((H, j) => H + j, 0)
                            : D.overflows[0],
                        D.overflows,
                    ];
                }).sort((D, _) => D[1] - _[1]);
                const B =
                    ((o = P.filter((D) =>
                        D[2].slice(0, He(D[0]) ? 2 : 3).every((_) => _ <= 0),
                    )[0]) == null
                        ? void 0
                        : o[0]) || P[0][0];
                return B !== l
    ...
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                const b = je(l);
                const x = Oe(l) === l;
                const C = await (a.isRTL == null
                    ? void 0
                    : a.isRTL(c.floating));
                const S = f || (x || !m ? [mr(l)] : eh(l));
                const R = p !== "none";
                !f && R && S.push(...th(l, m, p, C));
                const P = [l, ...S];
                const v = await en(e, g);
                const B = [];
                ...
                if (
                    ...
                    let _, H;
                    const U =
                        (((_ = i.flip) == null ? void 0 : _.index) || 0) + 1;
                    const oe = P[U];
                    if (
                        oe &&
        ...
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                switch (r) {
                    ...
                    case "escaped": {
                        const i = await en(e, { ...o, altBoundary: !0 });
...
function uh(t) {
    const e = ze(...t.map((i) => i.left));
    const n = ze(...t.map((i) => i.top));
                ...
                function p() {
                    ...
                    if (d.length >= 2) {
                        if (je(n) === "y") {
                            ...
                            const j = D.top;
                            const U = _.bottom;
                            const oe = H ? D.left : _.left;
                            const X = H ? D.right : _.right;
                            const G = X - oe;
                            const ie = U - j;
                            return {
                                top: j,
                        ...
                        const g = Oe(n) === "left";
                        const y = fe(...d.map((D) => D.right));
                        const b = ze(...d.map((D) => D.left));
                        const x = d.filter((D) =>
                            g ? D.left === b : D.right === y,
                        );
                        const C = x[0].top;
                        const S = x[x.length - 1].bottom;
                        const R = b;
                        const P = y;
                        const v = P - R;
                        const B = S - C;
    ...
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                const C = ze(m - u[g], b);
                const S = ze(p - u[y], x);
                const R = !e.middlewareData.shift;
                let P = C;
                let v = S;
                if (
                    ...
                    const D = fe(u.left, 0);
                    const _ = fe(u.right, 0);
                    const H = fe(u.top, 0);
                    const j = fe(u.bottom, 0);
                    h
                        ? (v =
                              p -
                              2 *
...
function gh(t) {
    return di() ? t instanceof Node || t instanceof ve(t).Node : !1;
}
function Fe(t) {
    return di() ? t instanceof Element || t instanceof ve(t).Element : !1;
}
function Ke(t) {
    return di()
...
const zx = new Set(["inline", "contents"]);
function An(t) {
    const { overflow: e, overflowX: n, overflowY: r, display: o } = $e(t);
    return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !zx.has(o);
}
const Hx = new Set(["table", "td", "th"]);
function yh(t) {
    return Hx.has(tn(t));
}
...
const _x = new Set(["html", "body", "#document"]);
function nn(t) {
    return _x.has(tn(t));
}
function $e(t) {
...
function xr(t, e, n, r) {
    ...
    const i = Ch(t);
    let s = _e(1);
    e && (r ? Fe(r) && (s = En(r)) : (s = En(t)));
    const l = Kx(i, n, r) ? Mh(i) : _e(0);
    ...
    if (i) {
        ...
        for (; m && r && h !== p; ) {
            ...
            const b = $e(m);
            const x = y.left + (m.clientLeft + parseFloat(b.paddingLeft)) * g.x;
            const C = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (u *= g.x),
                (d *= g.y),
...
function vh(t, e, n) {
    ...
    const o = r.left + e.scrollLeft - (n ? 0 : Yl(t, r));
    const i = r.top + e.scrollTop;
    return { x: o, y: i };
}
function Ux(t) {
    ...
    if (
        (d || (!d && !i)) &&
        ((tn(r) !== "body" || An(s)) && (a = br(r)), Ke(r))
    ) {
        const h = xr(r);
        ((c = En(r)), (u.x = h.x + r.clientLeft), (u.y = h.y + r.clientTop));
    }
    const f = s && !d && !i ? vh(s, a, !0) : _e(0);
    return {
        width: n.width * c.x,
        height: n.height * c.y,
...
function wh(t, e, n) {
    let r;
    if (e === "viewport") r = Gx(t, n);
    else if (e === "document") r = qx(ot(t));
    else if (Fe(e)) r = Xx(e, n);
    else {
        const o = Mh(t);
...
function Th(t, e) {
    ...
    return n === e || !Fe(n) || nn(n)
        ? !1
        : $e(n).position === "fixed" || Th(n, e);
}
function Qx(t, e) {
    const n = e.get(t);
    if (n) return n;
    let r = ui(t, [], !1).filter((l) => Fe(l) && tn(l) !== "body");
    let o = null;
...
function tw(t, e, n) {
    ...
    if (r || (!r && !i)) {
        if (((tn(e) !== "body" || An(o)) && (l = br(e)), r)) {
            const h = xr(e, !0, i, e);
            ((a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop));
        } else o && c();
    }
    i && !r && o && c();
    const u = o && !r && !i ? vh(o, l) : _e(0);
...
function Ah(t, e) {
    ...
    if (!Ke(t)) {
        let o = St(t);
        for (; o && !nn(o); ) {
            if (Fe(o) && !Gl(o)) return o;
            o = St(o);
        }
        return n;
    }
    let r = Sh(t, e);
    for (; r && yh(r) && Gl(r); ) r = Sh(r, e);
    return r && nn(r) && Gl(r) && !fi(r) ? n : r || bh(t) || n;
}
const nw = async function (t) {
    const e = this.getOffsetParent || Ah;
    const n = this.getDimensions;
    const r = await n(t.floating);
    return {
        reference: tw(t.reference, await e(t.floating), t.strategy),
...
const Lh = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
    items: ({ query: n }) =>
        t.filter((r) =>
        ...
        return {
            onStart: (d) => {
                ((o = d),
                    ...
                    d.clientRect && Ih(d.editor, n));
            },
            onUpdate: (d) => {
                ((o = d), (r = 0), s(), d.clientRect && Ih(d.editor, n));
            },
            onKeyDown: (d) =>
                d.event.key === "Escape"
...
const sw = class {
    constructor({
        ...
        ((this.preventHide = !1),
            ...
            (this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
                ...
                const { empty: h } = f;
                const p = !d.textBetween(c, u).length && ao(a.selection);
                const m = this.element.contains(document.activeElement);
                return !(
                    !(l.hasFocus() || m) ||
                    h ||
                    p ||
            ...
            (this.handleDebouncedUpdate = (l, a) => {
                const c = !a?.selection.eq(l.state.selection);
                const u = !a?.doc.eq(l.state.doc);
                (!c && !u) ||
    ...
    get middlewares() {
        ...
        return (
            ...
            this.floatingUIOptions.arrow &&
                t.push(Dh(this.floatingUIOptions.arrow)),
    ...
    updatePosition() {
        ...
        let e = { getBoundingClientRect: () => $u(this.view, t.from, t.to) };
        if (t instanceof K) {
            const { $anchorCell: n, $headCell: r } = t;
            const o = n ? n.pos : r.pos;
            const i = r ? r.pos : n.pos;
            const s = this.view.nodeDOM(o);
            const l = this.view.nodeDOM(i);
            if (!s || !l) return;
            const a =
                s === l
                    ? s.getBoundingClientRect()
                    : iw(s.getBoundingClientRect(), l.getBoundingClientRect());
...
const Xl = (t) =>
    new N({
        key: typeof t.pluginKey === "string" ? new L(t.pluginKey) : t.pluginKey,
        view: (e) => new sw({ view: e, ...t }),
    });
const Cv = $.create({
    name: "bubbleMenu",
    addOptions() {
...
function lw({
    ...
    return {
        ...
        async init() {
            ((y = new rd({
                ...
                Object.keys(g).forEach((b) => {
                    const x = this.$refs[`floatingToolbar::${b}`];
                    if (!x) {
        ...
        runEditorCommands({ commands: b, editorSelection: x }) {
            ...
            let C = y.chain();
            (b.forEach((S) => (C = C[S.name](...(S.arguments ?? [])))),
                C.run());
        },
        togglePanel(b = null) {

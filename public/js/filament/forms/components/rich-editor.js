...
function ba (t, e, n) {
  for (let r = 0; ; r++) {
    ...
    if (o.content.size || i.content.size) {
      const s = ba(o.content, i.content, n + 1)
      if (s != null) return s
    }
    n += o.nodeSize
  }
...
function wa (t, e, n, r) {
  for (let o = t.childCount, i = e.childCount; ;) {
    ...
    if (s.content.size || l.content.size) {
      const c = wa(s.content, l.content, n - 1, r - 1)
      if (c) return c
    }
    ((n -= a), (r -= a))
  }
...
function Nr (t, e) {
  ...
  if (n) {
    ...
    for (const r in t) if (!(r in e) || !Nr(t[r], e[r])) return !1
...
const E = class t {
  ...
  insertAt (e, n) {
    const r = ka(this.content, e + this.openStart, n)
...
function ka (t, e, n, r) {
  ...
  const l = ka(s.content, e - i - 1, n, s)
...
function va (t, e, n, r, o) {
  const i = t.depth > o && Ai(t, e, o + 1)
  const s = r.depth > o && Ai(n, r, o + 1)
  const l = []
  return (
    zn(null, t, o, l),
...
function gp (t) {
  ...
  function n (r) {
    ...
    const i = (e[r.join(',')] = new _t(r.indexOf(t.length - 1) > -1))
    for (let s = 0; s < o.length; s++) {
      const l = o[s][1].sort(Aa)
...
function Ra (t, e) {
  const n = Object.create(null)
  if (e) for (const r in e) n[r] = new Ri(t, r, e[r])
  return n
}
const Dr = class t {
  constructor (e, n, r) {
  ...
  createAndFill (e = null, n, r) {
    ...
    const i = o && o.fillBefore(v.empty, !0)
...
const fn = class {
  constructor (e) {
    ...
    for (const o in this.nodes) {
      ...
      if (
        ((i.contentMatch = r[s] || (r[s] = _t.parse(s, this.nodes))),
...
const Xe = class t {
  ...
  parse (e, n = {}) {
    const r = new Ir(this, n, !1)
    return (r.addAll(e, J.none, n.from, n.to), r.finish())
  }

  parseSlice (e, n = {}) {
    const r = new Ir(this, n, !0)
...
const un = class {
  ...
  findWrapping (e) {
    if (!this.match) {
      if (!this.type) return []
      const n = this.type.contentMatch.fillBefore(v.from(e))
...
var Ir = class {
  constructor (e, n, r) {
    ...
    const o = n.topNode
    let i
    const s = ha(null, n.preserveWhitespace, 0) | (r ? Hn : 0);
    (o
      ? (i = new un(
          o.type,
          o.attrs,
      ...
      : r
        ...
        : (i = new un(e.schema.topNodeType, null, J.none, !0, null, s)),
    (this.nodes = [i]),
  ...
  insertNode (e, n, r) {
    ...
    if (o) {
      ...
      for (const l of o.concat(e.marks)) {
        (i.type ? i.type.allowsMarkType(l.type) : ma(l.type, e.type)) &&
                    (s = l.addToSet(s))
      }
...
function Er (t, e, n, r) {
  ...
  for (let u = d; u < e.length; u++) {
    ...
    if (f === 0) {
      ...
      const { dom: h, contentDOM: p } = Er(t, f, n, r)
  ...
  _map (e, n, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        const h = a + o + (f < 0 ? 0 : d)
        if (r) return h
        const p = e == (n < 0 ? a : u) ? null : Tp(l / 3, e - a)
        let m = e == a ? $a : e == u ? Ha : Pr
        return (
          (n < 0 ? e != a : e != u) && (m |= Fa),
          new Wn(h, m, p)
        )
...
var ut = class t extends ce {
  ...
  apply (e) {
    const n = e.slice(this.from, this.to)
    const r = new E(
      Hi(n.content, (o) => o.mark(this.mark.removeFromSet(o.marks)), e),
      n.openStart,
      n.openEnd
    )
...
function $i (t, e, n, r = n.contentMatch, o = !0) {
  ...
  if (!r.validEnd) {
    const a = r.fillBefore(v.empty, !0)
...
function ft (t) {
  ...
  for (let r = t.depth, o = 0, i = 0; ; --r) {
    const s = t.$from.node(r)
    const l = t.$from.index(r) + o
    const a = t.$to.indexAfter(r) - i
...
var zi = class {
  ...
  findCloseLevel (e) {
    e: for (let n = Math.min(this.depth, e.depth); n >= 0; n--) {
      ...
      const s = Li(e, n, o, r, i)
      if (s) {
        for (let l = n - 1; l >= 0; l--) {
          const { match: a, type: c } = this.frontier[l]
          const d = Li(e, l, c, a, !0)
  ...
  closeFrontierNode () {
    const n = this.frontier.pop().match.fillBefore(v.empty, !0)
    n.childCount &&
...
const I = class {
  ...
  replace (e, n = E.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      l == 0 &&
                    Xa(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1))
    }
  }
  ...
  replaceWith (e, n) {
    ...
    for (let i = 0; i < o.length; i++) {
      ...
      i
        ? e.deleteRange(c, d)
        : (e.replaceRangeWith(c, d, n), Xa(e, r, n.isInline ? -1 : 1))
    }
  }
...
function gn (t, e, n, r, o, i = !1) {
  ...
  for (
    ...
    if (l.isAtom) {
      ...
      const a = gn(t, l, n + o, o < 0 ? l.childCount : 0, o, i)
      if (a) return a
    }
    n += l.nodeSize * o
  }
  ...
  constructor (e, n) {
    ...
    n &&
                n.forEach((r) => {
                  ...
                  r.spec.state &&
                            this.fields.push(new jt(r.key, r.spec.state, r)))
                }))
  }
}
const Fr = class t {
  ...
  static create (e) {
    const n = new Jn(e.doc ? e.doc.type.schema : e.schema, e.plugins)
    const r = new t(n)
  ...
  reconfigure (e) {
    const n = new Jn(this.schema, e.plugins)
    const r = n.fields
    const o = new t(n)
    for (let i = 0; i < r.length; i++) {
      const s = r[i].name
  ...
  static fromJSON (e, n, r) {
    ...
    const o = new Jn(e.schema, e.plugins)
    const i = new t(o)
    return (
      o.fields.forEach((s) => {
...
const Ui = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (bn(i, 'end') || L.isSelectable(i))) {
    for (let s = r.depth; ; s--) {
      const l = qn(t.doc, r.before(s), r.after(s), E.empty)
...
const Ji = (t, e, n) => {
  ...
  const i = o.nodeAfter
  if (fc(t, o, e, 1)) return !0
  if (r.parent.content.size == 0 && (bn(i, 'start') || L.isSelectable(i))) {
    const s = qn(t.doc, r.before(), r.after(), E.empty)
...
const Gi = (t, e, n) => {
  ...
  return !s || !L.isSelectable(s)
    ? !1
    : (e && e(t.tr.setSelection(L.create(t.doc, i.pos)).scrollIntoView()),
      !0)
}
function Xi (t) {
  if (!t.parent.type.spec.isolating) {
...
const es = (t, e) => {
  ...
  const i = Qi(o.parent.contentMatchAt(o.indexAfter()))
...
const Yp = (t, e) => (e && e(t.tr.setSelection(new ke(t.doc))), !0)
function Qp (t, e, n) {
  const r = e.nodeBefore
  const o = e.nodeAfter
  const i = e.index()
...
const ji = ss(Vr, Ui, Ki)
const nc = ss(Vr, Ji, Gi)
const At = {
...
function yc (t) {
  return function (e, n) {
    ...
    if (n) {
      ...
      const d = v.from(c ? t.create() : null)
      const u = new E(
...
const pt = function (t, e, n) {
  const r = fs || (fs = document.createRange())
  return (r.setEnd(t, n ?? t.nodeValue.length), r.setStart(t, e || 0), r)
}
const om = function () {
  fs = null
}
const Yt = function (t, e, n, r) {
  return n && (bc(t, e, n, r, -1) || bc(t, e, n, r, 1))
}
const im = /^(img|br|input|textarea|hr)$/i
...
const Ye = typeof navigator < 'u' ? navigator : null
const wc = typeof document < 'u' ? document : null
const It = (Ye && Ye.userAgent) || ''
const hs = /Edge\/(\d+)/.exec(It)
const Yc = /MSIE \d/.exec(It)
const ps = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(It)
const ve = !!(Yc || ps || hs)
const Rt = Yc ? document.documentMode : ps ? +ps[1] : hs ? +hs[1] : 0
const Pe = !ve && /gecko\/(\d+)/i.test(It)
Pe && +(/Firefox\/(\d+)/.exec(It) || [0, 0])[1]
const ms = !ve && /Chrome\/(\d+)/.exec(It)
const de = !!ms
const Qc = ms ? +ms[1] : 0
const we = !ve && !!Ye && /Apple Computer/.test(Ye.vendor)
const vn = we && (/Mobile\/\w+/.test(It) || (!!Ye && Ye.maxTouchPoints > 2))
const De = vn || (Ye ? /Mac/.test(Ye.platform) : !1)
const Zc = Ye ? /Win/.test(Ye.platform) : !1
const mt = /Android \d/.test(It)
const rr = !!wc && 'webkitFontSmoothing' in wc.documentElement.style
const um = rr
  ...
  if (r.nodeType == 3) {
    if (
      ...
      if (
        ...
        const c = Et(pt(r, o - 1, o - 1), -1)
        if (c.top == a.top) {
          const d = Et(pt(r, o, o + 1), -1)
    ...
    if (n <= 0) {
      ...
      return i && s && !i.border && !i.domAtom
        ...
        : {
            ...
            offset: i ? fe(i.dom) : this.contentDOM.childNodes.length
          }
    }
  }
...
const Dt = class t extends Qt {
  ...
  updateChildren (e, n) {
    ...
    const l = i && i.pos < 0
    const a = new ws(this, s && s.node, e);
    (Om(
      this.node,
      this.innerDeco,
      (c, d, u) => {
  ...
  localCompositionInfo (e, n) {
    ...
    if (this.node.inlineContent) {
      const s = i.nodeValue
      const l = Dm(this.node.content, s, r - n, o - n)
...
function Tc (t, e, n, r, o) {
  ad(r, e, t)
  const i = new Dt(void 0, t, e, n, r, r, r, o, 0)
...
var ws = class {
  ...
  syncToMarks (e, n, r) {
    ...
    for (; i < e.length;) {
      ...
      if (l > -1) {
        ...
        const a = Mn.create(this.top, e[i], n, r);
  ...
  recreateWrapper (e, n, r, o, i, s) {
    ...
    const l = Dt.create(this.top, n, r, o, i, s)
    if (l.contentDOM) {
  ...
  addNode (e, n, r, o, i) {
    const s = Dt.create(this.top, e, n, r, o, i);
  ...
  addHackNode (e, n) {
    if (
      ...
      const o = new jr(this.top, [], r, null);
      (n != this.top
        ? n.children.push(o)
...
function Lc (t, e, n) {
  ...
  if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? 'up' : 'down')) {
    const s = ks(t.state, e)
    if (s && s instanceof L) return Nt(t, s)
  }
  if (!o.parent.inlineContent) {
    const s = e < 0 ? o : i
    const l = r instanceof ke ? I.near(s, e) : I.findFrom(s, e)
    return l ? Nt(t, l) : !1
  }
  return !1
}
...
function _m (t, e) {
  ...
  if (n == 37 || (De && n == 66 && r == 'c')) {
    ...
    const o =
            n == 39 ? (Pc(t, t.state.selection.from) == 'ltr' ? 1 : -1) : 1
    return Ic(t, o, r) || xn(t, o)
  } else {
    if (n == 38 || (De && n == 80 && r == 'c')) {
...
function Is (t, e) {
  ...
  const s =
        t.someProp('clipboardSerializer') || ct.fromSchema(t.state.schema)
  const l = bd()
...
function md (t, e, n, r, o) {
  if (o < t.length && o < e.length && t[o] == e[o]) {
    const i = md(t, e, n, r.lastChild, o + 1)
...
function gd (t, e) {
  if (e == 0) return t
  const n = t.content.replaceChild(t.childCount - 1, gd(t.lastChild, e - 1))
  const r = t.contentMatchAt(t.childCount).fillBefore(v.empty, !0)
...
const Se = {}
const Ce = {}
const Gm = { touchstart: !0, touchmove: !0 }
const vs = class {
  constructor () {
    ((this.shiftKey = !1),
    (this.mouseDown = null),
...
function cg (t) {
  ...
  const n = sm(e.focusNode, e.focusOffset)
  const r = lm(e.focusNode, e.focusOffset)
  if (n && r && n != r) {
...
const Qn = (ve && Rt < 15) || (vn && um < 604)
Se.copy = Ce.cut = (t, e) => {
  const n = e
  const r = t.state.selection
  const o = n.type == 'cut'
  if (r.empty) return
  const i = Qn ? null : n.clipboardData
  const s = r.content()
  const { dom: l, text: a } = Is(t, s);
  (i
    ? (n.preventDefault(),
      i.clearData(),
...
function Zn (t, e, n, r, o) {
  const i = hd(t, e, n, r, t.state.selection.$from)
...
Ce.paste = (t, e) => {
  ...
  const r = Qn ? null : n.clipboardData
  const o = t.input.shiftKey && t.input.lastKeyCode != 45
...
Se.dragstart = (t, e) => {
  ...
  const i = o.empty ? null : t.posAtCoords(Zr(n))
  let s
  if (
  ...
  const { dom: a, text: c, slice: d } = Is(t, l);
...
function mg (t, e, n) {
  ...
  const c = a.mapping.map(l)
  const d = i.openStart == 0 && i.openEnd == 0 && i.content.childCount == 1
  const u = a.doc
  if (
    (d
...
const Jt = class t {
  ...
  eq (e) {
    return (
      this == e ||
            (e instanceof t && er(this.attrs, e.attrs) && er(this.spec, e.spec))
    )
  }
...
const Y = class t {
  constructor (e, n) {
    ((this.local = e.length ? e : kn), (this.children = n.length ? n : kn))
  }
    ...
    e.forEach((l, a) => {
      ...
      if ((d = Td(n, l, c))) {
        ...
        (o[i] == a
          ...
          : o.splice(i, 0, a, a + l.nodeSize, Yr(d, l, c + 1, Gt)),
        (i += 3))
      }
    })
    const s = Md(i ? Ad(n) : n, -r)
    for (let l = 0; l < s.length; l++) {
...
var Xr = class t {
  ...
  map (e, n) {
    const r = this.members.map((o) => o.map(e, n, Gt))
    return t.from(r)
  }
  ...
  forChild (e, n) {
    ...
    for (let o = 0; o < this.members.length; o++) {
      ...
      i != be && (i instanceof t ? (r = r.concat(i.members)) : r.push(i))
    }
    return t.from(r)
  }
...
function Yr (t, e, n, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      i = !0
      const d = Yr(c, l, n + a + 1, r)
      d != be && o.push(a, a + l.nodeSize, d)
    }
  })
  const s = Md(i ? Ad(t) : t, -n).sort(Xt)
  for (let l = 0; l < s.length; l++) {
...
const Ns = class {
  ...
  onSelectionChange () {
    if (Dc(this.view)) {
      ...
      if (ve && Rt <= 11 && !this.view.state.selection.empty) {
        ...
        if (
          e.focusNode &&
                    Yt(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
        ) {
  ...
  registerMutation (e, n) {
    ...
    if (e.type == 'childList') {
      ...
      const s = o && o.parentNode == e.target ? fe(o) + 1 : 0
...
function Cg (t, e, n) {
  ...
  const u = t.state.doc
  const f = t.someProp('domParser') || Xe.fromSchema(t.state.schema)
  const h = u.resolve(s)
  let p = null
  const m = f.parse(r, {
    topNode: h.parent,
...
function Tg (t, e, n, r, o) {
  ...
  if (((t.input.compositionPendingChanges = 0), e < 0)) {
    ...
    if (O && !t.state.selection.eq(O)) {
      ...
      const T = t.state.tr.setSelection(O);
      (k == 'pointer'
        ? T.setMeta('pointer', !0)
  ...
  if (!p) {
    if (
      ...
      if (c.sel) {
        const k = jc(t, t.state.doc, c.sel)
        if (k && !k.eq(t.state.selection)) {
          const O = t.state.tr.setSelection(k);
  ...
  const w = m.sameParent(g) && m.parent.inlineContent && y.end() >= p.endA
  if (
    ((vn &&
  ...
  if (w) {
    if (m.pos == g.pos) {
      ve &&
                ...
                setTimeout(() => gt(t), 20))
      const k = x(t.state.tr.delete(b, C))
      const O = d.resolve(p.start).marksAcross(d.resolve(p.endA));
      ...
      const k = m.parent.textBetween(m.parentOffset, g.parentOffset)
      const O = () => x(t.state.tr.insertText(k, b, C))
...
const Dg = typeof navigator < 'u' && /Mac/.test(navigator.platform)
const Ig =
    typeof navigator < 'u' &&
...
const Hg = Object.defineProperty
const js = (t, e) => {
  for (const n in e) Hg(t, n, { get: e[n], enumerable: !0 })
}
function co (t) {
...
function Ks (t, e, n) {
  ...
  for (
    ;
    a < t.parent.childCount && Od([...t.parent.child(a).marks], e, n);
  ) {
...
var ey =
    (t = null, e = {}) =>
      ({ editor: n, view: r, tr: o, dispatch: i }) => {
        ...
        const l = Fd(o.doc, t) || n.state.selection
...
var ty = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o }))
var ny =
    (t, e) =>
      ({ tr: n, commands: r }) =>
      ...
      ({ tr: r, dispatch: o, editor: i }) => {
        ...
        if (o) {
          ...
          if (f) {
            ...
            const y = g.node()
            const w = g.parentOffset === 0
            const b = y.isText || y.isTextblock
            const C = y.content.size > 0;
...
var dy =
    () =>
      ({ state: t, dispatch: e, tr: n }) => {
        try {
          const r = Wt(t.doc, t.selection.$from.pos, -1)
...
var xy =
    (t, e) =>
      ({ tr: n, state: r, dispatch: o }) => {
        let i = null
        let s = null
        const l = ho(typeof t === 'string' ? t : t.name, r.schema)
        if (!l) return !1;
...
function Kd (t) {
  const e = []
  const { nodeExtensions: n, markExtensions: r } = An(t)
  const o = [...n, ...r]
  const i = {
    default: null,
    validate: void 0,
...
function Ry (t, e) {
  let n
  const r = Kd(t)
  const { nodeExtensions: o, markExtensions: i } = An(t)
  ...
  const l = Object.fromEntries(
    o.map((c) => {
      ...
      const f = t.reduce((y, w) => {
        const b = B(w, 'extendNodeSchema', u)
        return { ...y, ...(b ? b(c) : {}) }
      }, {})
      const h = Id({
        ...f,
  ...
  const a = Object.fromEntries(
    i.map((c) => {
      ...
      const f = t.reduce((g, y) => {
        const w = B(y, 'extendMarkSchema', u)
        return { ...g, ...(w ? w(c) : {}) }
      }, {})
      const h = Id({
        ...f,
      ...
      return (
        m &&
                    (h.toDOM = (g) => m({ mark: g, HTMLAttributes: ao(g, d) })),
        [c.name, h]
      )
    })
  )
...
function Zs (t, e) {
  const n = ho(typeof e === 'string' ? e : e.name, t.schema)
  ...
  if (
    (o.forEach(({ $from: u, $to: f }) => {
      ...
      t.doc.nodesBetween(h, p, (m, g) => {
        ...
        const w = Math.min(p, g + m.nodeSize)
        const b = w - y;
        ((s += b),
        l.push(
...
const Yd = (t, e) => {
  ...
  if (e) {
    const i = et((l) => l.type.name === e)(t.selection)
    if (!i) return !1
...
var jy =
    (t) =>
      ({ tr: e, dispatch: n }) => {
        if (n) {
          const { doc: r } = e
          const o = bt(t, 0, r.content.size)
          const i = L.create(r, o)
          e.setSelection(i)
        }
        return !0
      }
    ...
    (t) =>
      ({ tr: e, dispatch: n }) => {
        if (n) {
          ...
          const s = D.atStart(r).from
          const l = D.atEnd(r).to
          const a = bt(o, s, l)
          const c = bt(i, s, l)
          const d = D.create(r, a, c)
          e.setSelection(d)
        }
        return !0
      }
...
var Jy =
    ({ keepMarks: t = !0 } = {}) =>
      ({ tr: e, state: n, dispatch: r, editor: o }) => {
        ...
        const d = so(c, l.node().type.name, l.node().attrs)
        ...
        let p = Ee(e.doc, e.mapping.map(l.pos), 1, h)
        if (
          (!h &&
                !p &&
                Ee(
...
var Gy =
    (t, e = {}) =>
      ({ tr: n, state: r, dispatch: o, editor: i }) => {
        ...
        const p = { ...so(f, u.type.name, u.attrs), ...e }
        const m = { ...so(f, a.node().type.name, a.node().attrs), ...e }
        ...
        if (o) {
          const { selection: y, storedMarks: w } = r
          const { splittableMarks: b } = i.extensionManager
          const C = w || (y.$to.parentOffset && y.$from.marks())
          if ((n.split(a.pos, 2, g).scrollIntoView(), !C || !o)) {
            return !0
          }
          const x = C.filter((S) => b.includes(S.type.name))
          n.ensureMarks(x)
        }
        return !0
      }
const Fs = (t, e) => {
  const n = et((s) => s.type === e)(t.selection)
  if (!n) return !0
  const r = t.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth)
  if (r === void 0) return !0
  const o = t.doc.nodeAt(r)
  return (n.node.type === o?.type && Re(t.doc, n.pos) && t.join(n.pos), !0)
}
const Vs = (t, e) => {
  const n = et((s) => s.type === e)(t.selection)
  if (!n) return !0
...
var Xy =
    (t, e, n, r = {}) =>
      ({
        ...
        const h = ne(t, s.schema)
        const p = ne(e, s.schema)
        const { selection: m, storedMarks: g } = s
        const { $from: y, $to: w } = m
        const b = y.blockRange(w)
        const C = g || (m.$to.parentOffset && m.$from.marks())
        if (!b) return !1
        const x = et((S) => Bd(S.type.name, u))(m)
        ...
        return !n || !C || !l
          ...
          : a()
            .command(() => {
              ...
              const k = C.filter((O) => f.includes(O.type.name))
...
var Qy =
    (t, e, n = {}) =>
      ({ state: r, commands: o }) => {
        const i = ne(t, r.schema)
        const s = ne(e, r.schema)
        const l = Ze(r, i, n)
        let a
        return (
...
function ro (t) {
  ...
  return (
    s.forEach((f) => {
      ...
      if (!h) return
      const p = a.state.tr
      const m = co({ state: a.state, transaction: p })
...
function pb (t) {
  ...
  const { commands: a, chain: c, can: d } = new uo({ editor: e, state: n })
  const u = []
  return (
...
function gb (t) {
  ...
  const a = ({ state: d, from: u, to: f, rule: h, pasteEvt: p }) => {
    const m = d.tr
    const g = co({ state: d, transaction: m })
    if (
      !(
        !pb({
          editor: e,
    ...
    (d) =>
      new P({
        ...
        appendTransaction: (u, f, h) => {
          ...
          const b = f.doc.content.findDiffStart(h.doc.content)
...
const yo = class {
  ...
  get nodeViews () {
    const { editor: t } = this
    const { nodeExtensions: e } = An(this.extensions)
    return Object.fromEntries(
      e
  ...
  get markViews () {
    const { editor: t } = this
    const { markExtensions: e } = An(this.extensions)
    return Object.fromEntries(
      e
    ...
    const i = () => {
      ...
      d.steps.forEach((h, p) => {
        ...
        if (h instanceof ut) {
          ...
          const w = f.slice(p).map(h.to)
          const b = f.invert().map(y, -1)
          const C = f.invert().map(w)
          const x =
    ...
    return [
      new P({
        ...
        appendTransaction: (t, e, n) => {
          ...
          const f = n.tr
          const h = co({ state: n, transaction: f })
          const { commands: p } = new uo({
            editor: this.editor,
            state: h
          })
  ...
  get children () {
    ...
    return (
      this.node.content.forEach((n, r) => {
        ...
        const a = new Tn(l, this.editor, o, o ? n : null);
...
const gu = class extends lb {
  constructor (t = {}) {
    ...
    const n = Fd(e, this.options.autofocus);
...
function Be (t) {
  return new go({
    ...
    handler: ({ state: e, range: n, match: r }) => {
      const o = G(t.getAttributes, void 0, r)
...
function ar (t) {
  return new go({
    ...
    handler: ({ state: e, range: n, match: r }) => {
      ...
      const i = G(t.getAttributes, void 0, r) || {}
      if (
        !o
          .node(-1)
        ...
        for (k.lastIndex = 0; ;) {
          ...
          if (!((p = T[2]) != null && p.endsWith(':::'))) {
            if ($) C += 1
              ...
              const z = O.slice(0, A)
              S = z.trim()
              const K = u.slice(0, x + A + T[0].length)
              let V = []
              if (S) {
                if (l === 'block') {
                  for (
  ...
  const d = (f) => {
    ...
    return (
      a.forEach((p) => {
        ...
        const g = typeof p === 'string' ? void 0 : p.skipIfDefault
        if (m in f) {
          const y = f[m]
...
`
    ...
    for (d += 1; d < l.length;) {
      const x = l[d]
      if (x.trim() === '') {
        const k = l.slice(d + 1).findIndex((A) => A.trim() !== '')
        if (k === -1) break
        if (
          (((o =
...
`),
    ...
    const b = y.slice(1)
    if (b.length > 0) {
      const x = b.map((S) => S.slice(m + u)).join(`
`)
      x.trim() &&
...
function Me (t) {
  return new fb({
    ...
    handler: ({ state: e, range: n, match: r, pasteEvent: o }) => {
      const i = G(t.getAttributes, void 0, r, o)
...
function xo (t, e) {
  ...
  return function (r, o, i) {
    ...
    const c = ae.findGapCursorFrom(l, e, a)
...
const tn = class t {
        ...
        (u, f) => {
          ...
          if (o) {
            ...
            (h &&
                            ...
                            c.push(
                              new nt(p, void 0, void 0, c.length + d.length)
                            )),
            i--,
            p && o.appendMap(p, i))
  ...
  addTransform (e, n, r, o) {
    ...
    for (let d = 0; d < e.steps.length; d++) {
      ...
      let f = new nt(e.mapping.maps[d], u, n)
      let h;
      ((h = a && a.merge(f)) &&
    ...
    const c = s - r.depth
    return (c > zb && ((l = Bb(l, c)), (s -= c)), new t(l.append(i), s))
  }
    ...
    const a =
            ...
            (!s &&
                ...
                (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                    !$b(n, t.prevRanges)))
    const c = s ? al(t.prevRanges, n.mapping) : Mu(n.mapping.maps)
    return new rt(
      t.done.addTransform(
        n,
...
function Fb (t, e, n) {
  ...
  const a = new rt(n ? l : i.remaining, n ? i.remaining : l, null, 0, -1)
  return i.transform
    .setSelection(s)
        ...
        props: {
          decorations (n) {
            return n.selection.empty ||
              ...
              ? null
              : Y.create(n.doc, [
                te.inline(n.selection.from, n.selection.to, {
                  class: e.className
                })
              ])
          }
...
const jb = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/
const Ub = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g
const Kb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/
const qb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g
const Jb = ee.create({
  name: 'bold',
  addOptions () {
    return { HTMLAttributes: {} }
  ...
  addKeyboardShortcuts () {
    return {
      ...
      Tab: ({ editor: t }) => {
        ...
        const n = (e = this.options.tabSize) != null ? e : hl
        const { state: r } = t
        const { selection: o } = r
...
const vo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null
const t0 = (t, e, n) => {
  for (let r = t.depth; r > 0; r -= 1) {
    const o = t.node(r)
    const i = e(o)
    const s = vo(t.start(r), n)
    if (i && s) {
      return {
...
const zu = (t, e) => {
  ...
  const d = et((y) => y.type === i.nodes.details)(s)
  if (!d) return !1
  const u = En(d.node, (y) => y.type === i.nodes.detailsContent)
  if (!u.length || vo(d.start + u[0].pos + 1, t)) return !1
  const h = n.doc.resolve(d.pos + d.node.nodeSize)
  const p = ae.findFrom(h, 1, !1)
  if (!p) return !1
  const { tr: m } = n
  const g = new ae(p)
...
const Hu = F.create({
  ...
  addNodeView () {
    return ({ editor: t, getPos: e, node: n, HTMLAttributes: r }) => {
      ...
      const i = R(this.options.HTMLAttributes, r, {
        'data-type': this.name
      })
      ...
      unsetDetails:
                () =>
                  ({ state: t, chain: e }) => {
                    ...
                    const o = et((y) => y.type === this.type)(n)
                    if (!o) return !1
                    const i = En(
                      o.node,
...
const $u = F.create({
  ...
  addNodeView () {
    return ({ HTMLAttributes: t }) => {
      const e = document.createElement('div')
      const n = R(this.options.HTMLAttributes, t, {
        'data-type': this.name,
        hidden: 'hidden'
      })
      return (
  ...
  addKeyboardShortcuts () {
    return {
      Enter: ({ editor: t }) => {
        ...
        const y = o.node(-3)
        if (!y) return !1
        const w = o.indexAfter(-3)
        const b = sr(y.contentMatchAt(w))
        if (!b || !y.canReplaceWith(w, w, b)) return !1
        const C = b.createAndFill()
        if (!C) return !1
        const { tr: x } = e
        const S = o.after(-2)
        x.replaceWith(S, S, C)
        const k = x.doc.resolve(S)
        const O = I.near(k, 1)
        x.setSelection(O)
        const T = m
        const A = m + p.nodeSize
        return (x.delete(T, A), x.scrollIntoView(), n.dispatch(x), !0)
      }
    }
  },
...
const a0 = F.create({
  ...
  addInputRules () {
    return [bo({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type })]
  }
})
const qu = a0
const c0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/
const d0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g
const u0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/
const f0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g
const h0 = ee.create({
  name: 'italic',
  addOptions () {
    return { HTMLAttributes: {} }
...
const kl = 'ascii'
const Sl = 'alpha'
const fr = 'asciinumeric'
const ur = 'alphanumeric'
const Cl = 'domain'
const of = 'emoji'
const b0 = 'scheme'
const w0 = 'slashscheme'
const pl = 'whitespace'
function x0 (t, e) {
    ...
    if (
      ...
      if (r) {
        if (s.t && typeof s.t === 'string') {
          const a = Object.assign(k0(s.t, r), n)
          nn(i, a, r)
        } else n && nn(i, n, r)
      }
      s.t = i
...
const j = (t, e, n, r, o) => t.ta(e, n, r, o)
const re = (t, e, n, r, o) => t.tr(e, n, r, o)
const Qu = (t, e, n, r, o) => t.ts(e, n, r, o)
const M = (t, e, n, r, o) => t.tt(e, n, r, o)
const St = 'WORD'
const vl = 'UWORD'
const sf = 'ASCIINUMERICAL'
const lf = 'ALPHANUMERICAL'
const br = 'LOCALHOST'
const Ml = 'TLD'
const Tl = 'UTLD'
const Eo = 'SCHEME'
const On = 'SLASH_SCHEME'
const El = 'NUM'
const Al = 'WS'
const Nl = 'NL'
const hr = 'OPENBRACE'
const pr = 'CLOSEBRACE'
const No = 'OPENBRACKET'
const Oo = 'CLOSEBRACKET'
const Ro = 'OPENPAREN'
const Do = 'CLOSEPAREN'
const Io = 'OPENANGLEBRACKET'
const Po = 'CLOSEANGLEBRACKET'
const Lo = 'FULLWIDTHLEFTPAREN'
const Bo = 'FULLWIDTHRIGHTPAREN'
const zo = 'LEFTCORNERBRACKET'
const Ho = 'RIGHTCORNERBRACKET'
const $o = 'LEFTWHITECORNERBRACKET'
const Fo = 'RIGHTWHITECORNERBRACKET'
const Vo = 'FULLWIDTHLESSTHAN'
const _o = 'FULLWIDTHGREATERTHAN'
const Wo = 'AMPERSAND'
const jo = 'APOSTROPHE'
const Uo = 'ASTERISK'
const Lt = 'AT'
...
function v0 (t = []) {
  ...
  M(n, '\\', Ko),
  M(n, '\u30FB', af))
  const r = re(n, kt, El, { [xl]: !0 })
  re(r, kt, r)
  const o = re(r, xt, sf, { [fr]: !0 })
  const i = re(r, dr, lf, { [ur]: !0 })
  const s = re(n, xt, St, { [kl]: !0 });
  (re(s, kt, o), re(s, xt, s), re(o, kt, o), re(o, xt, o))
  const l = re(n, dr, vl, { [Sl]: !0 });
  (re(l, xt),
  re(l, kt, i),
  re(l, dr, l),
  re(i, kt, i),
  re(i, xt),
  re(i, dr, i))
  const a = M(n, yl, Nl, { [pl]: !0 })
  const c = M(n, Zu, Al, { [pl]: !0 })
  const d = re(n, gl, Al, { [pl]: !0 });
  (M(n, bl, d),
  M(c, yl, a),
  M(c, bl, d),
  re(c, gl, d),
...
function uf (t, e) {
  const n = M0(e.replace(/[A-Z]/g, (l) => l.toLowerCase()))
  const r = n.length
  const o = []
  let i = 0
  let s = 0
...
const Bl = '[\0- \xA0\u1680\u180E\u2000-\u2029\u205F\u3000]'
const D0 = new RegExp(Bl)
const I0 = new RegExp(`${Bl}$`)
const P0 = new RegExp(Bl, 'g')
function L0 (t) {
  return t.length === 1
    ? t[0].isLink
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (
        (el(l).forEach(({ newRange: c }) => {
          const d = jd(r.doc, c, (h) => h.isTextblock)
          let u
          let f
          if (d.length > 1) {
            ((u = d[0]),
          ...
          if (u && f) {
            const h = f.split(D0).filter(Boolean)
    ...
    props: {
      handleClick: (e, n, r) => {
        ...
        if (
          ...
          if (!l) return s
          const a = Zs(e.state, t.type.name)
          const c = (o = l?.href) != null ? o : a.href
          const d = (i = l?.target) != null ? i : a.target
  ...
  return new P({
    ...
    props: {
      handlePaste: (e, n, r) => {
        ...
        const c = oi(a, { defaultProtocol: t.defaultProtocol }).find(
                ...
                (t) =>
                  ({ chain: e }) => {
                    ...
                    return this.options.isAllowedUri(n, {
                      defaultValidate: (r) => !!rn(r, this.options.protocols),
                      protocols: this.options.protocols,
                      defaultProtocol: this.options.defaultProtocol
                    })
                      ? e()
...
const pf = $0
const F0 = Object.defineProperty
const V0 = (t, e) => {
  for (const n in e) F0(t, n, { get: e[n], enumerable: !0 })
}
const _0 = 'listItem'
const mf = 'textStyle'
const gf = /^\s*([-+*])\s$/
...
function ew (t) {
  ...
  const w = new RegExp(`^[${i?.join('')}\0]?$`).test(y)
...
function nw ({
  ...
  const w = () => {
    ...
    const k = e.view.coordsAtPos(S)
    const { top: O, right: T, bottom: A, left: $ } = k
    try {
  ...
  const b = (S, k) =>
    k
      ? () => {
          const O = t.getState(e.state)
          const T = O?.decorationId
          const A = S.dom.querySelector(`[data-decoration-id="${T}"]`)
  ...
  function C (S, k) {
    let O
    try {
      const A = t.getState(S.state)
      const $ = A?.decorationId
        ? S.dom.querySelector(
    ...
    const T = S.state.tr.setMeta(k, { exit: !0 })
    S.dispatch(T)
  }
  const x = new P({
    key: t,
    view () {
      return {
        update: async (S, k) => {
          let O, T, A, $, z, K, V
          const N = (O = this.key) == null ? void 0 : O.getState(k)
          const _ =
                        (T = this.key) == null ? void 0 : T.getState(S.state)
          const W =
                        N.active && _.active && N.range.from !== _.range.from
          const Q = !N.active && _.active
          const me = N.active && !_.active
          const Ge = !Q && !me && N.query !== _.query
          const q = Q || (W && Ge)
          const We = Ge || W
          const je = me || (W && Ge)
          if (!q && !We && !je) return
          const dn = je && !q ? N : _
          const aa = S.dom.querySelector(
    ...
    state: {
      ...
      apply (S, k, O, T) {
        const { isEditable: A } = e
        const { composing: $ } = e.view
        const { selection: z } = S
        const { empty: K, from: V } = z
        const N = { ...k }
        const _ = S.getMeta(t)
        if (_ && _.exit) {
          return (
        ...
        if (((N.composing = $), A && (K || e.view.composing))) {
          ...
          const Q = `id_${Math.floor(Math.random() * 4294967295)}`
          W &&
                    p({
                      editor: e,
                      state: T,
    ...
    props: {
      handleKeyDown (S, k) {
        let O, T, A, $
        const { active: z, range: K } = x.getState(S.state)
        if (!z) return !1
        if (k.key === 'Escape' || k.key === 'Esc') {
          const N = x.getState(S.state)
          const _ = (O = g?.decorationNode) != null ? O : null
          const W =
                        _ ??
                        (N?.decorationId
                          ? S.dom.querySelector(
...
const Ef = F.create({
  ...
  renderHTML ({ node: t, HTMLAttributes: e }) {
    ...
    return typeof o === 'string'
      ? [
          'span',
          R({ 'data-type': this.name }, this.options.HTMLAttributes, e),
          o
        ]
      : o
  },
...
const Wl = ['top', 'right', 'bottom', 'left']
const Nf = ['start', 'end']
const jl = Wl.reduce(
  (t, e) => t.concat(e, e + '-' + Nf[0], e + '-' + Nf[1]),
  []
)
const $e = Math.min
const pe = Math.max
const Cr = Math.round
const Ue = (t) => ({ x: t, y: t })
const ow = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' }
const iw = { start: 'end', end: 'start' }
function li (t, e, n) {
  return pe(t, $e(e, n))
}
function st (t, e) {
...
async function on (t, e) {
  ...
  const w =
        u === 'floating'
          ...
          : s.reference
  const b = await (i.getOffsetParent == null
    ? void 0
    : i.getOffsetParent(l.floating))
  const C = (await (i.isElement == null ? void 0 : i.isElement(b)))
...
const Hf = (t) => ({
  ...
  async fn (e) {
    ...
    const { element: c, padding: d = 0 } = st(t, e) || {}
    if (c == null) return {}
    const u = di(d)
    const f = { x: n, y: r }
    const h = ci(o)
    ...
    const g = h === 'y'
    const y = g ? 'top' : 'left'
    const w = g ? 'bottom' : 'right'
    const b = g ? 'clientHeight' : 'clientWidth'
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const m = u !== void 0 || f === jl ? uw(u || null, h, f) : f
        const g = await on(e, p)
        const y =
        ...
        const T =
                    ((o = k.filter((A) =>
                      A[2].slice(0, Fe(A[0]) ? 2 : 3).every(($) => $ <= 0)
                    )[0]) == null
                      ? void 0
                      : o[0]) || k[0][0]
        return T !== l
    ...
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const C = await (a.isRTL == null
          ? void 0
          : a.isRTL(c.floating))
        const x = f || (b || !m ? [Sr(l)] : Df(l))
        const S = p !== 'none'
        !f && S && x.push(...If(l, m, p, C))
        const k = [l, ...x]
        const O = await on(e, g)
        const T = []
          ...
          if (
            N &&
                        (!(u === 'alignment' ? w !== Ke(N) : !1) ||
                            A.every((Q) =>
                              Ke(Q.placement) === w ? Q.overflows[0] > 0 : !0
                            ))
          ) {
            return {
                ...
                const W =
                                    (K = A.filter((Q) => {
                                      ...
                                      .map((Q) => [
                                        ...
                                        Q.overflows
                                          .filter((me) => me > 0)
                                          .reduce((me, Ge) => me + Ge, 0)
                                      ])
                                      .sort((Q, me) => Q[1] - me[1])[0]) ==
                                    null
                                      ? void 0
                                      : K[0]
                W && (_ = W)
...
const Vf = function (t) {
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        const { rects: n } = e
        const { strategy: r = 'referenceHidden', ...o } = st(t, e)
        switch (r) {
          ...
          case 'escaped': {
            const i = await on(e, { ...o, altBoundary: !0 })
            const s = Lf(i, n.floating)
...
function _f (t) {
  const e = $e(...t.map((i) => i.left))
  const n = $e(...t.map((i) => i.top))
  const r = pe(...t.map((i) => i.right))
  const o = pe(...t.map((i) => i.bottom))
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const { padding: l = 2, x: a, y: c } = st(t, e)
        const d = Array.from(
        ...
        function p () {
          ...
          if (u.length >= 2) {
            if (Ke(n) === 'y') {
              ...
              const K = A.top
              const V = $.bottom
              const N = z ? A.left : $.left
              const _ = z ? A.right : $.right
              const W = _ - N
              const Q = V - K
              return {
                top: K,
            ...
            const g = Ne(n) === 'left'
            const y = pe(...u.map((A) => A.right))
            const w = $e(...u.map((A) => A.left))
            const b = u.filter((A) =>
              g ? A.left === w : A.right === y
            )
            const C = b[0].top
            const x = b[b.length - 1].bottom
            const S = w
            const k = y
            const O = k - S
            const T = x - C
  ...
  return (
    t === void 0 && (t = {}),
    {
      ...
      async fn (e) {
        ...
        const { apply: a = () => {}, ...c } = st(t, e)
        const d = await on(e, c)
        const u = Ne(o)
        const f = Fe(o)
        const h = Ke(o) === 'y'
        ...
        const w = m - d.top - d.bottom
        const b = p - d.left - d.right
        const C = $e(m - d[g], w)
        const x = $e(p - d[y], b)
...
const bw = ['transform', 'translate', 'scale', 'rotate', 'perspective']
const ww = [
  'transform',
  'translate',
  'scale',
...
const xw = ['paint', 'layout', 'strict', 'content']
function hi (t) {
  const e = pi()
  const n = Ve(t) ? _e(t) : t
  return (
...
function vt (t) {
  ...
  const e = t.assignedSlot || t.parentNode || (qf(t) && t.host) || lt(t)
...
function Dn (t) {
  ...
  let s = (i ? Cr(n.width) : n.width) / r
  let l = (i ? Cr(n.height) : n.height) / o
  return (
...
function Tr (t, e, n, r) {
  ...
  if (i) {
    ...
    for (; m && r && h !== p;) {
      ...
      const w = _e(m)
      const b = y.left + (m.clientLeft + parseFloat(w.paddingLeft)) * g.x
      const C = y.top + (m.clientTop + parseFloat(w.paddingTop)) * g.y;
      ((a *= g.x),
      (c *= g.y),
      (d *= g.x),
      (u *= g.y),
...
function oh (t, e) {
  ...
  const r = n.left + e.scrollLeft - gi(t, n)
...
function Tw (t) {
  ...
  const o = pe(e.scrollWidth, e.clientWidth, r.scrollWidth, r.clientWidth)
  const i = pe(
    e.scrollHeight,
    e.clientHeight,
    r.scrollHeight,
...
const Pw = async function (t) {
  const e = this.getOffsetParent || sh
  ...
  return {
    items: async ({ query: l }) => {
      if (typeof t === 'function') {
        ...
        try {
          const c = t({ query: l })
          const d = Array.isArray(c) ? c : await c
    ...
    render: () => {
      ...
      const f = () => {
        ...
        if (b.length) {
          b.forEach((x, S) => {
            ...
            const O = typeof x === 'object' ? (x?.id ?? k) : k
      ...
      const w = () => {
        ...
        const S = typeof C === 'object' ? (C?.id ?? x) : x
        p(S, x)
      }
      return {
        onStart: (b) => {
...
const zw = function ({
  ...
  return {
    ...
    allow: ({ state: s, range: l }) => {
      const a = s.doc.resolve(l.from)
      const c = s.schema.nodes[n]
...
const mh = F.create({
  ...
  renderHTML ({ node: t, HTMLAttributes: e }) {
    const n = this.editor?.extensionStorage?.[
      this.name
  ...
  addProseMirrorPlugins () {
    const t = async (e) => {
      ...
      const i = this.options.getMentionLabelsUsing
      if (typeof i === 'function') {
        try {
          const s = o.map(({ id: a, char: c }) => ({
            id: a,
            char: c
          }))
          const l = await i(s)
          o.forEach(({ id: a, pos: c }) => {
            const d = l[a]
            if (!d) return
            const u = e.state.doc.nodeAt(c)
            if (!u || u.type.name !== this.name) return
            const f = { ...u.attrs, label: d }
            const h = e.state.tr.setNodeMarkup(c, void 0, f)
            r(h)
          })
        } catch {}
      }
    ...
    const t = (n) =>
      Array.isArray(n)
        ...
        : n && typeof n === 'object'
          ...
          : []
    const e = this.options.suggestions.length
      ? this.options.suggestions
      : [this.options.suggestion];
    ((this.storage.suggestions = e.map((n) => {
      const r = n?.char ?? '@'
      const o = n?.items ?? []
      const i = n?.noOptionsMessage ?? null
      const s = n?.noSearchResultsMessage ?? null
      const l = n?.isSearchable ?? !1
      const a = this.options.getMentionSearchResultsUsing
      let c = n
      if (typeof n?.items === 'function') {
        ...
        const d = n?.extraAttributes
        const u = n?.searchPrompt ?? null
        const f = n?.searchingMessage ?? null
        c = {
          ...ph({
            items: async ({ query: h }) => {
              if (
...
function jw (t) {
  ...
  for (let c = 0, d = 0; c < n; c++) {
    ...
    for (let p = 0; ; p++) {
      ...
      const m = u.child(p)
      const { colspan: g, rowspan: y, colwidth: w } = m.attrs
      for (let b = 0; b < y; b++) {
        if (b + c >= n) {
          (i || (i = [])).push({
...
function ox (t, e, n, r) {
  ...
  for (let a = 0, c = n + 1; a < o.height; a++) {
    ...
    if (f > 0) {
      ...
      const p = []
      for (let g = 0; g < f; g++) {
        const y = xe(t.schema)[h].createAndFill()
        y && p.push(y)
      }
...
function sx (t, e, n) {
  let r
  const o = xe(e.type.schema).header_cell
    ...
    e.useDeprecatedLogic
      ...
      : function (n, r) {
        ...
        if (r) {
          ...
          const s = n.tr
          const l = Ch('row', i, o)
          const a = Ch('column', i, o)
          const c = (t === 'column' ? l : t === 'row' && a) ? 1 : 0
          const d =
                          t == 'column'
                            ? {
                                left: 0,
          ...
          (i.map.cellsInRect(d).forEach((f) => {
            const h = f + i.tableStart
            const p = s.doc.nodeAt(h)
...
const cM = Bn('row', { useDeprecatedLogic: !0 })
const dM = Bn('column', { useDeprecatedLogic: !0 })
const jh = Bn('cell', { useDeprecatedLogic: !0 })
function ux (t, e) {
  if (e < 0) {
...
function yi (t, e) {
  ...
  if (e) {
    const r = t.tr
    const o = xe(t.schema).cell.createAndFill().content;
    (n.forEachCell((i, s) => {
      i.content.eq(o) ||
                r.replace(
                  r.mapping.map(s + 1),
...
function hx (t, e) {
  ...
  for (let o = 0; o < n.length; o++) {
    if ((o >= e.length && e.push(v.empty), n[o] < r)) {
      const i = xe(t).cell.createAndFill()
      const s = []
...
function mx (t, e, n, r, o, i, s) {
  ...
  if (i > e.height) {
    ...
    const f = a.row.create(null, v.from(u))
    const h = []
...
function wi (t, e) {
  return (n, r, o) => {
    ...
    const l = Rh(s.$headCell, t, e)
    return l ? xi(n, r, new X(s.$anchorCell, l)) : !1
  }
}
function yx (t, e) {
  const n = t.state.doc
  const r = an(n.resolve(e))
...
const Oe = new H('tableColumnResizing')
function qh ({
  handleWidth: t = 5,
  cellMinWidth: e = 25,
      ...
      init (s, l) {
        ...
        const c =
                    ...
                    a === void 0
                      ? void 0
                      : a.nodeViews
        const d = xe(l.schema).table.name
        return (
...
function vx (t, e, n, r) {
  ...
  const a = Mx(t, s.activeHandle, l.attrs)
  t.dispatch(
...
function Eh (t, e, n, r) {
  ...
  if (!i) return -1
  const { pos: s } = i
  const l = an(t.state.doc.resolve(s))
  if (!l) return -1
  if (n == 'right') return l.pos
  const a = oe.get(l.node(-1))
  const c = l.start(-1)
...
function Ax (t, e, n) {
  ...
  for (let c = 0; c < i.height; c++) {
    ...
    const p = f.colwidth ? f.colwidth.slice() : Ex(f.colspan);
...
function Oh (t, e, n, r) {
  ...
  const i = o.node(-1)
  const s = o.start(-1)
  const l = oe.get(i).colCount(o.pos - s) + o.nodeAfter.attrs.colspan - 1
...
function Nx (t, e) {
  ...
  for (let c = 0; c < i.height; c++) {
    ...
    if (
      ...
      var a
      const u = i.map[d]
      const f = s + u + o.nodeAt(u).nodeSize - 1
...
const Ci = ({ editor: t }) => {
  ...
  if (!zx(e)) return !1
  let n = 0
  const r = Gs(e.ranges[0].$from, (i) => i.type.name === 'table')
  return (
...
function Fx (t, e, n = {}) {
  let r
  const o = (r = n.cellLineSeparator) != null ? r : Hx
  ...
  i.forEach((p) => {
    let m
    for (let g = 0; g < s; g += 1) {
      const w = (((m = p[g]) == null ? void 0 : m.text) || '').length;
...
const rp = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
  items: ({ query: n }) =>
    Object.entries(t)
      .filter(
        ([r, o]) =>
  ...
  render: () => {
    ...
    return {
      ...
      onUpdate: (f) => {
        ((o = f), (r = 0), s(), a(), f.clientRect && np(f.editor, n))
      },
      onKeyDown: (f) =>
        f.event.key === 'Escape'
...
const op = async ({
  ...
  for (let T of O) {
    ...
    const A = k.findIndex(($) => $.name === T.name);
    (T.name === 'placeholder' &&
            T.parent === null &&
...
const qx = class {
  constructor ({
    ...
    (this.shouldShow = ({ view: d, state: u, from: f, to: h }) => {
      ...
      const { empty: g } = m
      const y = !p.textBetween(f, h).length && fo(u.selection)
      const w = this.element.contains(document.activeElement)
      return !(
        !(d.hasFocus() || w) ||
                    g ||
                    y ||
  ...
  get virtualElement () {
    ...
    const n =
            (t = this.getReferencedVirtualElement) == null
              ...
              : t.call(this)
    if (n) return n
    const r = tu(this.view, e.from, e.to)
    let o = {
    ...
    if (e instanceof X) {
      ...
      const u =
                c === d
                  ...
                  : Kx(c.getBoundingClientRect(), d.getBoundingClientRect())
      o = {
...
function Jx ({
  ...
  return {
    ...
    async init () {
      ...
      const N = 'paragraph' in l;
      (Object.keys(l).forEach((q) => {
        const We = this.$refs[`floatingToolbar::${q}`]
        if (!We) {

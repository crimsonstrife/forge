    ...
    const l = Object.fromEntries(
        o.map((c) => {
            ...
            const h = Rd({
                ...
                linebreakReplacement: J(B(c, "linebreakReplacement", u)),
    ...
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            e0(w, i.find, s).forEach((D) => {
                ...
                const M = x + D.index + 1;
                const z = M + D[0].length;
                const F = {
                    from: n.tr.mapping.map(M),
                    to: n.tr.mapping.map(z),
                };
                const K = i.handler({
                    state: n,
                    range: F,
    ...
    addKeyboardShortcuts() {
        return {
            Enter: ({ editor: t }) => {
                ...
                const s = Xe((z) => z.type === this.type)(r);
...
function Wb({
    ...
    const b = () => {
        ...
        const { top: N, right: D, bottom: M, left: z } = w;
        try {
...
const Bv = An("column", { useDeprecatedLogic: !0 });
    ...
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                const D =
                    ((o = w.filter((M) =>
                        M[2].slice(0, $e(M[0]) ? 2 : 3).every((z) => z <= 0),
                    )[0]) == null
                        ? void 0
                        : o[0]) || w[0][0];
                return D !== l
        ...
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                if (
                    ...
                    let z, F;
                    const _ =
                        (((z = i.flip) == null ? void 0 : z.index) || 0) + 1;
                    const T = w[_];
                    if (
                        T &&
                ...
                function p() {
                    ...
                    if (u.length >= 2) {
                        if (je(n) === "y") {
                            ...
                            const K = M.top;
                            const _ = z.bottom;
                            const T = F ? M.left : z.left;
                            const W = F ? M.right : z.right;
                            const U = W - T;
                            const ie = _ - K;
                            return {
                                top: K,
...
const Gh = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
    ...
    render: () => {
        ...
        const i = () => {
            ...
            return ((f.className = "fi-dropdown-panel fi-dropdown-list"), f);
        };
        const s = () => {
            if (!n || !o) return;
            const f = o.items || [];
        ...
        return {
            ...
            onUpdate: (f) => {
                ((o = f), (r = 0), s(), a(), f.clientRect && Jh(f.editor, n));
            },
            onKeyDown: (f) =>
                f.event.key === "Escape"

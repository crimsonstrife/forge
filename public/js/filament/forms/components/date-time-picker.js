                ...
                const o = (e || "YYYY-MM-DDTHH:mm:ssZ").replace(
                    ...
                    function (s) {
                        switch (s) {
                            ...
                            case "w":
                            case "ww":
                                return _.s(r.week(), s === "w" ? 1 : 2, "0");
                            case "W":
                            case "WW":
                                return _.s(r.isoWeek(), s === "W" ? 1 : 2, "0");
                            case "k":
                            case "kk":
                                return _.s(
                                    String(r.$H === 0 ? 24 : r.$H),
...
const En = g(($e, Ce) => {
    (function (n, t) {
        ...
        return function (n, t, a) {
            ...
            const r = function (s, d, f, l, m) {
                const c = s.name ? s : s.$locale();
                const Y = e(c[d]);
                const D = e(c[f]);
                const L =
                    Y ||
    ...
    (function (n, t) {
        ...
        return function (a, i, e) {
            ...
            ((o.tz = function (d, f) {
                ...
                const c = this.toDate();
                const Y = c.toLocaleString("en-US", { timeZone: d });
                ...
                (o.offsetName = function (d) {
                    ...
                    const l = u(this.valueOf(), f, { timeZoneName: d }).find(
                        function (m) {
    ...
    (function (n, t) {
        ...
        const w = {
            ...
            m: function v(M, h) {
                ...
                const y = M.clone().add(p, s);
                const S = h - y < 0;
                const j = M.clone().add(p + (S ? -1 : 1), s);
...
const bi = g((Xt, Bt) => {
    (function (n, t) {
        ...
        const s = function (l, m) {
            return _.test(m) ? i[l.month()] : e[l.month()];
        };
        ((s.s = e), (s.f = i));
        const d = function (l, m) {
    ...
    (function (n, t) {
        ...
        var i = {
            ...
            relativeTimeFormatter: function (r, u, _, o) {
                ...
                const d = i.correctGrammarCase(r, s);
                return _ === "yy" &&
                    u &&
                    d === "%d \u0433\u043E\u0434\u0438\u043D\u0443"
                    ? r + " \u0433\u043E\u0434\u0438\u043D\u0430"
    ...
    return (
        ...
        (t.startOf = function (i, e) {
            ...
            const s = function (L, w) {
                ...
                return z.w(
                    r.toDate()[L].apply(r.toDate("s"), (u ? b : C).slice(w)),
                    r,
                );
            };
            const d = this.$W;
        ...
        (t.add = function (i, e) {
            ...
            if (_ === oe) return o(7);
            const s =
                ((u = {}), (u[ne] = ce), (u[ie] = ge), (u[te] = se), u)[_] || 1;
            const d = this.$d.getTime() + i * s;
            return z.w(d, this);
        }),

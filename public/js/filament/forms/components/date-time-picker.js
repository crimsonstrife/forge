...
const xi = Object.getOwnPropertyDescriptor;
const Ni = Object.getOwnPropertyNames;
const Fi = Object.getPrototypeOf;
const Ei = Object.prototype.hasOwnProperty;
    ...
    if ((t && typeof t === "object") || typeof t === "function") {
        for (const e of Ni(t)) {
            !Ei.call(n, e) &&
                ...
                Dn(n, e, {
                    get: () => t[e],
                    enumerable: !(i = xi(t, e)) || i.enumerable,
                });
        }
    }
    return n;
...
const de = (n, t, a) => (
    ...
    Ji(
        t || !n || !n.__esModule
            ? Dn(a, "default", { value: n, enumerable: !0 })
            : a,
        n,
    )
);
                ...
                const o = (e || "YYYY-MM-DDTHH:mm:ssZ").replace(
                    ...
                    function (s) {
                        switch (s) {
                            ...
                            case "w":
                            case "ww":
                                return d.s(r.week(), s === "w" ? 1 : 2, "0");
                            case "W":
                            case "WW":
                                return d.s(r.isoWeek(), s === "W" ? 1 : 2, "0");
                            case "k":
                            case "kk":
                                return d.s(
                                    String(r.$H === 0 ? 24 : r.$H),
...
const In = g(($e, Ce) => {
    (function (n, t) {
        ...
        return function (n, t, a) {
            ...
            const r = function (s, _, y, l, f) {
                const m = s.name ? s : s.$locale();
                const Y = e(m[_]);
                const D = e(m[y]);
                const L =
                    Y ||
        ...
        return function (a, i, e) {
            ...
            ((o.tz = function (_, y) {
                ...
                (o.offsetName = function (_) {
                    ...
                    const l = u(this.valueOf(), y, { timeZoneName: _ }).find(
                        function (f) {
            ...
            ((o.startOf = function (_, y) {
                ...
                (e.tz = function (_, y, l) {
                    ...
                    const D = (function (C, A, I) {
                        ...
                        const $ = d(x, I);
                        if (A === $) return [x, A];
                        const T = d((x -= 60 * ($ - A) * 1e3), I);
                        return $ === T
                            ? [x, $]
                            : [C - 60 * Math.min($, T) * 1e3, Math.max($, T)];
                    })(e.utc(_, f).valueOf(), Y, m);
                    const L = D[0];
                    const w = D[1];
                    const S = e(L).utcOffset(w);
    ...
    (function (n, t) {
        ...
        const w = {
            ...
            z: function (v) {
                ...
                const M = c % 60;
                return (h <= 0 ? "+" : "-") + L(p, 2, "0") + ":" + L(M, 2, "0");
            },
            m: function v(h, c) {
                if (h.date() < c.date()) return -v(c, h);
                const p = 12 * (c.year() - h.year()) + (c.month() - h.month());
                const M = h.clone().add(p, s);
                const b = c - M < 0;
                const k = h.clone().add(p + (b ? -1 : 1), s);
            ...
            p: function (v) {
                return (
                    { M: s, y, w: o, d, D: l, h: u, m: r, s: e, ms: i, Q: _ }[
                        v
                    ] ||
                    String(v || "")
                        .toLowerCase()
        ...
        var U = (function () {
            ...
            return (
                ...
                (h.$g = function (c, p, M) {
                    return T.u(c) ? this[p] : this.set(M, c);
                }),
                (h.unix = function () {
                ...
                (h.startOf = function (c, p) {
                    ...
                    const q = function (Z, J) {
                        return T.w(
                            M.toDate()[Z].apply(
                                M.toDate("s"),
                                (b ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(J),
                            ),
                            M,
                        );
                    };
                    ...
                    switch (k) {
                        ...
                        case s:
                            return b ? H(1, F) : H(0, F + 1);
                        case o:
                            var Q = this.$locale().weekStart || 0;
                            var ae = (N < Q ? N + 7 : N) - Q;
                            return H(b ? P - ae : P + (6 - ae), F);
                        case d:
                        case l:
                            return q(B + "Hours", 0);
                        case u:
                ...
                (h.add = function (c, p) {
                    ...
                    const H = function (F) {
                        const P = $(b);
                        return T.w(P.date(P.date() + Math.round(F * c)), b);
                    };
                ...
                (h.format = function (c) {
                    ...
                    const b = c || "YYYY-MM-DDTHH:mm:ssZ";
                    const k = T.z(this);
                    const H = this.$H;
                    const q = this.$m;
                    const N = this.$M;
                    ...
                    const Q = function (J, R, X, ee) {
                        return (J && (J[R] || J(p, b))) || X[R].slice(0, ee);
                    };
                    const ae = function (J) {
                        return T.s(H % 12 || 12, J, "0");
                    };
                    const Z =
                        B ||
                        function (J, R, X) {
                        ...
                        return (
                            ...
                            (function (X) {
                                switch (X) {
                                    ...
                                    case "ddd":
                                        return Q(M.weekdaysShort, p.$W, F, 3);
                                    case "dddd":
                                        return F[p.$W];
                                    case "H":
                                        return String(H);
    ...
    (function (n, t) {
        ...
        var i = {
            ...
            relativeTimeFormatter: function (r, u, d, o) {
                ...
                const _ = i.correctGrammarCase(r, s);
                return d === "yy" &&
                    u &&
                    _ === "%d \u0433\u043E\u0434\u0438\u043D\u0443"
                    ? r + " \u0433\u043E\u0434\u0438\u043D\u0430"
...
const Cn = { s: be, z: Wi, m: Pi, a: Gi, p: Ri, u: Zi };
let le = "en";
const ue = {};
ue[le] = $n;
const On = "$isDayjsObject";
const ke = function (t) {
    return t instanceof ye || !!(t && t[On]);
};
...
var ye = (function () {
    ...
    return (
        ...
        (t.startOf = function (i, e) {
            ...
            const s = function (L, w) {
                const S = [0, 0, 0, 0];
                const C = [23, 59, 59, 999];
                return z.w(
                    r.toDate()[L].apply(r.toDate("s"), (u ? S : C).slice(w)),
                    r,
                );
            };
            const _ = this.$W;
        ...
        (t.add = function (i, e) {
            ...
            if (d === oe) return o(7);
            const s =
                ((u = {}), (u[ne] = ce), (u[ie] = ge), (u[te] = se), u)[d] || 1;
            const _ = this.$d.getTime() + i * s;
            return z.w(_, this);
        }),
        ...
        (t.format = function (i) {
            ...
            return u.replace(Hn, function (w, S) {
        ...
        (t.diff = function (i, e, r) {
            ...
            const d = z.p(e);
            const o = E(i);
            const s = (o.utcOffset() - this.utcOffset()) * ce;
            const _ = this - o;
            const y = function () {
                return z.m(u, o);
            };
        ...
        init() {
            ...
            (((this.getMaxDate() !== null && o.isAfter(this.getMaxDate())) ||
                ...
                this.$watch("focusedDate", () => {
                    const s = this.focusedDate.month();

...
trait CommonUtilities
{
     ...
     * @return bool
     */
    public function matchesId(int|string $id): bool
    {
        return $this->id() === $id;
    }
    ...
    public static function escapeString(string $string): string
    {
        try {
            ...
            throw new RuntimeException('An error occurred while escaping the string.');
        }
    }
    ...
    public static function stripTags(string $string): string
    {
        try {
            ...
            throw new RuntimeException('An error occurred while stripping tags from the string.');
        }
    }

...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('HEALTH_NOTIFICATION_EMAIL', 'admin@example.com'),
    ...
    'queue_check_enabled' => env('HEALTH_QUEUE_CHECK_ENABLED', false),
    ...
    'reverb_healthcheck_enabled' => env('REVERB_HEALTHCHECK_ENABLED', false),
